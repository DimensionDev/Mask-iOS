//
//  WalletBackupKeystoreViewController.swift
//  Maskbook
//
...
class WalletBackupKeystoreViewController: BaseViewController {
    ...
    lazy var tipsLabel: UILabel = {
        ...
        view.text = L10n.Scene.WalletBackup.keystoreTips
    ...
    // MARK: - Data
    let viewModel = WalletBackupKeystoreViewModel()
...
extension WalletBackupKeystoreViewController: UITextViewDelegate {
...
import SwiftUI
@available(iOS 13.0, *)
struct WalletBackupKeystoreViewControllerPreview: PreviewProvider {
    static var previews: some SwiftUI.View {
        let vc = WalletBackupKeystoreViewController()
