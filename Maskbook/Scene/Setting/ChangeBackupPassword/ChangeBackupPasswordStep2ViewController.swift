//
//  ChangeBackupPasswordStep2ViewController.swift
//  Maskbook
//
...
class ChangeBackupPasswordStep2ViewController: UIViewController {
    var disposeBag = Set<AnyCancellable>()
    
    let viewModel = ChangeBackupPasswordStep2ViewModel()
    ...
    let titleLabel: UILabel = {
        ...
        label.text = L10n.Scene.ChangeBackupPassword.title
    ...
    let newPasswordLabel: UILabel = {
        ...
        label.text = L10n.Scene.ChangeBackupPassword.newBackupPassword
        return label
    }()
    ...
    let newPasswordTextField: MaskTextField = {
        ...
        textField.attributedPlaceholder = NSAttributedString(
            string: L10n.Scene.ChangeBackupPassword.newBackupPassword,
    ...
    let confirmPasswordLabel: UILabel = {
        ...
        label.textColor = Asset.Colors.Text.normal.color
        label.font = FontStyles.BH5
        label.text = L10n.Scene.ChangeBackupPassword.confirmBackupPassword
        return label
    }()
    ...
    let confirmPasswordTextField: MaskTextField = {
        ...
        textField.isPasswordTextField = true
        textField.attributedPlaceholder = NSAttributedString(
            string: L10n.Scene.ChangeBackupPassword.confirmBackupPassword,
            attributes: [.foregroundColor: Asset.Colors.Text.light.color,
                         .font: FontStyles.BH5])
        return textField
    }()
    ...
    let passwordErrorLabel: UILabel = {
        ...
        label.text = L10n.Scene.ChangeBackupPassword.tips
...
extension ChangeBackupPasswordStep2ViewController {
        ...
        viewModel.changePasswordError
            ...
            .sink { [weak self] errorString in
                ...
                guard errorString != nil else {
                    self.passwordErrorLabel.text = L10n.Scene.ChangeBackupPassword.tips
    ...
    private func bindViewModel() {
        viewModel.dismissSignal
            ...
            .sink { [weak self] error in
                ...
                guard error != nil else {
                    self.dismiss(animated: true, completion: {
                        let alertController = AlertController(
                            title: L10n.Common.Alert.ChangeBackupPassword.title,
                            message: L10n.Common.Alert.ChangeBackupPassword.description,
                ...
                self.dismiss(animated: true, completion: {
                    let alertController = AlertController(
                        title: L10n.Common.Alert.ChangeBackupPasswordFailed.title,
                        message: "",
                        confirmButtonText: L10n.Common.Controls.done,
                        imageType: .error)
                    Coordinator.main.present(
...
extension ChangeBackupPasswordStep2ViewController: UITextFieldDelegate {
...
extension ChangeBackupPasswordStep2ViewController: KeyboardHandlerContent {
