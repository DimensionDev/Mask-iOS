...
internal enum Asset {
  internal enum Colors {
    ...
    internal enum Gradient {
      ...
      internal static let mnemonicVerify3 = ColorAsset(name: "Colors/Gradient/mnemonicVerify3")
      internal static let mnemonicVerify4 = ColorAsset(name: "Colors/Gradient/mnemonicVerify4")
  ...
  internal enum Plugins {
    internal enum FileService {
      ...
      internal static let textPlaceholder = ImageAsset(name: "Plugins/FileService/text_placeholder")
