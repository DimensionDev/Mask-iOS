(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[3996],{
...
async function connectSocialNetwork(identifier, network, type, profile) {
...
async function openShareLink(SNSIdentifier, post) {
    const url = (await (0,social_network/* getNetworkWorker */.C8)(SNSIdentifier)).utils.getShareLinkURL?.(post);
    if (!url) return;
    const width = 700;
    const height = 520;
