"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[4024],{
...
function createNativeTagDelegate(tag, acceptProps) {
    const C = ()=>{
        ...
        if (acceptProps?.children === false) return /*#__PURE__*/ (0,react.createElement)(tag);
...
const createReactRootShadowed = (0,entry/* createReactRootShadowedPartial */.zV)({
...
var base = __webpack_require__(47845);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.6.1_15f9e73798f83ff073fea11061a4a4f7/node_modules/@mui/icons-material/esm/Link.js
var esm_Link = __webpack_require__(11443);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.6.1_15f9e73798f83ff073fea11061a4a4f7/node_modules/@mui/icons-material/esm/Person.js
var Person = __webpack_require__(1494);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.6.1_15f9e73798f83ff073fea11061a4a4f7/node_modules/@mui/icons-material/esm/Description.js
var Description = __webpack_require__(48471);
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(ListItem/* default */.ZP, {
                        children: [
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(ListItemText/* default */.Z, {
                                primary: "Publisher",
                                secondary: loading ? skeleton : value?.publisher ?? ''
                            })
                        ]
                    }),
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(ListItem/* default */.ZP, {
                        children: [
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(ListItemText/* default */.Z, {
                                primary: "Description",
                                secondary: loading ? skeleton : value?.description ?? ''
                            })
                        ]
                    })
                ]
...
function ThirdPartyPluginCompositionEntry(props) {
    ...
    return (0,entry/* usePortalShadowRoot */.ad)((container)=>/*#__PURE__*/ (0,jsx_runtime.jsx)(src/* InjectedDialog */.Fl, {
            open: props.open,
...
var messages = __webpack_require__(40391);
...
const sns = {
    ...
    init (signal) {
        ...
        const b = messages/* ExternalPluginMessages.appendComposition.on */.M.appendComposition.on((data)=>{
            ...
            utils/* MaskMessages.events.replaceComposition.sendToLocal */.ql.events.replaceComposition.sendToLocal((0,typed_message_base/* makeTypedMessageText */.P)(data.appendText, data.payload));
        });
