"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[1080],{
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(55917);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(37253);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(85139);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(37731);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(80579);
/* harmony import */ var _masknet_theme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30232);
/* harmony import */ var zod__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(74368);
/* harmony import */ var react_hook_form__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(7631);
/* harmony import */ var _hookform_resolvers_zod__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(53753);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(10459);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(44111);
...
/* harmony import */ var _masknet_plugin_wallet__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(19841);
/* harmony import */ var _API__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(62490);
...
/* harmony import */ var _components_PasswordField__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(24278);
/* harmony import */ var _masknet_icons__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(76520);
...
const useStyles = (0,_masknet_theme__WEBPACK_IMPORTED_MODULE_2__/* .makeStyles */ .ZL)()((theme)=>({
        ...
        textField: {
            ...
            lineHeight: '16px',
            borderRadius: 6,
            [`&.${_mui_material__WEBPACK_IMPORTED_MODULE_8__/* ["default"].error */ .Z.error}`]: {
...
const CreateWalletForm = /*#__PURE__*/ (0,react__WEBPACK_IMPORTED_MODULE_1__.memo)(()=>{
    ...
    const { value: hasPassword , loading , retry  } = (0,react_use__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z)(_API__WEBPACK_IMPORTED_MODULE_12__/* .PluginServices.Wallet.hasPassword */ .NG.Wallet.hasPassword, []);
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        return _masknet_plugin_wallet__WEBPACK_IMPORTED_MODULE_5__/* .WalletMessages.events.walletLockStatusUpdated.on */ .R$.events.walletLockStatusUpdated.on(retry);
    }, [
        retry
    ]);
    const schema = (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(()=>{
        const passwordRule = zod__WEBPACK_IMPORTED_MODULE_13__.z.string().min(8, t.create_wallet_password_length_error()).max(20, t.create_wallet_password_length_error()).refine((input)=>[
                /[A-Z]/,
                /[a-z]/,
                /\d/,
                /[^\dA-Za-z]/
        ...
        return zod__WEBPACK_IMPORTED_MODULE_13__.z.object(hasPassword ? {
            name: zod__WEBPACK_IMPORTED_MODULE_13__.z.string().min(1).max(12)
        } : {
            name: zod__WEBPACK_IMPORTED_MODULE_13__.z.string().min(1).max(12),
            password: hasPassword ? passwordRule.optional() : passwordRule,
            confirm: zod__WEBPACK_IMPORTED_MODULE_13__.z.string().optional()
    ...
    const { control , handleSubmit , formState: { errors , isValid  } ,  } = (0,react_hook_form__WEBPACK_IMPORTED_MODULE_14__/* .useForm */ .cI)({
        mode: 'onBlur',
        resolver: (0,_hookform_resolvers_zod__WEBPACK_IMPORTED_MODULE_15__/* .zodResolver */ .F)(schema),
        defaultValues: {
            name: '',
            password: '',
            confirm: ''
    ...
    const onSubmit = handleSubmit((data)=>{
        navigate(urlcat__WEBPACK_IMPORTED_MODULE_6___default()(_masknet_shared_base__WEBPACK_IMPORTED_MODULE_3__/* .DashboardRoutes.CreateMaskWalletMnemonic */ .vq.CreateMaskWalletMnemonic, {
            name: data.name,
                ...
                children: [
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .Z, {
                        children: [
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_hook_form__WEBPACK_IMPORTED_MODULE_14__/* .Controller */ .Qr, {
                                render: ({ field  })=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_masknet_theme__WEBPACK_IMPORTED_MODULE_2__/* .MaskTextField */ .FU, {
                                        ...field,
                        ...
                        children: [
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mui_material__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .Z, {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_hook_form__WEBPACK_IMPORTED_MODULE_14__/* .Controller */ .Qr, {
                                        control: control,
                                        render: ({ field  })=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_PasswordField__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z, {
                                                ...field,
                                                className: classes.input,
