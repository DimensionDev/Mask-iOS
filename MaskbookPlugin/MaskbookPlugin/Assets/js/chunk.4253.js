"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[3403],{
...
async function fetchPool(address, subgraphUrl) {
    ...
    const prizeStrategy = prizePool.prizeStrategy.singleRandomWinne ? prizePool.prizeStrategy.singleRandomWinne : prizePool.prizeStrategy.multipleWinners;
    ...
    return {
        ...
        tokens: {
            ticket: {
                ...
                totalSupply: (0,src/* formatBalance */.azF)(prizeStrategy.ticket.totalSupply, prizeStrategy.ticket.decimals)
            },
            underlyingToken: {
