(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[8369],{
...
__webpack_require__.d(__webpack_exports__, {
  ...
  "getRedPacketHistoryWithPassword": () => (/* binding */ getRedPacketHistoryWithPassword)
});
...
const RedPacketDatabase = (0,wrap_plugin_database/* createPluginDatabase */.X)(constants/* RedPacketPluginID */.jY);
...
async function updateV1ToV2(history) {
    var ref;
    const record_v1 = await getRedPacket(history.rpid);
    if ((record_v1 === null || record_v1 === void 0 ? void 0 : (ref = record_v1.payload) === null || ref === void 0 ? void 0 : ref.contract_version) === 1) {
...
;// CONCATENATED MODULE: ./src/plugins/RedPacket/Worker/apis/index.ts
...
async function fetchFromRedPacketSubgraph(query) {
    const subgraphURL = (0,src/* getRedPacketConstants */.GVo)(settings/* currentChainIdSettings.value */.wU.value).SUBGRAPH_URL;
...
async function getRedPacketTxid(rpid) {
    ...
    `);
    return (ref = (0,lodash.first)(data === null || data === void 0 ? void 0 : data.redPackets)) === null || ref === void 0 ? void 0 : ref.txid;
}
async function getRedPacketHistory(address, chainId) {
    ...
    return data.redPackets.map((x)=>{
        ...
        const redPacketBasic = (0,lodash.pick)(redPacketSubgraphInMask, redPacketBasicKeys);
        ...
        const network = (0,src/* getChainName */.qzE)(redPacketSubgraphInMask.chain_id);
        let token;
        if (redPacketSubgraphInMask.token.type === src/* EthereumTokenType.Native */.Drc.Native) {
            const detailed = (0,src/* getChainDetailed */.$Gt)(redPacketSubgraphInMask.token.chainId);
            var _name, _symbol;
            token = {
                ...redPacketSubgraphInMask.token,
                name: (_name = detailed === null || detailed === void 0 ? void 0 : detailed.nativeCurrency.name) !== null && _name !== void 0 ? _name : 'Ether',
                symbol: (_symbol = detailed === null || detailed === void 0 ? void 0 : detailed.nativeCurrency.symbol) !== null && _symbol !== void 0 ? _symbol : 'ETH'
            };
        ...
        const payload = {
            ...
            token: (0,lodash.pick)(redPacketSubgraphInMask.token, [
                'symbol',
                'address',
                'name',
                'decimals'
...
async function getRedPacketHistoryWithPassword(address, chainId) {
    const histories = await getRedPacketHistory(address, chainId);
    const historiesWithPassword = [];
    for (const history of histories){
        await updateV1ToV2(history);
        const record = await getRedPacket(history.txid);
