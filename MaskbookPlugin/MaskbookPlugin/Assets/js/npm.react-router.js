...
/* harmony export */ });
/* unused harmony exports Prompt, StaticRouter, __HistoryContext, generatePath, withRouter */
/* harmony import */ var _babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(55794);
...
/* harmony import */ var mini_create_react_context__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(64715);
/* harmony import */ var tiny_invariant__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(32054);
/* harmony import */ var _babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(40531);
...
/* harmony import */ var _babel_runtime_helpers_esm_objectWithoutPropertiesLoose__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(81987);
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(context.Consumer, null, function (context$1) {
      ...
      return react__WEBPACK_IMPORTED_MODULE_0__.createElement(context.Provider, {
        value: props
      }, props.match ? children ? typeof children === "function" ?  false ? 0 : children(props) : children : component ? react__WEBPACK_IMPORTED_MODULE_0__.createElement(component, props) : render ? render(props) : null : typeof children === "function" ?  false ? 0 : children(props) : null);
    });
  };
...
function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return react__WEBPACK_IMPORTED_MODULE_0__.createElement(Router, (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_9__/* .default */ .Z)({}, rest, {
      history: history,
...
/* harmony import */ var history__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(68987);
...
function q(a,b,c){b||p[a]||(p[a]=!0, false?0:void 0)}var r=(0,react__WEBPACK_IMPORTED_MODULE_1__.createContext)({static:!1}); false&&(0);var v=(0,react__WEBPACK_IMPORTED_MODULE_1__.createContext)({outlet:null,params:k({}),pathname:"",route:null}); false&&(0);
function w(a){var b=a.children,c=a.initialEntries;a=a.initialIndex;var d=useRef();null==d.current&&(d.current=createMemoryHistory({initialEntries:c,initialIndex:a}));var e=d.current;c=useReducer(function(a,c){return c},{action:e.action,location:e.location});a=c[0];var g=c[1];useLayoutEffect(function(){return e.listen(g)},[e]);return createElement(x,{children:b,action:a.action,location:a.location,navigator:e})}
 false&&(0);
function y(a){var b=a.to,c=a.replace,d=a.state;z()?void 0: false?0:l(!1); false?0:void 0;var e=A();(0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function(){e(b,{replace:c,
state:d})});return null} false&&(0);function B(){return C()} false&&(0);function D(a){a=a.element;return void 0===a?(0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(B,null):a}
 false&&(0);
function x(a){var b=a.children;b=void 0===b?null:b;var c=a.action;c=void 0===c?history__WEBPACK_IMPORTED_MODULE_2__/* .Action.Pop */ .aU.Pop:c;var d=a.location,e=a.navigator;a=a.static;a=void 0===a?!1:a;z()? false?0:l(!1):void 0;return (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(r.Provider,{children:b,value:{action:c,location:d,navigator:e,static:a}})}
 false&&(0);function E(a){var b=a.basename;b=void 0===b?"":b;a=F(a.children);return G(a,b)}
 false&&(0);function z(){return null!=(0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(r).location}function H(){z()?void 0: false?0:l(!1);return (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(r).location}
function A(){z()?void 0: false?0:l(!1);var a=(0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(r).navigator,b=(0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(v).pathname,c=(0,react__WEBPACK_IMPORTED_MODULE_1__.useRef)(!1);(0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(function(){c.current=!0});return (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(function(d,e){void 0===e&&(e={});c.current?"number"===typeof d?a.go(d):(d=J(d,b),(e.replace?a.replace:a.push)(d,e.state)): false?0:
void 0},[a,b])}function C(){return (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(v).outlet}function K(a){var b=(0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(v).pathname;return (0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function(){return J(a,b)},[a,b])}
function G(a,b){void 0===b&&(b="");var c=(0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(v),d=c.route,e=c.pathname,g=c.params; false&&(0);b=b?L([e,b]):e;var h=H();return(d=(0,react__WEBPACK_IMPORTED_MODULE_1__.useMemo)(function(){return M(a,h,b)},[h,a,b]))?d.reduceRight(function(a,c){var d=c.pathname,e=c.route;return (0,react__WEBPACK_IMPORTED_MODULE_1__.createElement)(v.Provider,{children:e.element,value:{outlet:a,params:k(f({},g,{},c.params)),pathname:L([b,d]),route:e}})},null):null}function N(a){return a.map(function(a){var c={path:a.path||"/",caseSensitive:!0===a.caseSensitive,element:a.element||createElement(B,null)};a.children&&(c.children=N(a.children));return c})}
function F(a){var b=[];react__WEBPACK_IMPORTED_MODULE_1__.Children.forEach(a,function(a){if((0,react__WEBPACK_IMPORTED_MODULE_1__.isValidElement)(a))if(a.type===react__WEBPACK_IMPORTED_MODULE_1__.Fragment)b.push.apply(b,F(a.props.children));else{var c={path:a.props.path||"/",caseSensitive:!0===a.props.caseSensitive,element:a};a.props.children&&(a=F(a.props.children),a.length&&(c.children=a));b.push(c)}});return b}
function M(a,b,c){void 0===c&&(c="");"string"===typeof b&&(b=(0,history__WEBPACK_IMPORTED_MODULE_2__/* .parsePath */ .cP)(b));b=b.pathname||"/";if(c)if(c=c.replace(/^\/*/,"/").replace(/\/+$/,""),b.startsWith(c))b=b===c?"/":b.slice(c.length);else return null;a=O(a);P(a);var d=null;for(c=0;null==d&&c<a.length;++c)a:{d=b;for(var e=a[c][1],g="/",h={},I=[],n=0;n<e.length;++n){var t=e[n],u="/"===g?d:d.slice(g.length)||"/";u=Q({path:t.path,caseSensitive:t.caseSensitive,end:n===e.length-1},u);if(!u){d=null;break a}g=L([g,u.pathname]);h=f({},h,{},u.params);
...
function J(a,b){void 0===b&&(b="/");var c="string"===typeof a?(0,history__WEBPACK_IMPORTED_MODULE_2__/* .parsePath */ .cP)(a):a;a=c.pathname;var d=c.search;d=void 0===d?"":d;c=c.hash;c=void 0===c?"":c;return{pathname:a?ba(a,a.startsWith("/")?"/":b):b,search:d,hash:c}}function L(a){return a.join("/").replace(/\/\/+/g,"/")}function ba(a,b){var c=b.replace(/\/+$/,"").replace(/\/\/+/g,"/").split("/");a.replace(/\/\/+/g,"/").split("/").forEach(function(a){".."===a?1<c.length&&c.pop():"."!==a&&c.push(a)});return 1<c.length?L(c):"/"}
...
function useHref(a){z()?void 0: false?0:l(!1);var b=(0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(r).navigator;a=K(a);return b.createHref(a)};function useMatch(a){z()?void 0: false?0:l(!1);var b=H();return Q(a,b.pathname)};
function useParams(){return (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(v).params};function useRoutes(a,b){void 0===b&&(b="");z()?void 0: false?0:l(!1);var c=useMemo(function(){return N(a)},[a]);return G(c,b)};
