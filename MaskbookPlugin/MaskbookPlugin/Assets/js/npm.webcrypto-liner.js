"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[5732],{

/***/ 83089:
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

var des_js__WEBPACK_IMPORTED_MODULE_6___namespace_cache;
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "eL": () => (/* binding */ crypto)
/* harmony export */ });
/* unused harmony exports Crypto, CryptoKey, nativeCrypto, nativeSubtle, setCrypto */
/* harmony import */ var webcrypto_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(85914);
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(64873);
...
/* harmony import */ var asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(26851);
/* harmony import */ var elliptic__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(75367);
...
/* harmony import */ var des_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(29236);
...
class CryptoKey extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .CryptoKey */ .$h {
...
class AesCryptoKey extends CryptoKey {
    ...
    toJSON() {
        const jwk = {
            ...
            k: pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToBase64Url(this.raw),
    ...
    getJwkAlgorithm() {
        switch (this.algorithm.name.toUpperCase()) {
            ...
            default:
                throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .AlgorithmError */ ._R("Unsupported algorithm name");
        }
    }
}
...
class AesCrypto {
    ...
    static encrypt(algorithm, key, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            return this.cipher(algorithm, key, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(data), true);
        });
    }
    static decrypt(algorithm, key, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            return this.cipher(algorithm, key, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(data), false);
        });
    }
    static exportKey(format, key) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            switch (format) {
                ...
                default:
                    throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un("format: Must be 'jwk' or 'raw'");
            }
        });
    }
    static importKey(format, keyData, algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            let raw;
            if ((0,webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .isJWK */ .x)(keyData)) {
                raw = pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.FromBase64Url(keyData.k);
            }
            else {
                raw = webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toArrayBuffer */ .vJ.toArrayBuffer(keyData);
            }
            switch (raw.byteLength << 3) {
                ...
                case 256:
                    break;
                default:
                    throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un("keyData: Is wrong key length");
            }
    ...
    static cipher(algorithm, key, data, encrypt) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (isAlgorithm(algorithm, AesCrypto.AesCBC)) {
                const iv = webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(algorithm.iv);
                result = asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .AES_CBC */ .zW[action](data, key.raw, undefined, iv);
            }
            else if (isAlgorithm(algorithm, AesCrypto.AesGCM)) {
                const iv = webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(algorithm.iv);
                let additionalData;
                if (algorithm.additionalData) {
                    additionalData = webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toArrayBuffer */ .vJ.toArrayBuffer(algorithm.additionalData);
                }
                const tagLength = (algorithm.tagLength || 128) / 8;
                result = asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .AES_GCM */ .IQ[action](data, key.raw, iv, additionalData, tagLength);
            }
            else if (isAlgorithm(algorithm, AesCrypto.AesECB)) {
                result = asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .AES_ECB */ .uP[action](data, key.raw, true);
            }
            else {
                throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un(`algorithm: Is not recognized`);
            }
            return webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toArrayBuffer */ .vJ.toArrayBuffer(result);
        });
    }
}
...
class AesCbcProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .AesCbcProvider */ .HD {
...
class AesEcbProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .AesEcbProvider */ .mR {
    onGenerateKey(algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            return AesCrypto.generateKey(algorithm, extractable, keyUsages);
        });
...
class AesGcmProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .AesGcmProvider */ .sU {
    onGenerateKey(algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            return AesCrypto.generateKey(algorithm, extractable, keyUsages);
        });
...
class AesCtrProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .AesCtrProvider */ .KH {
    onEncrypt(algorithm, key, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            const result = new asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .AES_CTR */ .bx(key.raw, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(algorithm.counter))
                .encrypt(webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(data));
            return webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toArrayBuffer */ .vJ.toArrayBuffer(result);
        });
    }
    onDecrypt(algorithm, key, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            const result = new asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .AES_CTR */ .bx(key.raw, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(algorithm.counter))
                .decrypt(webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(data));
            return webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toArrayBuffer */ .vJ.toArrayBuffer(result);
        });
    }
    onGenerateKey(algorithm, extractable, keyUsages) {
...
class AesKwProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .AesKwProvider */ .z1 {
    onEncrypt(algorithm, key, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
...
class RsaCrypto {
    ...
    static exportKey(format, key) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            switch (format) {
                ...
                default:
                    throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un("format: Must be 'jwk', 'pkcs8' or 'spki'");
            }
        });
    }
    static importKey(format, keyData, algorithm, extractable, keyUsages) {
    ...
    static exportPkcs8Key(key) {
        const keyInfo = new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.PrivateKeyInfo */ .sc.PrivateKeyInfo();
        keyInfo.privateKeyAlgorithm.algorithm = "1.2.840.113549.1.1.1";
        keyInfo.privateKeyAlgorithm.parameters = null;
        keyInfo.privateKey = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.serialize */ .zc.serialize(this.exportAsmKey(key.data));
        return _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.serialize */ .zc.serialize(keyInfo);
    }
    static importPkcs8Key(data) {
        const keyInfo = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.parse */ .zc.parse(data, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.PrivateKeyInfo */ .sc.PrivateKeyInfo);
        const privateKey = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.parse */ .zc.parse(keyInfo.privateKey, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.RsaPrivateKey */ .sc.RsaPrivateKey);
        return this.importAsmKey(privateKey);
    }
    static importSpkiKey(data) {
        const keyInfo = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.parse */ .zc.parse(data, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.PublicKeyInfo */ .sc.PublicKeyInfo);
        const publicKey = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.parse */ .zc.parse(keyInfo.publicKey, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.RsaPublicKey */ .sc.RsaPublicKey);
        return this.importAsmKey(publicKey);
    }
    static exportSpkiKey(key) {
        const publicKey = new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.RsaPublicKey */ .sc.RsaPublicKey();
        ...
        const keyInfo = new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.PublicKeyInfo */ .sc.PublicKeyInfo();
        keyInfo.publicKeyAlgorithm.algorithm = "1.2.840.113549.1.1.1";
        keyInfo.publicKeyAlgorithm.parameters = null;
        keyInfo.publicKey = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.serialize */ .zc.serialize(publicKey);
        return _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.serialize */ .zc.serialize(keyInfo);
    }
    static importJwkKey(data) {
        let key;
        if (data.d) {
            key = _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonParser.fromJSON */ .zu.fromJSON(data, { targetSchema: webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.RsaPrivateKey */ .sc.RsaPrivateKey });
        }
        else {
            key = _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonParser.fromJSON */ .zu.fromJSON(data, { targetSchema: webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.RsaPublicKey */ .sc.RsaPublicKey });
        }
        return this.importAsmKey(key);
    }
    static exportJwkKey(key) {
        const asnKey = this.exportAsmKey(key.data);
        const jwk = _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonSerializer.toJSON */ .HE.toJSON(asnKey);
        jwk.ext = true;
    ...
    static exportAsmKey(asmKey) {
        let key;
        if (asmKey.length > 2) {
            const privateKey = new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.RsaPrivateKey */ .sc.RsaPrivateKey();
            ...
            key = new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.RsaPublicKey */ .sc.RsaPublicKey();
        }
    ...
    static importAsmKey(key) {
        ...
        if (key instanceof webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.RsaPrivateKey */ .sc.RsaPrivateKey) {
...
class ShaCrypto {
    static getDigest(name) {
        switch (name) {
            case "SHA-1":
                return new asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .Sha1 */ .gQ();
            case "SHA-256":
                return new asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .Sha256 */ .fN();
            case "SHA-512":
                return new asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .Sha512 */ .XZ();
            default:
                throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .AlgorithmError */ ._R("keyAlgorithm.hash: Is not recognized");
        }
    }
    static digest(algorithm, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            const result = mech
                .process(webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(data))
                .finish().result;
            return webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toArrayBuffer */ .vJ.toArrayBuffer(result);
        });
    }
...
class RsaOaepProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .RsaOaepProvider */ .PW {
    onGenerateKey(algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
    ...
    cipher(algorithm, key, data) {
        ...
        let label;
        if (algorithm.label) {
            label = webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(algorithm.label);
        }
        const cipher = new asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .RSA_OAEP */ .$k(key.data, digest, label);
        let res;
        const u8Data = webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(data);
        if (key.type === "public") {
        ...
        return webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toArrayBuffer */ .vJ.toArrayBuffer(res);
    }
}

class RsaPssProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .RsaPssProvider */ .pj {
    onGenerateKey(algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            return RsaCrypto.generateKey(algorithm, extractable, keyUsages);
        });
    ...
    onSign(algorithm, key, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            const rsa = new asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .RSA_PSS */ .kb(key.data, ShaCrypto.getDigest(key.algorithm.hash.name), algorithm.saltLength);
            const result = rsa.sign(webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(data));
            return webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toArrayBuffer */ .vJ.toArrayBuffer(result);
        });
    }
    onVerify(algorithm, key, signature, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            const rsa = new asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .RSA_PSS */ .kb(key.data, ShaCrypto.getDigest(key.algorithm.hash.name), algorithm.saltLength);
            try {
                rsa.verify(webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(signature), webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(data));
            }
            catch (_a) {
                return false;
            }
...
class RsaSsaProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .RsaSsaProvider */ .bV {
    onGenerateKey(algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            return RsaCrypto.generateKey(algorithm, extractable, keyUsages);
        });
    ...
    onSign(algorithm, key, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            const rsa = new asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .RSA_PKCS1_v1_5 */ .cz(key.data, ShaCrypto.getDigest(key.algorithm.hash.name));
            const result = rsa.sign(webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(data));
            return webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toArrayBuffer */ .vJ.toArrayBuffer(result);
        });
    }
...
class RsaEsProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .ProviderCrypto */ .YG {
    constructor() {
        super(...arguments);
    ...
    checkGenerateKeyParams(algorithm) {
        ...
        const publicExponent = pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToBase64(algorithm.publicExponent);
    ...
    onDecrypt(algorithm, key, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            const EM = new asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .RSA */ .SJ(key.data).decrypt(new asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .BigNumber */ .O$(webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(data))).result;
            const k = key.algorithm.modulusLength >> 3;
            if (data.byteLength !== k) {
                throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .CryptoError */ .jw("Decryption error. Encrypted message size doesn't match to key length");
            }
            let offset = 0;
            if (EM[offset++] || EM[offset++] !== 2) {
                throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .CryptoError */ .jw("Decryption error");
            }
            do {
                if (EM[offset++] === 0) {
                    break;
            ...
            if (offset < 11) {
                throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .CryptoError */ .jw("Decryption error. PS is less than 8 octets.");
            }
            if (offset === EM.length) {
                throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .CryptoError */ .jw("Decryption error. There is no octet with hexadecimal value 0x00 to separate PS from M");
            }
    ...
    onEncrypt(algorithm, key, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (data.byteLength > k - 11) {
                throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .CryptoError */ .jw("Message too long");
            }
            ...
            const result = new asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .RSA */ .SJ(key.data).encrypt(new asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .BigNumber */ .O$(EM)).result;
            return webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toArrayBuffer */ .vJ.toArrayBuffer(result);
        });
    }
    onExportKey(format, key) {
...
function getOidByNamedCurve(namedCurve) {
    ...
    if (!oid) {
        throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un(`Cannot convert WebCrypto named curve '${namedCurve}' to OID`);
    }
    return oid;
}
...
class EcCrypto {
    static checkLib() {
        if (typeof (elliptic__WEBPACK_IMPORTED_MODULE_5__) === "undefined") {
            throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un("Cannot implement EC mechanism. Add 'https://peculiarventures.github.io/pv-webcrypto-tests/src/elliptic.js' script to your project");
        }
    }
    static generateKey(algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
    ...
    static exportKey(format, key) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            switch (format) {
                ...
                default:
                    throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un("format: Must be 'jwk', 'raw, 'pkcs8' or 'spki'");
            }
        });
    }
    static importKey(format, keyData, algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            switch (format) {
                ...
                case "spki":
                    ...
                    break;
                case "raw":
                    ecKey = this.importEcKey(new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.EcPublicKey */ .sc.EcPublicKey(keyData), algorithm.namedCurve);
                    break;
                case "jwk":
    ...
    static getNamedCurve(wcNamedCurve) {
        ...
        if (["P-256", "P-384", "P-521"].indexOf(crv) > -1) {
            ...
            throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un(`Unsupported named curve '${wcNamedCurve}'`);
        }
        return res;
    }
    static initEcKey(namedCurve) {
        return (0,elliptic__WEBPACK_IMPORTED_MODULE_5__.ec)(this.getNamedCurve(namedCurve));
    }
    static exportPkcs8Key(key) {
        const keyInfo = new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.PrivateKeyInfo */ .sc.PrivateKeyInfo();
        keyInfo.privateKeyAlgorithm.algorithm = this.ASN_ALGORITHM;
        keyInfo.privateKeyAlgorithm.parameters = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.serialize */ .zc.serialize(new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.ObjectIdentifier */ .sc.ObjectIdentifier(getOidByNamedCurve(key.algorithm.namedCurve)));
        keyInfo.privateKey = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.serialize */ .zc.serialize(this.exportEcKey(key));
        return _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.serialize */ .zc.serialize(keyInfo);
    }
    static importPkcs8Key(data, namedCurve) {
        const keyInfo = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.parse */ .zc.parse(data, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.PrivateKeyInfo */ .sc.PrivateKeyInfo);
        const privateKey = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.parse */ .zc.parse(keyInfo.privateKey, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.EcPrivateKey */ .sc.EcPrivateKey);
        return this.importEcKey(privateKey, namedCurve);
    }
    static importSpkiKey(data, namedCurve) {
        const keyInfo = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.parse */ .zc.parse(data, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.PublicKeyInfo */ .sc.PublicKeyInfo);
        const publicKey = new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.EcPublicKey */ .sc.EcPublicKey(keyInfo.publicKey);
        return this.importEcKey(publicKey, namedCurve);
    }
    static exportSpkiKey(key) {
        const publicKey = new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.EcPublicKey */ .sc.EcPublicKey(new Uint8Array(key.data.getPublic("der")).buffer);
        const keyInfo = new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.PublicKeyInfo */ .sc.PublicKeyInfo();
        keyInfo.publicKeyAlgorithm.algorithm = this.ASN_ALGORITHM;
        keyInfo.publicKeyAlgorithm.parameters = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.serialize */ .zc.serialize(new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.ObjectIdentifier */ .sc.ObjectIdentifier(getOidByNamedCurve(key.algorithm.namedCurve)));
    ...
    static importJwkKey(data) {
        let key;
        if (data.d) {
            key = _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonParser.fromJSON */ .zu.fromJSON(data, { targetSchema: webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.EcPrivateKey */ .sc.EcPrivateKey });
        }
        else {
            key = _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonParser.fromJSON */ .zu.fromJSON(data, { targetSchema: webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.EcPublicKey */ .sc.EcPublicKey });
        }
    ...
    static exportEcKey(ecKey) {
        if (ecKey.type === "private") {
            const privateKey = new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.EcPrivateKey */ .sc.EcPrivateKey();
            ...
            return new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.EcPublicKey */ .sc.EcPublicKey(new Uint8Array(ecKey.data.getPublic("der")).buffer);
        }
        else {
    ...
    static importEcKey(key, namedCurve) {
        ...
        if (key instanceof webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.EcPublicKey */ .sc.EcPublicKey) {
...
class EcdhProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .EcdhProvider */ .Lo {
    onGenerateKey(algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
...
class EcdsaProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .EcdsaProvider */ .IJ {
    onGenerateKey(algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            return EcCrypto.generateKey(algorithm, extractable, keyUsages);
        });
...
const edOIDs = {
    [webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.idEd448 */ .sc.idEd448]: "Ed448",
    "ed448": webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.idEd448 */ .sc.idEd448,
    [webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.idX448 */ .sc.idX448]: "X448",
    "x448": webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.idX448 */ .sc.idX448,
    [webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.idEd25519 */ .sc.idEd25519]: "Ed25519",
    "ed25519": webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.idEd25519 */ .sc.idEd25519,
    [webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.idX25519 */ .sc.idX25519]: "X25519",
    "x25519": webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.idX25519 */ .sc.idX25519,
};
...
class EdPrivateKey extends CryptoKey {
    ...
    toJSON() {
        ...
        return Object.assign(json, {
            d: pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToBase64Url(pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.FromHex(/^ed/i.test(json.crv) ? this.data.getSecret("hex") : this.data.getPrivate("hex"))),
        });
    }
    fromJSON(json) {
        if (!json.d) {
            throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un(`Cannot get private data from JWK. Property 'd' is required`);
        }
        if (!json.crv) {
            throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un(`Cannot get named curve from JWK. Property 'crv' is required`);
        }
        const hexPrivateKey = pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToHex(pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.FromBase64Url(json.d));
        if (/^ed/i.test(json.crv)) {
            const eddsa$1 = new elliptic__WEBPACK_IMPORTED_MODULE_5__.eddsa(json.crv.toLowerCase());
            this.data = eddsa$1.keyFromSecret(hexPrivateKey);
        }
        else {
            const ecdhEs = (0,elliptic__WEBPACK_IMPORTED_MODULE_5__.ec)(json.crv.replace(/^x/i, "curve"));
...
class EdPublicKey extends CryptoKey {
    ...
    toJSON() {
        ...
        return Object.assign(json, {
            x: pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToBase64Url(pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.FromHex(this.data.getPublic("hex"))),
        });
    }
    fromJSON(json) {
        if (!json.crv) {
        ...
        if (!json.x) {
            throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un(`Cannot get property from JWK. Property 'x' is required`);
        }
        const hexPublicKey = pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToHex(pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.FromBase64Url(json.x));
        if (/^ed/i.test(json.crv)) {
            const eddsa$1 = new elliptic__WEBPACK_IMPORTED_MODULE_5__.eddsa(json.crv.toLowerCase());
...
class EdCrypto {
    ...
    static generateKey(algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (curve === "ed25519") {
                ...
                const eddsa$1 = new elliptic__WEBPACK_IMPORTED_MODULE_5__.eddsa(curve);
                edKey = eddsa$1.keyFromSecret(raw);
            }
            else {
                edKey = (0,elliptic__WEBPACK_IMPORTED_MODULE_5__.ec)(curve).genKeyPair();
                edKey.getPublic();
            }
    ...
    static sign(algorithm, key, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.FromHex(signature);
        });
    }
    static verify(algorithm, key, signature, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            this.checkLib();
            const array = b2a(data);
            const ok = key.data.verify(array, pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToHex(signature));
            return ok;
        });
    }
    ...
    static exportKey(format, key) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            switch (format.toLowerCase()) {
                case "jwk":
                    return _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonSerializer.toJSON */ .HE.toJSON(key);
                case "pkcs8": {
                    const raw = pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.FromHex(/^x/i.test(key.algorithm.namedCurve)
                    ...
                    keyInfo.privateKey = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.serialize */ .zc.serialize(new _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .OctetString */ .fi(raw));
                    return _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.serialize */ .zc.serialize(keyInfo);
                }
                case "spki": {
                    const raw = pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.FromHex(key.data.getPublic("hex"));
                    const keyInfo = new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.PublicKeyInfo */ .sc.PublicKeyInfo();
                ...
                case "raw": {
                    return pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.FromHex(key.data.getPublic("hex"));
                }
                default:
                    throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un("format: Must be 'jwk', 'raw', pkcs8' or 'spki'");
            }
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            switch (format.toLowerCase()) {
                case "jwk": {
                    const jwk = keyData;
                    if (jwk.d) {
                        const asnKey = _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonParser.fromJSON */ .zu.fromJSON(keyData, { targetSchema: webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.CurvePrivateKey */ .sc.CurvePrivateKey });
                        ...
                        return this.importPublicKey(pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.FromBase64Url(jwk.x), algorithm, extractable, keyUsages);
                    }
                }
                case "raw": {
                ...
                case "spki": {
                    const keyInfo = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.parse */ .zc.parse(new Uint8Array(keyData), webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.PublicKeyInfo */ .sc.PublicKeyInfo);
                    return this.importPublicKey(keyInfo.publicKey, algorithm, extractable, keyUsages);
                }
                case "pkcs8": {
                    const keyInfo = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.parse */ .zc.parse(new Uint8Array(keyData), webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.PrivateKeyInfo */ .sc.PrivateKeyInfo);
                    const asnKey = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.parse */ .zc.parse(keyInfo.privateKey, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.CurvePrivateKey */ .sc.CurvePrivateKey);
                    return this.importPrivateKey(asnKey, algorithm, extractable, keyUsages);
                }
                default:
                    throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un("format: Must be 'jwk', 'raw', 'pkcs8' or 'spki'");
    ...
    static importPrivateKey(asnKey, algorithm, extractable, keyUsages) {
        ...
        key.fromJSON({
            ...
            d: pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToBase64Url(asnKey.d),
        });
        return key;
    }
    static importPublicKey(asnKey, algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            key.fromJSON({
                crv: algorithm.namedCurve,
                x: pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToBase64Url(asnKey),
            });
            return key;
        });
    }
...
class EdDsaProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .EdDsaProvider */ .es {
    constructor() {
        super(...arguments);
...
class Sha1Provider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .ProviderCrypto */ .YG {
    constructor() {
        super(...arguments);
        this.name = "SHA-1";
        this.usages = [];
...
class Pbkdf2Provider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .Pbkdf2Provider */ .nk {
    onImportKey(format, keyData, algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            return new PbkdfCryptoKey(algorithm, extractable, keyUsages, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(keyData));
        });
    }
    onDeriveBits(algorithm, baseKey, length) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            let result;
            const salt = webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(algorithm.salt);
            const password = baseKey.raw;
            switch (algorithm.hash.name.toUpperCase()) {
                case "SHA-1":
                    result = (0,asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .Pbkdf2HmacSha1 */ .zN)(password, salt, algorithm.iterations, length >> 3);
                    break;
                case "SHA-256":
                    result = (0,asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .Pbkdf2HmacSha256 */ .q4)(password, salt, algorithm.iterations, length >> 3);
                    break;
                case "SHA-512":
                    result = (0,asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .Pbkdf2HmacSha512 */ .py)(password, salt, algorithm.iterations, length >> 3);
                    break;
                default:
                    throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un(`algorithm.hash: '${algorithm.hash.name}' hash algorithm is not supported`);
            }
            return webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toArrayBuffer */ .vJ.toArrayBuffer(result);
        });
    }
...
class DesCrypto {
    static checkLib() {
        if (typeof (/*#__PURE__*/ (des_js__WEBPACK_IMPORTED_MODULE_6___namespace_cache || (des_js__WEBPACK_IMPORTED_MODULE_6___namespace_cache = __webpack_require__.t(des_js__WEBPACK_IMPORTED_MODULE_6__, 2)))) === "undefined") {
            throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un("Cannot implement DES mechanism. Add 'https://peculiarventures.github.io/pv-webcrypto-tests/src/des.js' script to your project");
        }
    }
    static checkCryptoKey(key) {
    ...
    static cipher(algorithm, key, data, encrypt) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            switch (algorithm.name.toUpperCase()) {
                case "DES-CBC":
                    DesCipher = des_js__WEBPACK_IMPORTED_MODULE_6__.CBC.instantiate(des_js__WEBPACK_IMPORTED_MODULE_6__.DES).create({
                        key: key.raw,
                        type,
                        iv,
                    });
                    break;
                case "DES-EDE3-CBC":
                    DesCipher = des_js__WEBPACK_IMPORTED_MODULE_6__.CBC.instantiate(des_js__WEBPACK_IMPORTED_MODULE_6__.EDE).create({
                        key: key.raw,
                        type,
                        iv,
                    });
...
class DesCbcProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .DesProvider */ .Sn {
    constructor() {
        super(...arguments);
        this.keySizeBits = 64;
        this.ivSize = 8;
...
class DesEde3CbcProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .DesProvider */ .Sn {
    constructor() {
        super(...arguments);
...
const JsonBase64UrlConverter = {
    fromJSON: (value) => Buffer.from(pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.FromBase64Url(value)),
    toJSON: (value) => pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToBase64Url(value),
};
...
(0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonProp */ .uj)({ name: "ext", type: _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonPropTypes.Boolean */ .bx.Boolean, optional: true })
], HmacCryptoKey.prototype, "extractable", void 0);
(0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonProp */ .uj)({ name: "key_ops", type: _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonPropTypes.String */ .bx.String, repeated: true, optional: true })
], HmacCryptoKey.prototype, "usages", void 0);
(0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonProp */ .uj)({ name: "k", converter: JsonBase64UrlConverter })
], HmacCryptoKey.prototype, "data", void 0);
(0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonProp */ .uj)({ type: _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonPropTypes.String */ .bx.String })
], HmacCryptoKey.prototype, "kty", void 0);
(0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([
    (0,_peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonProp */ .uj)({ type: _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonPropTypes.String */ .bx.String })
], HmacCryptoKey.prototype, "alg", null);

class HmacProvider extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .HmacProvider */ .NR {
    onGenerateKey(algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
    ...
    onSign(algorithm, key, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            switch (key.algorithm.hash.name.toUpperCase()) {
                case "SHA-1":
                    fn = asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .HmacSha1 */ .uj;
                    break;
                case "SHA-256":
                    fn = asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .HmacSha256 */ .eH;
                    break;
                case "SHA-512":
                    fn = asmcrypto_js__WEBPACK_IMPORTED_MODULE_4__/* .HmacSha512 */ .lJ;
                    break;
                default:
                    throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un("key.algorithm.hash: Is not recognized");
            }
    ...
    onVerify(algorithm, key, signature, data) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToHex(signature2) === pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToHex(signature);
        });
    }
    onImportKey(format, keyData, algorithm, extractable, keyUsages) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            switch (format.toLowerCase()) {
                case "jwk":
                    key = _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonParser.fromJSON */ .zu.fromJSON(keyData, { targetSchema: HmacCryptoKey });
                    break;
                case "raw":
                    if (!webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.isBufferSource */ .vJ.isBufferSource(keyData)) {
                        throw new TypeError("keyData: Is not ArrayBuffer or ArrayBufferView");
                    }
                    key = new HmacCryptoKey(algorithm, extractable, keyUsages, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toUint8Array */ .vJ.toUint8Array(keyData));
                    break;
                default:
                    throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un("format: Must be 'jwk' or 'raw'");
            }
    ...
    onExportKey(format, key) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            switch (format.toLowerCase()) {
                case "jwk":
                    const jwk = _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonSerializer.toJSON */ .HE.toJSON(key);
                    return jwk;
                case "raw":
...
class WrappedNativeCryptoKey extends CryptoKey {
    constructor(algorithm, extractable, type, usages, nativeKey) {
        ...
        (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__classPrivateFieldSet)(this, _nativeKey, nativeKey);
    }
    getNative() {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__classPrivateFieldGet)(this, _nativeKey);
    }
}
_nativeKey = new WeakMap();

class SubtleCrypto extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .SubtleCrypto */ .WD {
    constructor() {
        super();
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            ...
            if (method === "wrapKey") {
                try {
                    ...
                    const keyData = (args[0] === "jwk") ? pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.FromUtf8String(JSON.stringify(data)) : data;
            ...
            if (method === "unwrapKey") {
                try {
                    ...
                    const keyData = (args[0] === "jwk") ? JSON.parse(pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToUtf8String(data)) : data;
    ...
    fixNativeArguments(method, args) {
        ...
        const res = [...args];
        if (method === "importKey") {
            if (this.browserInfo.name === Browser.IE && ((_b = (_a = res[0]) === null || _a === void 0 ? void 0 : _a.toLowerCase) === null || _b === void 0 ? void 0 : _b.call(_a)) === "jwk" && !pvtsutils__WEBPACK_IMPORTED_MODULE_3__.BufferSourceConverter.isBufferSource(res[1])) {
                res[1] = pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.FromUtf8String(JSON.stringify(res[1]));
            }
        }
        ...
        if (this.browserInfo.name === Browser.IE) {
            if (method === "exportKey") {
                if (((_b = (_a = args[0]) === null || _a === void 0 ? void 0 : _a.toLowerCase) === null || _b === void 0 ? void 0 : _b.call(_a)) === "jwk" && res instanceof ArrayBuffer) {
                    return JSON.parse(pvtsutils__WEBPACK_IMPORTED_MODULE_3__.Convert.ToUtf8String(res));
                }
            }
            if ("privateKey" in res) {
                ...
                switch (method) {
                    ...
                    case "generateKey":
                        ...
                        break;
                    default:
                        throw new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .OperationError */ .un("Cannot wrap native key. Unsupported method in use");
                }
    ...
    wrapNativeKey(key, algorithm, extractable, keyUsages) {
        if (this.browserInfo.name === Browser.IE) {
            ...
            if (index !== -1) {
                ...
                if (webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .SubtleCrypto.isHashedAlgorithm */ .WD.isHashedAlgorithm(alg)) {
                    newAlg.hash = {
    ...
    fixFirefoxEcImportPkcs8(args) {
        ...
        if (this.browserInfo.name === Browser.Firefox
            ...
            if (!webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.isBufferSource */ .vJ.isBufferSource(args[1])) {
                throw new TypeError("data: Is not ArrayBuffer or ArrayBufferView");
            }
            const preparedData = webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .BufferSourceConverter.toArrayBuffer */ .vJ.toArrayBuffer(args[1]);
            const keyInfo = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.parse */ .zc.parse(preparedData, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.PrivateKeyInfo */ .sc.PrivateKeyInfo);
            const privateKey = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.parse */ .zc.parse(keyInfo.privateKey, webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.EcPrivateKey */ .sc.EcPrivateKey);
            const jwk = _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonSerializer.toJSON */ .HE.toJSON(privateKey);
            jwk.ext = true;
            jwk.key_ops = args[4];
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_7__.__awaiter)(this, void 0, void 0, function* () {
            try {
                if (this.browserInfo.name === Browser.Firefox
                    ...
                    const ecKey = _peculiar_json_schema__WEBPACK_IMPORTED_MODULE_2__/* .JsonParser.fromJSON */ .zu.fromJSON(jwk, { targetSchema: webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.EcPrivateKey */ .sc.EcPrivateKey });
                    const keyInfo = new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.PrivateKeyInfo */ .sc.PrivateKeyInfo();
                    keyInfo.privateKeyAlgorithm.algorithm = EcCrypto.ASN_ALGORITHM;
                    keyInfo.privateKeyAlgorithm.parameters = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.serialize */ .zc.serialize(new webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .asn1.ObjectIdentifier */ .sc.ObjectIdentifier(getOidByNamedCurve(args[1].algorithm.namedCurve)));
                    keyInfo.privateKey = _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.serialize */ .zc.serialize(ecKey);
                    return _peculiar_asn1_schema__WEBPACK_IMPORTED_MODULE_1__/* .AsnConvert.serialize */ .zc.serialize(keyInfo);
                }
            }
            catch (err) {
...
class Crypto extends webcrypto_core__WEBPACK_IMPORTED_MODULE_0__/* .Crypto */ .w1 {
    constructor() {
        super(...arguments);
