"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[7829],{
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/Drawer/Drawer.js + 1 modules
var Drawer = __webpack_require__(59219);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/Paper/paperClasses.js
var paperClasses = __webpack_require__(66886);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/AppBar/AppBar.js + 1 modules
var AppBar = __webpack_require__(81206);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/Toolbar/Toolbar.js + 1 modules
var Toolbar = __webpack_require__(25772);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.4.4_d06e3de907ce734e888a65f5db1d962e/node_modules/@mui/icons-material/esm/Menu.js
var Menu = __webpack_require__(75128);
...
var UserContext = __webpack_require__(60838);
// EXTERNAL MODULE: ../dashboard/src/components/LoadingButton/index.tsx
var LoadingButton = __webpack_require__(38551);
// EXTERNAL MODULE: ../dashboard/src/pages/Settings/api.ts
var api = __webpack_require__(99323);
...
var LoadingCard = __webpack_require__(4047);
// EXTERNAL MODULE: ../backup-format/src/index.ts + 3 modules
var backup_format_src = __webpack_require__(55223);
...
var MaskAlert = __webpack_require__(79042);
    ...
    const [{ loading  }, handleBackup] = (0,useAsyncFn/* default */.Z)(async ()=>{
        ...
        try {
            ...
            if (local) {
                ...
                const encrypted = await (0,backup_format_src/* encryptBackup */.Hb)((0,encode/* encode */.c)(backupPassword), (0,encode/* encode */.c)(fileJson));
                ...
                const encrypted = await (0,backup_format_src/* encryptBackup */.Hb)((0,encode/* encode */.c)(params.account + backupPassword), (0,encode/* encode */.c)(fileJson));
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/FormControlLabel/formControlLabelClasses.js
var formControlLabelClasses = __webpack_require__(16450);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/RadioGroup/RadioGroup.js
var RadioGroup = __webpack_require__(97010);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/Radio/Radio.js + 4 modules
var Radio = __webpack_require__(55201);
// EXTERNAL MODULE: ../dashboard/src/components/Restore/BackupInfoCard.tsx
var BackupInfoCard = __webpack_require__(14087);
...
const CloudBackupMergeDialog_useStyles = (0,src/* makeStyles */.ZL)()(()=>({
        helpContent: {
            fontSize: '13px',
            padding: '12px 0',
...
function CloudBackupMergeDialog({ account , info , open , onClose , onMerged  }) {
    ...
    const [{ loading  }, handleMerge] = (0,useAsyncFn/* default */.Z)(async ()=>{
        try {
            ...
            const decrypted = await (0,backup_format_src/* decryptBackup */.lK)((0,encode/* encode */.c)(account + backupPassword), encrypted);
            ...
            if (data === null || data === void 0 ? void 0 : data.info.wallets) {
...
var type = __webpack_require__(33044);
...
function BackupSetting() {
    ...
    (0,react.useEffect)(()=>{
        if (!(state === null || state === void 0 ? void 0 : state.open) || (state === null || state === void 0 ? void 0 : state.open) !== 'setting') return;
        ...
        state === null || state === void 0 ? void 0 : state.open
    ]);
    const onBackup = ()=>{
        ensurePasswordSet(()=>setShowDialog({
                ...showDialog,
...
function PasswordSetting() {
    ...
    (0,react.useEffect)(()=>{
        if (!(state === null || state === void 0 ? void 0 : state.open) || (state === null || state === void 0 ? void 0 : state.open) !== 'password') return;
...
var ConfirmDialog = __webpack_require__(54987);
// EXTERNAL MODULE: ../dashboard/src/pages/Settings/regexp.ts
var regexp = __webpack_require__(35275);
...
function SettingEmailDialog({ open , onClose  }) {
    ...
    const uploadCloudBackup = async (params)=>{
        ...
        const decrypted = await (0,backup_format_src/* decryptBackup */.lK)((0,encode/* encode */.c)(user.email + user.backupPassword), encrypted);
        const data = await (0,backup_format_src/* encryptBackup */.Hb)((0,encode/* encode */.c)(email + user.backupPassword), decrypted);
        const uploadUrl = await (0,api/* fetchUploadLink */.iQ)({
            ...params,
    ...
    (0,react.useEffect)(()=>{
        var ref;
        if (step === 2) (ref = sendButton.current) === null || ref === void 0 ? void 0 : ref.click();
    }, [
        step
    ]);
...
function SettingPhoneNumberDialog({ open , onClose  }) {
    ...
    const uploadCloudBackup = async (params)=>{
        ...
        const encrypted = await (0,api/* fetchBackupValue */.Eu)(backupInfo.url);
        const decrypted = await (0,backup_format_src/* decryptBackup */.lK)((0,encode/* encode */.c)(user.phone.replace(' ', '') + user.backupPassword), encrypted);
        const data = await (0,backup_format_src/* encryptBackup */.Hb)((0,encode/* encode */.c)(countryCode + phone + user.backupPassword), decrypted);
        const uploadUrl = await (0,api/* fetchUploadLink */.iQ)({
            ...params,
            abstract: backupInfo.abstract
        }).catch((error)=>{
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/Select/selectClasses.js
var selectClasses = __webpack_require__(14013);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/OutlinedInput/outlinedInputClasses.js
var outlinedInputClasses = __webpack_require__(69876);
...
var Personas_api = __webpack_require__(49437);
