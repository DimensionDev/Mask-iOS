"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[1035],{
...
var crypto_alpha_40 = __webpack_require__(62131);
// EXTERNAL MODULE: ./src/crypto/crypto-alpha-39.ts
var crypto_alpha_39 = __webpack_require__(73367);
// EXTERNAL MODULE: ./src/network/gun/index.ts
var gun = __webpack_require__(41134);
...
var text_payload_worker = __webpack_require__(24131);
// EXTERNAL MODULE: ./src/extension/background-script/CryptoServices/utils.ts
var utils = __webpack_require__(40452);
 ...
 */ async function* decryptFromPayloadWithProgress_raw(post, author, authorNetworkHint, whoAmI, discoverURL) {
    ...
    if (version === -40 || version === -39 || version === -38) {
        ...
        ;
        const mine = await queryWhoAmI().then((x)=>x || (0,src/* delay */.gw)(1000).then(queryWhoAmI)
        );
        ...
        try {
            ...
            const { keyHash , postHash  } = await (await Promise.all(/* import() */[__webpack_require__.e(4477), __webpack_require__.e(1435)]).then(__webpack_require__.bind(__webpack_require__, 40168))).calculatePostKeyPartition(version, iv, minePublic, gunNetworkHint);
            yield {
                type: 'debug',
        ...
        if (version === -40) {
            ...
            if (result === undefined) return makeError(locales_legacy/* i18n.t */.a.t('service_not_share_target'));
            aesKeyEncrypted.push(result);
        } else if (version === -39 || version === -38) {
            const keys = await gun/* GunAPI.queryPostKeysOnGun2 */.Oo.queryPostKeysOnGun2(version, iv, minePublic, authorNetworkWorker.val.gunNetworkHint);
        ...
        const subscription = gun/* GunAPISubscribe.subscribePostKeysOnGun2 */.OG.subscribePostKeysOnGun2(version, iv, minePublic, authorNetworkWorker.val.gunNetworkHint);
