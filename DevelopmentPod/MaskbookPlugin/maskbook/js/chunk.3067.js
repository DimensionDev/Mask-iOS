(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[3067],{
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/react-use@17.4.0/node_modules/react-use/esm/useUnmount.js
var useUnmount = __webpack_require__(90437);
...
;// CONCATENATED MODULE: ./src/plugins/Trader/locales/i18n_generated.js
/* eslint-disable */


const bind = (i18nKey) => (props) => (0,react.createElement)(Trans/* Trans */.c, { i18nKey, ns: "com.maskbook.trader", ...props })
function useI18N() {
    const { t } = (0,useTranslation/* useTranslation */.$)("com.maskbook.trader")
...
;// CONCATENATED MODULE: ./src/plugins/Trader/locales/index.ts
...
function useTradeCallback(trade, gasConfig) {
    const [wrapCallback, unwrapCallback] = (0,entry_web3_evm/* useNativeTokenWrapperCallback */.Hv)();
...
function useTradeCallback_useTradeCallback(tradeComputed, gasConfig) {
    ...
    return (0,useAsyncFn/* default */.Z)(async ()=>{
        ...
        return new Promise((resolve, reject)=>{
            web3.eth.sendTransaction(config_).on(types/* TransactionEventType.CONFIRMATION */.iE.CONFIRMATION, (_, receipt)=>{
                resolve(receipt.transactionHash);
            }).on(types/* TransactionEventType.ERROR */.iE.ERROR, reject);
        });
    }, [
        web3,
        account,
...
function balancer_useTradeCallback_useTradeCallback(trade, exchangeProxyContract, allowedSlippage = Trader_constants/* SLIPPAGE_DEFAULT */.Nd, gasConfig) {
    ...
    return (0,useAsyncFn/* default */.Z)(async ()=>{
        ...
        // send transaction and wait for hash
        return new Promise((resolve, reject)=>{
            tx.send(config).on(types/* TransactionEventType.CONFIRMATION */.iE.CONFIRMATION, (_, receipt)=>{
                resolve(receipt.transactionHash);
            }).on(types/* TransactionEventType.ERROR */.iE.ERROR, (error)=>{
                reject(error);
            });
...
function bancor_useTradeCallback_useTradeCallback(tradeComputed, gasConfig) {
    ...
    return (0,useAsyncFn/* default */.Z)(async ()=>{
        ...
        // send transaction and wait for hash
        return new Promise((resolve, reject)=>{
            web3.eth.sendTransaction(config_).on(types/* TransactionEventType.ERROR */.iE.ERROR, reject).on(types/* TransactionEventType.CONFIRMATION */.iE.CONFIRMATION, (_, receipt)=>{
                resolve(receipt.transactionHash);
            });
        });
    }, [
...
function trader_useTradeCallback_useTradeCallback(provider, tradeComputed, gasConfig, allowedSlippage) {
    ...
    switch(provider){
        ...
        case public_api_src/* TradeProvider.TRISOLARIS */.z4.TRISOLARIS:
            return uniswapV2Like;
        case public_api_src/* TradeProvider.VENOMSWAP */.z4.VENOMSWAP:
            return uniswapV2Like;
        case public_api_src/* TradeProvider.OPENSWAP */.z4.OPENSWAP:
            return uniswapV2Like;
        case public_api_src/* TradeProvider.MDEX */.z4.MDEX:
            return uniswapV2Like;
        case public_api_src/* TradeProvider.DEFIKINGDOMS */.z4.DEFIKINGDOMS:
            return uniswapV2Like;
...
var Info = __webpack_require__(9397);
// EXTERNAL MODULE: ../icons/utils/index.tsx
var utils = __webpack_require__(50498);
;// CONCATENATED MODULE: ../icons/general/Retweet.tsx


const RetweetIcon = (0,utils/* createPaletteAwareIcon */.t)('RetweetIcon', /*#__PURE__*/ (0,jsx_runtime.jsx)("g", {
    fill: "none",
...
const CramIcon = (0,utils/* createIcon */.I)('CramIcon', /*#__PURE__*/ (0,jsx_runtime.jsxs)("g", {
    fill: "none",
    children: [
...
const useGreatThanSlippageSetting = (priceImpact)=>{
    const slippageSetting = (0,shared_base_ui_src/* useValueRef */.E)(settings/* currentSlippageSettings */.It);
...
function ConfirmDialogUI(props) {
    ...
    const currentSlippage = (0,shared_base_ui_src/* useValueRef */.E)(settings/* currentSlippageSettings */.It);
    ...
    const { value: tokenPrice = 0  } = (0,entry_web3/* useNativeTokenPrice */.lb)(base_src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM, {
        chainId
    });
    ...
    const feeValueUSD = (0,react.useMemo)(()=>{
        if (!gasFee) return '0';
        return (0,formatter/* formatUSD */.ZP)((0,formatter/* formatWeiToEther */.yp)(gasFee).times(tokenPrice));
    }, [
        gasFee,
        tokenPrice
    ]);
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(src/* InjectedDialog */.Fl, {
            open: open,
            onClose: onClose,
            title: "Confirm Swap",
            children: [
                        ...
                        /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.Z, {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.Z, {
                                    children: [
                                        wallet?.name ? `(${wallet.name})` : /*#__PURE__*/ (0,jsx_runtime.jsx)(src/* FormattedAddress */.Kv, {
                                            address: account,
                                            size: 10,
                                            formatter: formatter/* formatEthereumAddress */.j8
                                        }),
                                        /*#__PURE__*/ (0,jsx_runtime.jsx)(src/* FormattedAddress */.Kv, {
                                        ...
                                        priceReversed ? /*#__PURE__*/ (0,jsx_runtime.jsxs)("span", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                                    children: (0,base_src/* formatBalance */.az)(inputAmount.dividedBy(outputAmount).shiftedBy(outputToken.decimals - inputToken.decimals).shiftedBy(inputToken.decimals).integerValue(), inputToken.decimals, 6)
                                                }),
                                                inputToken.symbol
                                            ]
                                        }) : /*#__PURE__*/ (0,jsx_runtime.jsxs)("span", {
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0,jsx_runtime.jsxs)("span", {
                                                    children: [
                                                        (0,base_src/* formatBalance */.az)(outputAmount.dividedBy(inputAmount).shiftedBy(inputToken.decimals - outputToken.decimals).shiftedBy(outputToken.decimals).integerValue(), outputToken.decimals, 6),
                                                        ' ',
                                                        outputToken.symbol
                                                    ]
                                                })
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.Z, {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                            component: "span",
                                            children: feeValueUSD === '<$0.01' ? t('plugin_trader_tx_cost_very_small', {
                                                usd: feeValueUSD
                                            }) : t('plugin_trader_tx_cost_usd', {
                                                usd: feeValueUSD
                                            })
                                        })
                                    ]
...
function useSortedTrades(traders, chainId, gasPrice) {
    ...
    const { value: outputTokenPrice = 0  } = (0,entry_web3/* useFungibleTokenPrice */.Of)(base_src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM, outputToken?.address.toLowerCase(), {
        chainId
    });
    return (0,react.useMemo)(()=>{
        if (outputToken && nativeToken && (outputTokenPrice || nativeTokenPrice)) {
            return traders.map((trade)=>{
                if (gasPrice && trade.value && (0,base_src/* isGreaterThan */.T1)(trade.value.outputAmount, Trader_constants/* MINIMUM_AMOUNT */.rI) && trade.gas.value) {
                    ...
                    const gasFeeUSD = new (bignumber_default())((0,base_src/* formatBalance */.az)(gasFee ?? 0, nativeToken?.decimals)).times(nativeTokenPrice);
                    const finalPrice = new (bignumber_default())((0,base_src/* formatBalance */.az)(trade.value.outputAmount, outputToken.decimals, 2)).times(outputToken.schema !== types/* SchemaType.Native */.XQ.Native ? outputTokenPrice : nativeTokenPrice).minus(gasFeeUSD);
                    return {
                        ...trade,
                        finalPrice
                    };
...
function useUpdateBalance(chainId) {
    const currentAccount = (0,entry_web3/* useAccount */.mA)(base_src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM);
    ...
    const balance = (0,entry_web3/* useBalance */.KQ)(base_src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM, {
        chainId
    });
    (0,react.useEffect)(()=>{
    ...
    (0,react.useEffect)(()=>{
        if (!currentAccount) return;
        const value = inputToken?.schema === types/* SchemaType.Native */.XQ.Native ? balance.value : '0';
        dispatchTradeStore({
            type: useAllProviderTradeContext/* AllProviderTradeActionType.UPDATE_INPUT_TOKEN_BALANCE */.AF.UPDATE_INPUT_TOKEN_BALANCE,
            balance: value || '0'
        });
    ...
    (0,react.useEffect)(()=>{
        if (!currentAccount) return;
        const value = outputToken?.schema === types/* SchemaType.Native */.XQ.Native || (0,base_src/* isSameAddress */.Wr)(outputToken?.address, NATIVE_TOKEN_ADDRESS) ? balance.value : '0';
        dispatchTradeStore({
            type: useAllProviderTradeContext/* AllProviderTradeActionType.UPDATE_OUTPUT_TOKEN_BALANCE */.AF.UPDATE_OUTPUT_TOKEN_BALANCE,
            balance: value || '0'
        });
...
const Gas1559Settings = /*#__PURE__*/ (0,react.memo)(({ onCancel , onSave: onSave_ , gasConfig , onSaveSlippage  })=>{
    ...
    const maxPriorFeeHelperText = (0,react.useMemo)(()=>{
        ...
        if ((0,base_src/* isLessThan */.FI)(maxPriorityFeePerGas1, gasOptions?.[base_src/* GasOptionType.SLOW */.Qd.SLOW]?.suggestedMaxPriorityFeePerGas ?? 0)) return t('wallet_transfer_error_max_priority_gas_fee_too_low');
        if ((0,base_src/* isGreaterThan */.T1)(maxPriorityFeePerGas1, (0,base_src/* multipliedBy */.$q)(gasOptions?.[base_src/* GasOptionType.FAST */.Qd.FAST]?.suggestedMaxPriorityFeePerGas ?? 0, HIGH_FEE_WARNING_MULTIPLIER))) return t('wallet_transfer_error_max_priority_gas_fee_too_high');
        return undefined;
    }, [
    ...
    const maxFeeGasHelperText = (0,react.useMemo)(()=>{
        if (getGasOptionsLoading) return undefined;
        if ((0,base_src/* isLessThan */.FI)(maxFeePerGas1, gasOptions?.[base_src/* GasOptionType.SLOW */.Qd.SLOW]?.estimatedBaseFee ?? 0)) return t('wallet_transfer_error_max_fee_too_low');
        if ((0,base_src/* isGreaterThan */.T1)(maxFeePerGas1, (0,base_src/* multipliedBy */.$q)(gasOptions?.[base_src/* GasOptionType.FAST */.Qd.FAST]?.suggestedMaxFeePerGas ?? 0, HIGH_FEE_WARNING_MULTIPLIER))) return t('wallet_transfer_error_max_fee_too_high');
        return undefined;
    }, [
        maxFeePerGas1,
        gasOptions,
...
const GasPrior1559Settings = /*#__PURE__*/ (0,react.memo)(({ onCancel , onSave: onSave_ , gasConfig , onSaveSlippage  })=>{
    ...
    const handleConfirm = (0,react.useCallback)(()=>{
        onSave_({
            gasPrice: (0,web3_utils_lib.toHex)((0,formatter/* formatGweiToWei */.nU)(options[selected].gasPrice).toString())
        });
    }, [
        selected,
        options
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                ...
                                children: t('plugin_trader_gas_option', {
                                    option: options[selected].title,
                                    value: new (bignumber_default())(options[selected].gasPrice ?? 0).toString()
                                })
                            })
                        ]
                    }),
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.Z, {
                                            ...
                                            children: [
                                                /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                                    ...
                                                    }) : new (bignumber_default())(option.gasPrice ?? 0).toString()
                                                }),
                                                t('wallet_transfer_gwei')
                                            ]
                                        }),
                                        /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                            ...
                                            children: t('popups_wallet_gas_fee_settings_usd', {
                                                usd: (0,formatter/* formatGweiToEther */.Hh)(option.gasPrice).times(nativeTokenPrice).times(21000).toPrecision(3)
                                            })
                                        })
                                    ]
                                }, index)
...
function SettingsDialog(props) {
    ...
    const slippage = (0,shared_base_ui_src/* useValueRef */.E)(settings/* currentSlippageSettings */.It);
    const chainId = (0,entry_web3/* useChainId */.xx)(base_src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM);
    ...
    const { open , setDialog , closeDialog  } = (0,shared_base_ui_src/* useRemoteControlledDialog */.F$)(messages/* PluginTraderMessages.swapSettingsUpdated */.A.swapSettingsUpdated);
    // #endregion
    (0,react.useEffect)(()=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(src/* InjectedDialog */.Fl, {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(DialogContent/* default */.Z, {
            children: [
                ...
                resolver/* chainResolver.isSupport */.VU.isSupport(chainId, 'EIP1559') ? /*#__PURE__*/ (0,jsx_runtime.jsx)(Gas1559Settings, {
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.8.0_4xriuibr7qayay6mzcpq5f43me/node_modules/@mui/material/Chip/chipClasses.js
var chipClasses = __webpack_require__(98431);
...
const InputTokenPanel_useStyles = (0,entry/* makeStyles */.ZL)()((theme, { isDashboard  })=>({
        filledInput: {
            borderRadius: 12,
            padding: 12,
...
const InputTokenPanel = /*#__PURE__*/ (0,react.memo)(({ chainId , token , balance , onAmountChange , amount , ...props })=>{
    const isDashboard = (0,shared_base_src/* isDashboardPage */.K2)();
    const { t  } = (0,src_utils/* useI18N */.M1)();
    const { classes  } = InputTokenPanel_useStyles({
        isDashboard
    });
    ...
    const { value: tokenPrice = 0  } = (0,entry_web3/* useFungibleTokenPrice */.Of)(base_src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM, token?.address.toLowerCase(), {
        chainId
    });
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(TextField/* default */.Z, {
        ...
        InputProps: {
            ...
            startAdornment: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.Z, {
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(src/* SelectTokenChip */.xR, {
                        token: token,
                        chainId: chainId,
                        classes: {
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.Z, {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Chip/* default */.Z, {
                                ...
                                onClick: ()=>{
                                    onAmountChange((0,base_src/* formatBalance */.az)(balance, token?.decimals, 6));
                                }
                            })
                        ]
                    })
...
const DropIcon = (0,utils/* createIcon */.I)('DropIcon', /*#__PURE__*/ (0,jsx_runtime.jsx)("g", {
    children: /*#__PURE__*/ (0,jsx_runtime.jsx)("path", {
...
const ChevronUpIcon = (0,utils/* createIcon */.I)('ChevronUpIcon', /*#__PURE__*/ (0,jsx_runtime.jsx)("g", {
    children: /*#__PURE__*/ (0,jsx_runtime.jsx)("path", {
        stroke: "currentColor",
...
var pipes = __webpack_require__(83049);
;// CONCATENATED MODULE: ../icons/general/BestTrade.tsx


const BestTradeIcon = (0,utils/* createIcon */.I)('BestTradeIcon', /*#__PURE__*/ (0,jsx_runtime.jsxs)("g", {
    children: [
        /*#__PURE__*/ (0,jsx_runtime.jsx)("path", {
...
const TriangleWarning = (0,utils/* createIcon */.I)('TriangleWarningIcon', /*#__PURE__*/ (0,jsx_runtime.jsxs)("g", {
    fill: "none",
    children: [
        /*#__PURE__*/ (0,jsx_runtime.jsx)("path", {
            opacity: ".2",
...
const TraderInfo = /*#__PURE__*/ (0,react.memo)(({ trade , gasPrice , isBest , onClick , isFocus  })=>{
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(TextField/* default */.Z, {
        ...
        variant: "filled",
        onClick: onClick,
        value: (0,base_src/* formatBalance */.az)(trade.value?.outputAmount ?? 0, trade.value?.outputToken?.decimals, 2),
        InputProps: {
...
function useTradeApproveComputed(trade, provider, token) {
    ...
    return (0,react.useMemo)(()=>{
        return {
            approveToken: token?.schema === types/* SchemaType.ERC20 */.XQ.ERC20 ? (0,utils_token/* createERC20Token */.wY)(chainId, token.address, token.name, token.symbol, token.decimals) : null,
            ...
            approveAddress: (()=>{
                ...
                if (context?.TYPE === public_api_src/* TradeProvider.OPENOCEAN */.z4.OPENOCEAN) return trade?.trade_ ? trade?.trade_.to : context?.SPENDER_CONTRACT_ADDRESS;
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.8.0_ar3vczqpton7uep5462l6mtgi4/node_modules/@mui/icons-material/esm/ArrowDownward.js
var ArrowDownward = __webpack_require__(62834);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.8.0_ar3vczqpton7uep5462l6mtgi4/node_modules/@mui/icons-material/esm/HelpOutline.js
var HelpOutline = __webpack_require__(54878);
...
const TradeForm = /*#__PURE__*/ (0,react.memo)(({ account , trades , inputAmount , inputToken , outputToken , onTokenChipClick =noop/* default */.Z , onInputAmountChange , inputTokenBalance , outputTokenBalance , focusedTrade , onFocusedTradeChange , onSwap , gasPrice , onSwitch ,  })=>{
    ...
    const { targetChainId: chainId  } = entry_web3_evm/* TargetChainIdContext.useContainer */.Zq.useContainer();
    const { isSwapping  } = useAllProviderTradeContext/* AllProviderTradeContext.useContainer */.TX.useContainer();
    ...
    const { openDialog: openSwapSettingDialog  } = (0,shared_base_ui_src/* useRemoteControlledDialog */.F$)(messages/* PluginTraderMessages.swapSettingsUpdated */.A.swapSettingsUpdated);
    // #endregion
    ...
    const nativeWrapMessage = (0,react.useMemo)(()=>{
        if (focusedTrade?.value) {
            ...
            return t('plugin_trader_swap_amount_symbol', {
                amount: (0,base_src/* formatBalance */.az)(focusedTrade?.value?.outputAmount ?? 0, focusedTrade?.value?.outputToken?.decimals, 2),
                symbol: outputToken?.symbol
            });
        } else {
                    ...
                    account ? /*#__PURE__*/ (0,jsx_runtime.jsx)(Box/* default */.Z, {
                        ...
                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(ChainBoundary/* ChainBoundary */.s, {
                            ...
                            children: /*#__PURE__*/ (0,jsx_runtime.jsx)(EthereumERC20TokenApprovedBoundary/* EthereumERC20TokenApprovedBoundary */.L, {
                                ...
                                token: !(0,helpers/* isNativeTokenWrapper */.fU)(focusedTrade?.value ?? null) && approveToken?.schema === types/* SchemaType.ERC20 */.XQ.ERC20 && !!approveAmount.toNumber() ? approveToken : undefined,
                                ...
                                render: (disable)=>isGreatThanSlippageSetting ? /*#__PURE__*/ (0,jsx_runtime.jsx)(ActionButton/* default */.ZP, {
                                        ...
                                        variant: "contained",
                                        color: "error",
                                        disabled: focusedTrade?.loading || !focusedTrade?.value || disable || isSwapping,
                                        classes: {
                                            root: classes.button,
                                            disabled: classes.disabledButton
                                        },
                                        ...
                                        loading: isSwapping,
                                        variant: "contained",
                                        disabled: focusedTrade?.loading || !focusedTrade?.value || !!validationMessage || disable || isSwapping,
                                        classes: {
                                            root: classes.button,
                                            disabled: classes.disabledButton
                                        },
...
function Trader(props) {
    ...
    const chainIdValid = (0,entry_web3/* useChainIdValid */.as)(base_src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM);
    const { NATIVE_TOKEN_ADDRESS  } = (0,constants/* useTokenConstants */.kd)();
    const classes = (0,entry/* useStylesExtends */.Bc)(Trader_useStyles(), props);
    const t = useI18N();
    const { setTargetChainId  } = entry_web3_evm/* TargetChainIdContext.useContainer */.Zq.useContainer();
    // #region trade state
    const { setIsSwapping , tradeState: [{ inputToken , outputToken , inputTokenBalance , outputTokenBalance , inputAmount  }, dispatchTradeStore, ] , allTradeComputed , setTemporarySlippage ,  } = useAllProviderTradeContext/* AllProviderTradeContext.useContainer */.TX.useContainer();
    // #endregion
    // #region gas config and gas price
    const { gasPrice , gasConfig , setGasConfig  } = (0,entry_web3_evm/* useGasConfig */.cI)(chainId);
    // #endregion
    ...
    const updateTradingCoin = (0,react.useCallback)((type, coin)=>{
        ...
        dispatchTradeStore({
            type,
            token: (0,utils_token/* createERC20Token */.wY)(chainId, coin.contract_address, coin.name, coin.symbol, coin.decimals)
        });
    }, [
        chainId
    ]);
    ...
    (0,react.useEffect)(()=>{
        ...
        if ((0,base_src/* isSameAddress */.Wr)(coin1.contract_address, NATIVE_TOKEN_ADDRESS) && inputToken?.schema === types/* SchemaType.Native */.XQ.Native && coin1.symbol === inputToken.symbol) {
            dispatchTradeStore({
                type: useAllProviderTradeContext/* AllProviderTradeActionType.UPDATE_INPUT_TOKEN */.AF.UPDATE_INPUT_TOKEN,
                token: undefined
            });
    ...
    (0,react.useEffect)(()=>{
        ...
        dispatchTradeStore({
            type: useAllProviderTradeContext/* AllProviderTradeActionType.UPDATE_INPUT_TOKEN */.AF.UPDATE_INPUT_TOKEN,
            token: defaultInputCoin.contract_address ? (0,utils_token/* createERC20Token */.wY)(chainId, defaultInputCoin.contract_address, defaultInputCoin.name, defaultInputCoin.symbol, defaultInputCoin.decimals) : undefined
        });
    }, [
        defaultInputCoin,
        chainId
    ...
    const { value: inputTokenBalance_ , loading: loadingInputTokenBalance  } = (0,entry_web3/* useFungibleTokenBalance */.V4)(base_src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM, inputToken?.address ?? '', {
        chainId
    });
    const { value: outputTokenBalance_ , loading: loadingOutputTokenBalance  } = (0,entry_web3/* useFungibleTokenBalance */.V4)(base_src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM, outputToken?.address ?? '', {
        chainId
    });
    (0,react.useEffect)(()=>{
        if (!inputToken || inputToken.schema === types/* SchemaType.Native */.XQ.Native || !inputTokenBalance_ || loadingInputTokenBalance) {
            return;
        }
        dispatchTradeStore({
            type: useAllProviderTradeContext/* AllProviderTradeActionType.UPDATE_INPUT_TOKEN_BALANCE */.AF.UPDATE_INPUT_TOKEN_BALANCE,
    ...
    (0,react.useEffect)(()=>{
        if (!outputToken || outputToken.schema === types/* SchemaType.Native */.XQ.Native || !outputTokenBalance_ || loadingOutputTokenBalance) {
            return;
        }
        dispatchTradeStore({
            type: useAllProviderTradeContext/* AllProviderTradeActionType.UPDATE_OUTPUT_TOKEN_BALANCE */.AF.UPDATE_OUTPUT_TOKEN_BALANCE,
    ...
    const [{ loading: isTrading  }, tradeCallback] = trader_useTradeCallback_useTradeCallback(focusedTrade?.provider, focusedTrade?.value, gasConfig);
    (0,react.useEffect)(()=>{
    ...
    const shareText = (0,react.useMemo)(()=>{
        ...
        return focusedTrade?.value && inputToken && outputToken ? t.share_text({
            input_amount: (0,base_src/* formatBalance */.az)(focusedTrade.value.inputAmount, inputToken.decimals, 6),
            input_symbol: `${cashTag}${inputToken.symbol}`,
            output_amount: (0,base_src/* formatBalance */.az)(focusedTrade.value.outputAmount, outputToken.decimals, 6),
    ...
    const onConfirmDialogConfirm = (0,react.useCallback)(async ()=>{
        ...
        await openShareTxDialog({
            hash,
            buttonLabel: social_network/* activatedSocialNetworkUI.utils.share */.LM.utils.share ? 'Share' : 'Confirm',
            onShare () {
