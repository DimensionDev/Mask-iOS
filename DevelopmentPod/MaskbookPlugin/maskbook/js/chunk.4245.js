"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[4245],{
 ...
 */ async function* decryptFromPayloadWithProgress_raw(post, author, authorNetworkHint, whoAmI, discoverURL) {
    ...
    if (version === -40 || version === -39 || version === -38) {
        ...
        try {
            ...
            const { keyHash , postHash  } = await (await Promise.all(/* import() */[__webpack_require__.e(4477), __webpack_require__.e(451)]).then(__webpack_require__.bind(__webpack_require__, 21959))).calculatePostKeyPartition(version, iv, minePublic, gunNetworkHint);
            yield {
                type: 'debug',
