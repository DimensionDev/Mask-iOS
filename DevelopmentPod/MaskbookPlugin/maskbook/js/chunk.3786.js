"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[3786,9613],{
...
var social_network_utils = __webpack_require__(55334);
// EXTERNAL MODULE: ./src/social-network/utils/create-post-context.ts + 1 modules
var create_post_context = __webpack_require__(3025);
...
var shared = __webpack_require__(17321);
    ...
    configuration: {
        steganography: {
            password () {
                ...
                return new shared_base_src/* ProfileIdentifier */.WO('minds.com', shared_base_src/* ProfileIdentifier.getUserName */.WO.getUserName(IdentityProviderMinds.recognized.value.identifier) || shared_base_src/* ProfileIdentifier.getUserName */.WO.getUserName(social_network.globalUIState.profiles.value[0].identifier) || (0,esm/* unreachable */.t1)('Cannot figure out password')).toText();
            }
        }
    }
};
