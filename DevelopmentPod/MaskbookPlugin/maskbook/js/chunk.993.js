"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[993],{
...
var post_helper = __webpack_require__(39885);
...
async function encryptTo(content, target, whoAmI) {
    ...
    (async ()=>{
        ...
        const usingPersona = profile === null || profile === void 0 ? void 0 : profile.linkedPersona;
...
// EXTERNAL MODULE: ./background/database/post/index.ts
var database_post = __webpack_require__(32849);
// EXTERNAL MODULE: ./background/services/crypto/decryption.ts
var decryption = __webpack_require__(26768);
...
async function appendShareTarget(version, post, target, whoAmI, reason) {
    ...
    const postBy = (postRec === null || postRec === void 0 ? void 0 : postRec.encryptBy) || (postRec === null || postRec === void 0 ? void 0 : postRec.postBy) || whoAmI;
    if (whoAmI === null || whoAmI === void 0 ? void 0 : whoAmI.isUnknown) throw new Error('Cannot find private key');
 ...
 */ async function getPartialSharedListOfPost(id) {
    var ref;
    const ids = new Set();
    const nameInDB = (ref = await (0,database_post/* queryPostDB */.q3)(id)) === null || ref === void 0 ? void 0 : ref.recipients;
