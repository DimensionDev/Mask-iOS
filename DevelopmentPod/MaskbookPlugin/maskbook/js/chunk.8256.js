"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[8256,9990],{
...
var url = __webpack_require__(44730);
...
function useNFTAvatar(userId) {
    return (0,useAsync/* default */.Z)(async ()=>{
        ...
        return Avatar_messages/* PluginNFTAvatarRPC.getNFTAvatar */.B.getNFTAvatar(userId, social_network/* activatedSocialNetworkUI.networkIdentifier */.LM.networkIdentifier);
    }, [
        userId,
    ...
    configuration: {
        steganography: {
            password () {
                ...
                return new shared_base_src/* ProfileIdentifier */.WO('twitter.com', shared_base_src/* ProfileIdentifier.getUserName */.WO.getUserName(IdentityProviderTwitter.recognized.value.identifier) || shared_base_src/* ProfileIdentifier.getUserName */.WO.getUserName(social_network/* globalUIState.profiles.value.0.identifier */.EJ.profiles.value[0].identifier) || (0,esm/* unreachable */.t1)('Cannot figure out password')).toText();
            }
        }
    }
};
...
/* harmony import */ var _url__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(44730);
