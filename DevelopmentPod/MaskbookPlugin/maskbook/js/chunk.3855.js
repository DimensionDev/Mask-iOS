"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[3855],{
...
var usePoolTogetherPool = __webpack_require__(52491);
...
var PoolTogether_messages = __webpack_require__(48551);
// EXTERNAL MODULE: ./src/plugins/PoolTogether/utils.ts
var utils = __webpack_require__(80472);
...
function DepositDialog() {
    ...
    // #region blocking
    const [depositState, depositCallback, resetDepositCallback] = useDepositCallback((_address = pool === null || pool === void 0 ? void 0 : pool.prizePool.address) !== null && _address !== void 0 ? _address : '', amount.toFixed(), (_address1 = pool === null || pool === void 0 ? void 0 : pool.tokens.ticket.address) !== null && _address1 !== void 0 ? _address1 : '', specific/* ZERO_ADDRESS */.r_, token);
    // #endregion
    // #region Swap
    ...
    var ref3;
    const shareLink = (ref = (_utils = social_network.activatedSocialNetworkUI.utils).getShareLinkURL) === null || ref === void 0 ? void 0 : ref.call(_utils, token ? t((0,base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) || (0,facebook_com_base/* isFacebook */.DF)(social_network.activatedSocialNetworkUI) ? 'plugin_pooltogether_share' : 'plugin_pooltogether_share_no_official_account', {
        amount: rawAmount,
        cashTag: cashTag,
        symbol: token.symbol,
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(50229);
...
const PluginPooltogetherRPC = (0,_masknet_plugin_infra__WEBPACK_IMPORTED_MODULE_0__/* .createPluginRPC */ .V8)(_constants__WEBPACK_IMPORTED_MODULE_1__/* .POOLTOGETHER_PLUGIN_ID */ .hD, ()=>__webpack_require__.e(/* import() */ 5483).then(__webpack_require__.bind(__webpack_require__, 45483))
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(50229);
