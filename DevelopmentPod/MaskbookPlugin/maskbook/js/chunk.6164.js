...
;// CONCATENATED MODULE: ./src/plugin-infra/I18NFieldRender.tsx
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.2.5_695e98f08a2d125282e19cae338368d2/node_modules/@mui/icons-material/Done.js
var Done = __webpack_require__(80099);
...
const CustomEntry = /*#__PURE__*/ (0,react.memo)(/*#__PURE__*/ (0,react.forwardRef)((props, ref)=>{
    ...
    return(/*#__PURE__*/ (0,jsx_runtime.jsx)(ClickableChip, {
        label: /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
            children: [
                /*#__PURE__*/ (0,jsx_runtime.jsx)(PluginI18NFieldRender, {
                    field: label,
                    pluginID: id
                }),
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/react-highlight-words@0.17.0/node_modules/react-highlight-words/dist/main.js
var main = __webpack_require__(87624);
...
async function SteganographyTextPayload(template, text) {
    ...
    const secretImage = await service/* default.Crypto.steganographyEncodeImage */.ZP.Crypto.steganographyEncodeImage(new Uint8Array(blankImage), {
        ...
        pass,
        template,
        grayscaleAlgorithm: (ref3 = (ref2 = social_network.activatedSocialNetworkUI.configuration.steganography) === null || ref2 === void 0 ? void 0 : ref2.grayscaleAlgorithm) !== null && ref3 !== void 0 ? ref3 : encryption_src/* GrayscaleAlgorithm.NONE */.Ft.NONE
    });
    const blob = new Blob([
        secretImage
    ], {
...
function useSubmit(onClose) {
    ...
    return (0,react.useCallback)(async (info)=>{
        ...
        const network = social_network.activatedSocialNetworkUI.networkIdentifier;
        const currentProfile = new shared_base_src/* ProfileIdentifier */.WO(network, shared_base_src/* ProfileIdentifier.getUserName */.WO.getUserName(social_network.globalUIState.profiles.value[0].identifier) || (0,kit_esm/* unreachable */.t1)('Cannot figure out current profile'));
        var ref;
        ...
        const redPacketPreText = (0,base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) || (0,facebook_com_base/* isFacebook */.DF)(social_network.activatedSocialNetworkUI) ? t('additional_post_box__encrypted_post_pre_red_packet_twitter_official_account', {
            encrypted,
            account: (0,base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) ? t('twitter_account') : t('facebook_account')
...
function pasteTextEncode(text) {
    var ref, ref3;
    (ref = social_network.activatedSocialNetworkUI.automation.nativeCompositionDialog) === null || ref === void 0 ? void 0 : (ref3 = ref.appendText) === null || ref3 === void 0 ? void 0 : ref3.call(ref, text, {
        recover: true
    });
}
...
function Composition({ type ='timeline' , requireClipboardPermission  }) {
    ...
    const networkSupport = (ref3 = social_network.activatedSocialNetworkUI.injection.newPostComposition) === null || ref3 === void 0 ? void 0 : ref3.supportedOutputTypes;
    var ref1, ref2;
...
/* harmony import */ var _ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(94922);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.2.5_811d2bc6069f340521b4a59905442643/node_modules/@mui/material/DialogContent/DialogContent.js
var DialogContent = __webpack_require__(55535);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.2.5_811d2bc6069f340521b4a59905442643/node_modules/@mui/material/DialogContentText/DialogContentText.js
var DialogContentText = __webpack_require__(70944);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.2.5_811d2bc6069f340521b4a59905442643/node_modules/@mui/material/TextField/TextField.js
var TextField = __webpack_require__(92498);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.2.5_811d2bc6069f340521b4a59905442643/node_modules/@mui/material/DialogActions/DialogActions.js
var DialogActions = __webpack_require__(52153);
// EXTERNAL MODULE: ./src/components/shared/Image.tsx
var Image = __webpack_require__(78486);
// EXTERNAL MODULE: ../../node_modules/.pnpm/react-draggable@4.4.4/node_modules/react-draggable/build/cjs/cjs.js
var cjs = __webpack_require__(93069);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.2.5_695e98f08a2d125282e19cae338368d2/node_modules/@mui/icons-material/CloudDownload.js
var CloudDownload = __webpack_require__(889);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.2.5_695e98f08a2d125282e19cae338368d2/node_modules/@mui/icons-material/Close.js
var Close = __webpack_require__(39419);
// EXTERNAL MODULE: ./shared/index.ts + 1 modules
var shared = __webpack_require__(89650);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.2.5_695e98f08a2d125282e19cae338368d2/node_modules/@mui/icons-material/Close.js
var Close = __webpack_require__(39419);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.2.5_811d2bc6069f340521b4a59905442643/node_modules/@mui/material/colors/green.js
var green = __webpack_require__(17523);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/react-window@1.8.6/node_modules/react-window/dist/index.esm.js
var index_esm = __webpack_require__(49298);
...
function PossiblePluginSuggestionUI(props) {
    ...
    return(/*#__PURE__*/ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
        children: plugins.map((x)=>/*#__PURE__*/ (0,jsx_runtime.jsx)(MaskPluginWrapper/* default */.Z, {
                pluginName: t('plugin_not_enabled', {
                    plugin: x.name.fallback
                }),
...
var text_payload_ui = __webpack_require__(94506);
...
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(74750);
/* harmony import */ var _utils_shadow_root_renderInShadowRoot__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(74936);
/* harmony import */ var _components_InjectedComponents_SetupGuide__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(24957);
...
/* harmony import */ var _utils_messages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(86865);
...
/* harmony export */ });
/* harmony import */ var _utils_messages__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(86865);
/* harmony import */ var _extension_service__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8267);
...
function createSNSAdaptorSpecializedPostContext(create) {
    return function createPostContext(opt) {
        ...
        cancel.push(postContent.addListener((post)=>{
            var ref;
            links.clear();
            (0,src/* parseURL */.Lk)(post).forEach((link)=>links.add(resolveFacebookLink(link, social_network.activatedSocialNetworkUI.networkIdentifier))
            );
            (ref = opt.postMentionedLinksProvider) === null || ref === void 0 ? void 0 : ref.getCurrentValue().forEach((link)=>links.add(resolveFacebookLink(link, social_network.activatedSocialNetworkUI.networkIdentifier))
            );
        }));
