(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[8781],{
...
var Copy = __webpack_require__(59640);
...
const useStyles = (0,src/* makeStyles */.ZL)()((theme)=>({
        ...
        copy: {
            ...
            marginLeft: 12,
            cursor: 'pointer',
            stroke: src/* MaskColorVar.textPrimary */.ZN.textPrimary
        }
    })
);
...
const CreateMnemonic_useStyles = (0,src/* makeStyles */.ZL)()((theme)=>({
        container: {
            padding: '120px 18%',
            display: 'flex',
...
const CreateMnemonic = /*#__PURE__*/ (0,react.memo)(()=>{
    ...
    const [walletState, onSubmit] = (0,useAsyncFn/* default */.Z)(async ()=>{
        ...
        const password = (ref = location.state) === null || ref === void 0 ? void 0 : ref.password;
    ...
    (0,react.useEffect)(()=>{
        var ref;
        if (!((ref = location.state) === null || ref === void 0 ? void 0 : ref.password) && !hasPassword && !loading) navigate(-1);
    }, [
        location.state,
        hasPassword,
        loading
