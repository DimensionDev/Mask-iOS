"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[7083],{
...
function create(name, prefix, initialData) {
    const url = dist_default()(DEFAULT_HOST, prefix ? ':prefix.:name.json' : ':name.json', {
        name,
        prefix: prefix !== null && prefix !== void 0 ? prefix : DEFAULT_PREFIX
    });
    ...
    ProfileTabs: [
        {
            ...
            Utils: {
                shouldDisplay: (identity, _addressNames)=>{
                    ...
                    return !(identity === null || identity === void 0 ? void 0 : identity.identifier.isUnknown) && (daoTabTwitterIdList !== null && daoTabTwitterIdList !== void 0 ? daoTabTwitterIdList : []).some((x)=>{
