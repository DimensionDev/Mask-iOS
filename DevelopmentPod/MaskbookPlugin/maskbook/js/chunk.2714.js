"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[2714],{
...
var utils_chainDetailed = __webpack_require__(80945);
...
var base = __webpack_require__(74343);
// EXTERNAL MODULE: ./src/plugins/RedPacket/constants.ts
var constants = __webpack_require__(99850);
...
var messages = __webpack_require__(5471);
...
var TokenAmountPanel = __webpack_require__(22538);
...
var call = __webpack_require__(46522);
...
const ERC721ContractSelectPanel_useStyles = (0,theme_src/* makeStyles */.ZL)()((theme, props)=>{
    return {
        root: {
            height: 52,
...
const EthereumERC721TokenApprovedBoundary_useStyles = (0,theme_src/* makeStyles */.ZL)()(()=>({
        snackBarText: {
            fontSize: 14
        },
        snackBarLink: {
...
function EthereumERC721TokenApprovedBoundary(props) {
    ...
    const { t  } = (0,utils/* useI18N */.M1)();
    const classes = (0,theme_src/* useStylesExtends */.Bc)(EthereumERC721TokenApprovedBoundary_useStyles(), props);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.4.2_c6f532f0ffa0f9bea763747ab672d46f/node_modules/@mui/icons-material/AddCircleOutline.js
var AddCircleOutline = __webpack_require__(40089);
...
const RedpacketMessagePanel_useStyles = (0,theme_src/* makeStyles */.ZL)()((theme)=>{
    return {
        root: {
            height: 52,
            border: `1px solid ${theme.palette.mode === 'light' ? '#EBEEF0' : '#2F3336'}`,
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.4.2_c6f532f0ffa0f9bea763747ab672d46f/node_modules/@mui/icons-material/QuestionMark.js
var QuestionMark = __webpack_require__(5463);
// EXTERNAL MODULE: ../icons/general/Search.tsx
var Search = __webpack_require__(76102);
...
const SelectNftTokenDialog_useStyles = (0,theme_src/* makeStyles */.ZL)()((theme, props)=>({
        dialogContent: {
            minHeight: 380
        },
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.4.2_c6f532f0ffa0f9bea763747ab672d46f/node_modules/@mui/icons-material/Launch.js
var Launch = __webpack_require__(3799);
...
const RedpacketNftConfirmDialog_useStyles = (0,theme_src/* makeStyles */.ZL)()((theme)=>({
        root: {
            fontSize: 16
        },
        link: {
...
function RedpacketNftConfirmDialog(props) {
    ...
    const { attachMetadata  } = (0,src/* useCompositionContext */.Cp)();
    const { t  } = (0,utils/* useI18N */.M1)();
...
const RedPacketCreateNew_useStyles = (0,theme_src/* makeStyles */.ZL)()((theme, { snsId  })=>({
        tab: {
            height: 36,
            minHeight: 36,
            fontWeight: 300
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.2_859545d82eec4e4ab7d574641ee2c82e/node_modules/@mui/material/Popper/Popper.js
var Popper = __webpack_require__(11825);
// EXTERNAL MODULE: ../web3-shared/evm/hooks/useFungibleTokenDetailed.ts
var useFungibleTokenDetailed = __webpack_require__(58608);
...
var StyledLinearProgress = __webpack_require__(27974);
...
const RedPacketHistoryList_useStyles = (0,theme_src/* makeStyles */.ZL)()((theme)=>{
    const smallQuery = `@media (max-width: ${theme.breakpoints.values.sm}px)`;
    return {
        root: {
            display: 'flex',
...
const NftList_useStyles = (0,theme_src/* makeStyles */.ZL)()((theme)=>{
    const smallQuery = `@media (max-width: ${theme.breakpoints.values.sm}px)`;
    return {
        list: {
            display: 'grid',
...
const NftRedPacketHistoryList_useStyles = (0,theme_src/* makeStyles */.ZL)()((theme, _, refs)=>{
    const smallQuery = `@media (max-width: ${theme.breakpoints.values.sm}px)`;
    return {
        root: {
            display: 'flex',
...
const RedPacketPast_useStyles = (0,theme_src/* makeStyles */.ZL)()((theme)=>({
        tab: {
            height: 36,
            minHeight: 36,
            fontWeight: 300
...
var useNetworkType = __webpack_require__(2809);
        ...
        tabs: [
            {
                ...
                children: (0,theme_src/* usePortalShadowRoot */.ad)((container)=>/*#__PURE__*/ (0,jsx_runtime.jsx)(RedPacketCreateNew, {
                        origin: settings,
                        onNext: onNext,
                        state: tokenState,
                        onClose: onClose,
...
const useStyles_useStyles = (0,theme_src/* makeStyles */.ZL)()((theme)=>{
    const spinningAnimationKeyFrames = theme_src/* keyframes */.F4`
to {
...
function RedPacket(props) {
    ...
    const shareLink = (ref2 = (_utils = social_network/* activatedSocialNetworkUI.utils */.LM.utils).getShareLinkURL) === null || ref2 === void 0 ? void 0 : ref2.call(_utils, t((0,twitter_com_base/* isTwitter */.L3)(social_network/* activatedSocialNetworkUI */.LM) || (0,facebook_com_base/* isFacebook */.DF)(social_network/* activatedSocialNetworkUI */.LM) ? 'plugin_red_packet_share_message_official_account' : 'plugin_red_packet_share_message_not_twitter', {
...
function RedPacketInPost(props) {
    ...
    const fromUrl = postIdentifier && !postIdentifier.isUnknown ? (ref = (_utils = social_network/* activatedSocialNetworkUI.utils */.LM.utils).getPostURL) === null || ref === void 0 ? void 0 : (ref1 = ref.call(_utils, postIdentifier)) === null || ref1 === void 0 ? void 0 : ref1.toString() : undefined;
    (0,react.useEffect)(()=>{
        if (!fromUrl) return;
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.2_859545d82eec4e4ab7d574641ee2c82e/node_modules/@mui/material/CardMedia/CardMedia.js
var CardMedia = __webpack_require__(58847);
...
const RedPacketNft_useStyles = (0,theme_src/* makeStyles */.ZL)()((theme)=>({
        root: {
            position: 'relative'
        },
        actions: {
...
function RedPacketNft({ payload  }) {
    ...
    const postLink = (0,usePostInfo/* usePostLink */.Vc)();
    const networkType = (0,useNetworkType/* useNetworkType */.b)();
    const shareLink = (ref = (_utils = social_network/* activatedSocialNetworkUI.utils */.LM.utils).getShareLinkURL) === null || ref === void 0 ? void 0 : ref.call(_utils, (availability === null || availability === void 0 ? void 0 : availability.isClaimed) ? t((0,twitter_com_base/* isTwitter */.L3)(social_network/* activatedSocialNetworkUI */.LM) || (0,facebook_com_base/* isFacebook */.DF)(social_network/* activatedSocialNetworkUI */.LM) ? 'plugin_red_packet_nft_share_claimed_message' : 'plugin_red_packet_nft_share_claimed_message_not_twitter', {
...
var general_RedPacket = __webpack_require__(66502);
...
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(99850);
...
const RedPacketRPC = (0,_masknet_plugin_infra__WEBPACK_IMPORTED_MODULE_1__/* .createPluginRPC */ .V8)(_constants__WEBPACK_IMPORTED_MODULE_0__/* .RedPacketPluginID */ .jY, ()=>Promise.all(/* import() */[__webpack_require__.e(2698), __webpack_require__.e(3294), __webpack_require__.e(5132), __webpack_require__.e(4544), __webpack_require__.e(187), __webpack_require__.e(5737), __webpack_require__.e(3883), __webpack_require__.e(6045), __webpack_require__.e(2299), __webpack_require__.e(1077), __webpack_require__.e(2943), __webpack_require__.e(8117), __webpack_require__.e(8492), __webpack_require__.e(7765), __webpack_require__.e(1305), __webpack_require__.e(5891), __webpack_require__.e(8936), __webpack_require__.e(6265), __webpack_require__.e(1246), __webpack_require__.e(7141), __webpack_require__.e(708), __webpack_require__.e(9447), __webpack_require__.e(1544), __webpack_require__.e(2145), __webpack_require__.e(2511), __webpack_require__.e(5875)]).then(__webpack_require__.bind(__webpack_require__, 91624))
