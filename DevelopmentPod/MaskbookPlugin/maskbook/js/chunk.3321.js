"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[3321],{
...
/* harmony import */ var _social_network_define__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9758);
...
/* harmony import */ var _masknet_plugin_wallet__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(39973);
...
/* harmony import */ var _messages__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(86865);
...
const MaskNetworkAPI = {
    ...
    settings_getBackupPreviewInfo: async ({ backupInfo  })=>{
        const data = _extension_service__WEBPACK_IMPORTED_MODULE_5__/* ["default"].Welcome.parseBackupStr */ .ZP.Welcome.parseBackupStr(backupInfo);
    ...
    async SNSAdaptor_getCurrentDetectedProfile () {
        var ref;
        const { activatedSocialNetworkUI  } = await Promise.resolve(/* import() */).then(__webpack_require__.bind(__webpack_require__, 29980));
        return (ref = activatedSocialNetworkUI.collecting.identityProvider) === null || ref === void 0 ? void 0 : ref.recognized.value.identifier.toText();
    },
