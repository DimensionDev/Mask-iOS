...
;(function(){
  ...
  function USE(arg, req){
    return req? __webpack_require__(9134)(arg) : arg.slice? USE[R(arg)] : function(mod, path){
      arg(mod = {exports: {}});
...
;(function(){
	...
	function Radisk(opt){
		...
		if(''+u != "function"){ __webpack_require__(65270) }
		var parse = JSON.parseAsync || function(t,cb,r){ var u; try{ cb(u, JSON.parse(t,r)) }catch(e){ cb(e) } }
		var json = JSON.stringifyAsync || function(v,cb,r,s){ var u; try{ cb(u, JSON.stringify(v,r,s)) }catch(e){ cb(e) } }
		/*
    ...
    r.tags = {};
		...
		*/
		...
		try{ !Gun.window && __webpack_require__(42707)(r) }catch(e){}
...
Gun.on('create', function(root){
    ...
    var Radisk = (Gun.window && Gun.window.Radisk) || __webpack_require__(97062);
...
;(function(){
  ...
  ;USE(function(module){
    ...
    if(u+''== typeof btoa){
      if(u+'' == typeof Buffer){
        try{ __webpack_require__.g.Buffer = USE("buffer", 1).Buffer }catch(e){ console.log("Please add `buffer` to your package.json!") }
      }
