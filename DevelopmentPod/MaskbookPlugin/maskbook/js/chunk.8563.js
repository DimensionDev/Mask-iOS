(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[8563,6631,6880],{
...
var EthereumServices_web3 = __webpack_require__(99039);
...
var web3_eth_abi_lib = __webpack_require__(9177);
        ...
        if (abi) {
            try {
                return {
                    ...
                    name: abi.name,
                    parameters: rpc_coder.decodeParameters(abi.parameters, parameters ?? ''),
                    _tx: config
                };
            } catch  {
            // do nothing
...
function hasError(error, response) {
    return !(0,isNil/* default */.Z)(error) || !(0,isNil/* default */.Z)(response?.error);
}
    ...
    switch(computedPayload.type){
        ...
        case types/* EthereumRpcType.CONTRACT_INTERACTION */.Wv.CONTRACT_INTERACTION:
            if ([
                'transfer',
                'transferFrom'
            ].includes(computedPayload.name ?? '')) return computedPayload.parameters?.to ?? '';
    }
    return '';
}
async function handleTransferTransaction(chainId, payload) {
    ...
    if (!computedPayload) return;
    const from = computedPayload._tx.from ?? '';
...
async function handleNonce(chainId, account, error, response) {
    ...
    const error_ = error ?? response?.error;
 ...
 */ async function INTERNAL_send(payload, callback, { chainId =settings/* currentChainIdSettings.value */.wU.value , account =settings/* currentAccountSettings.value */.aK.value , providerType =settings/* currentProviderSettings.value */.t1.value  } = {}) {
    ...
    async function sendTransaction() {
        ...
        config.gas = (0,lib.toHex)(config.gas ?? '0');
        // add chain id
 ...
 */ async function INTERNAL_nativeSend(payload, callback, { account =settings/* currentAccountSettings.value */.aK.value , chainId =settings/* currentChainIdSettings.value */.wU.value  } = {}) {
    ...
    try {
        let response;
        const _ = await native_rpc/* nativeAPI */.Nz?.api.send(payload);
        if (_) {
            const { error , ...rest } = _;
            response = {
                ...rest
...
var helper = __webpack_require__(86631);
...
async function requestSend(payload, callback, overrides, options) {
    ...
    const { providerType =settings/* currentProviderSettings.value */.t1.value  } = overrides ?? {};
    const chainId = overrides?.chainId ?? (providerType === types/* ProviderType.MaskWallet */.lP.MaskWallet ? settings/* currentMaskWalletChainIdSettings.value */.DT.value : settings/* currentChainIdSettings.value */.wU.value);
    ...
    if (payload_.method === types/* EthereumMethodType.ETH_SEND_TRANSACTION */.W8.ETH_SEND_TRANSACTION) {
        ...
        if ((0,chainDetailed/* isEIP1559Supported */.U1)(chainId)) {
            ...
            if (results?.low?.suggestedMaxFeePerGas && results?.medium && ((0,src/* isLessThan */.FI)(config?.maxFeePerGas ? (0,formatter/* formatWeiToGwei */.f1)(config.maxFeePerGas) : 0, results.low.suggestedMaxFeePerGas) || (0,src/* isLessThan */.FI)(config?.maxPriorityFeePerGas ? (0,formatter/* formatWeiToGwei */.f1)(config.maxPriorityFeePerGas) : 0, results.low.suggestedMaxPriorityFeePerGas))) {
                payload_.params[0] = {
                    ...config,
            ...
            if (results?.data.slow.price && (0,src/* isLessThan */.FI)(config?.gasPrice ?? 0, results.data.slow.price)) {
                payload_.params[0] = {
                    ...config,
    ...
    if (!native_rpc/* hasNativeAPI */._ && providerType === types/* ProviderType.MaskWallet */.lP.MaskWallet && isRiskMethod(payload_.method)) {
        ...
        if (popupsWindow) (0,helper.openPopupWindow)();
        return;
    }
    if (notifyProgress) messages/* WalletRPC.addProgress */.V.addProgress({
        payload,
...
async function confirmRequest(payload) {
    ...
    if (!pid) return;
    const [deferred, resolve, reject] = (0,esm/* defer */.PQ)();
...
var MaskWallet = __webpack_require__(1902);
...
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(65506);
/* harmony import */ var _plugins_EVM_messages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(96069);
/* harmony import */ var _plugins_Wallet_services__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(31880);
...
/* harmony import */ var web3__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(75692);
...
/* harmony import */ var _plugins_EVM_messages__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(96069);
/* harmony import */ var _plugins_Wallet_settings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(94232);
/* harmony import */ var _plugins_Wallet_services__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(31880);
...
async function request(requestArguments) {
    id += 1;
    const requestId = id;
    const [deferred, resolve, reject] = (0,_dimensiondev_kit__WEBPACK_IMPORTED_MODULE_0__/* .defer */ .PQ)();
    function onResponse({ payload , result , error  }) {
        if (payload.id !== requestId) return;
        if (error) reject(error);
        else resolve(result);
...
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(80526);
...
/* harmony import */ var _plugins_Wallet_services__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(31880);
/* harmony import */ var _background_services_helper__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(86631);
...
function createProvider(url) {
    const provider = providerPool.get(url) ?? new (web3__WEBPACK_IMPORTED_MODULE_0___default().providers.HttpProvider)(url, {
        timeout: 20000,
        // @ts-ignore
        clientConfig: {
            keepalive: true,
...
function createWeb3Instance(provider) {
    return instancePool.get(provider.host) ?? (()=>{
...
async function requestAccounts(networkType) {
    ...
    return new Promise(async (resolve, reject)=>{
        try {
            ...
            await (0,_background_services_helper__WEBPACK_IMPORTED_MODULE_4__.openPopupWindow)(wallets.length > 0 ? _masknet_shared_base__WEBPACK_IMPORTED_MODULE_1__/* .PopupRoutes.SelectWallet */ .mZ.SelectWallet : undefined, {
...
/* harmony import */ var _plugins_Wallet_services_transaction_database__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(18132);
...
async function createProvider() {
    ...
    await (0,_dimensiondev_kit__WEBPACK_IMPORTED_MODULE_2__/* .delay */ .gw)(1000);
...
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(65506);
/* harmony import */ var _MaskWallet__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1902);
/* harmony import */ var _plugins_Wallet_services__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(31880);
/* harmony import */ var _plugins_Wallet_settings__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(94232);
...
/* harmony export */ });
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(65506);
/* harmony import */ var _dimensiondev_kit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(28807);
/* harmony import */ var _providers_MaskWallet__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(1902);
/* harmony import */ var _providers_MetaMask__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(55439);
/* harmony import */ var _providers_WalletConnect__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(52631);
/* harmony import */ var _providers_Injected__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(34223);
/* harmony import */ var _providers_Fortmatic__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(88337);
/* harmony import */ var _plugins_Wallet_settings__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(94232);
...
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(91469);
/* harmony import */ var _database_Plugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(80614);
...
var Plugin_db = __webpack_require__(53123);
...
async function removeAddress(chainId, address) {
    ...
    await Plugin_db/* PluginDB.add */.O.add({
        id: chainId,
        type: 'address-book',
        records: chunk.records.filter((x)=>!(0,utils_address/* isSameAddress */.Wr)(x.address, address)
        ) ?? [],
...
var database = __webpack_require__(28776);
...
var token = __webpack_require__(84275);
// EXTERNAL MODULE: ./src/plugins/Wallet/services/wallet/database/wallet.ts
var wallet = __webpack_require__(94858);
// EXTERNAL MODULE: ./src/plugins/Wallet/messages.ts
var messages = __webpack_require__(84797);
...
async function getWalletPrimary() {
    ...
    return (0,head/* default */.Z)((await database/* getWallets */.MX(types/* ProviderType.MaskWallet */.lP.MaskWallet)).filter((x)=>x.storedKeyInfo?.type === index_esm.api.StoredKeyType.Mnemonic
...
async function wallet_signTransaction(address, config) {
    ...
    return signTransaction({
        ...
        sign_input: {
            amount: config.value ?? '0x0',
            gas_limit: config.gas?.toString() ?? '0x0',
            gas_price: config.gasPrice?.toString() ?? '0x0',
            chain_id: config.chainId ? (0,lib.toHex)(config.chainId?.toString()) : '0x1',
...
async function wallet_exportPrivateKey(address, unverifiedPassword) {
    ...
    const exported = wallet.derivationPath ? await exportPrivateKeyOfPath({
        coin: index_esm.api.Coin.Ethereum,
        derivationPath: wallet.derivationPath ?? `${src/* HD_PATH_WITHOUT_INDEX_ETHEREUM */.UB}/0`,
        password: password_,
        StoredKeyData: wallet.storedKeyInfo.data
...
async function updateAccount(options = {}) {
    ...
    if (chainId) {
        ...
        if (native_rpc/* hasNativeAPI */._) {
            native_rpc/* nativeAPI */.Nz?.api.wallet_switchBlockChain({
                networkId: chainId
            });
        }
    }
...
async function setDefaultWallet() {
    ...
    const address = (0,head/* default */.Z)(wallets)?.address;
...
var EVM_messages = __webpack_require__(96069);
// EXTERNAL MODULE: ../../node_modules/.pnpm/urlcat@2.0.4/node_modules/urlcat/dist/index.js
...
const auroraChainOnDebank = (0,constants/* getDeBankConstants */.Bx)(types/* ChainId.Aurora */.a_.Aurora).CHAIN_ID;
const fieldKeys = [
    'fast',
    'normal',
    'slow'
 ...
 */ function gasModifier(gasDict, chain) {
    if (chain === auroraChainOnDebank) {
        fieldKeys.forEach((fieldKey)=>{
            const field = gasDict.data[fieldKey];
            field.price = Math.max(field.price, (0,formatter/* formatGweiToWei */.nU)(1).toNumber());
        });
    }
    return gasDict;
}
async function getGasPriceDict(chainId) {
    ...
    if (result.error_code === 0) {
        return gasModifier(result, CHAIN_ID);
    }
    return null;
}
...
function resolveZerionAssetsScopeName(networkType) {
    return (0,constants/* getZerionConstants */.oV)((0,chainDetailed/* getChainIdFromNetworkType */.EP)(networkType)).ASSETS_SCOPE_NAME ?? '';
}
function resolveZerionTransactionsScopeName(networkType) {
    return (0,constants/* getZerionConstants */.oV)((0,chainDetailed/* getChainIdFromNetworkType */.EP)(networkType)).TRANSACTIONS_SCOPE_NAME ?? '';
}
...
function formatAssetsFromDebank(data, network) {
    return data.filter((x)=>(0,chainDetailed/* getChainIdFromName */.np)(x.chain)
    ).filter((x)=>!network || (0,chainDetailed/* getChainIdFromName */.np)(x.chain) === (0,chainDetailed/* getChainIdFromNetworkType */.EP)(network)
    ).filter((x)=>x.is_verified
    ).map((y)=>{
        const chainIdFromChain = (0,chainDetailed/* getChainIdFromName */.np)(y.chain) ?? types/* ChainId.Mainnet */.a_.Mainnet;
        ...
        return {
            ...
            value: {
                [types/* CurrencyType.USD */.V2.USD]: (0,base_src/* multipliedBy */.$q)(y.price ?? 0, y.amount).toFixed()
            },
            logoURI: y.logo_url
        };
    });
...
function formatAssetsFromZerion(data, scope) {
    return data.map(({ asset , quantity  })=>{
        ...
        const value = (asset.price?.value ?? asset.value) ?? 0;
        return {
            token: {
                name: asset.name,
                symbol: asset.symbol,
...
function fromDeBank({ cate_dict , history_list , token_dict  }) {
    return history_list.filter((transaction)=>transaction.tx?.name || transaction.cate_id
...
function fromZerion(data) {
    return data.filter(({ type  })=>type !== ZerionRBDTransactionType.AUTHORIZE
        ...
        const ethGasFee = (0,base_src/* leftShift */.w5)(transaction.fee?.value ?? 0, 18).toString();
        const usdGasFee = (0,base_src/* multipliedBy */.$q)(ethGasFee, transaction.fee?.price ?? 0).toString();
        return {
            ...
            pairs: transaction.changes?.map(({ asset , direction , value  })=>{
                return {
                    name: asset.name,
                    symbol: asset.symbol,
...
async function checkAccount(chainId, account) {
    ...
    for (const latestTransaction of latestTransactions){
        const [watchedHash, watchedTransaction] = watchedTransactions.find(([hash, transaction])=>{
...
async function getRecentTransactions(chainId, address, options) {
    ...
    const allSettled = await Promise.allSettled(transactions.map(async ({ at , hash , hashReplacement , payload , payloadReplacement  })=>{
        ...
        if (options?.computedPayload) {
            tx.computedPayload = await (0,EthereumService.getSendTransactionComputedPayload)(payloadReplacement ?? payload);
        }
        return tx;
    }));
    // compose result
    const transaction_ = [];
    allSettled.forEach((x)=>x.status === 'fulfilled' && (typeof options?.status !== 'undefined' ? x.value.status === options?.status : true) ? transaction_.push(x.value) : undefined
    );
    return transaction_;
}
...
async function pushUnconfirmedRequest(payload) {
    ...
    if (requests.length >= MAX_UNCONFIRMED_REQUESTS_SIZE) {
        await (0,helper.openPopupWindow)();
...
const PLUGIN_ID = entry/* PluginId.Profile */.je.Profile;
...
const PluginProfileMessages = (0,entry/* createPluginMessage */.I4)(PLUGIN_ID);
const PluginProfileRPC = (0,entry/* createPluginRPC */.V8)(PLUGIN_ID, ()=>__webpack_require__.e(/* import() */ 9952).then(__webpack_require__.bind(__webpack_require__, 89952))
...
async function getAddressNames(identity) {
    ...
    const allSettled = await Promise.allSettled([
        ...
        Avatar_messages/* PluginNFTAvatarRPC.getAddress */.B.getAddress(identifier.userId ?? '', identifier.network), 
    ]);
...
const setRiskWarningConfirmed = (address, confirmed)=>(0,helper.__deprecated__setStorage)(RISK_WARNING_KEY, {
        [address]: confirmed
    }, {
        howToUpdate: 'merge'
    })
...
const getRiskWarningConfirmed = async (address)=>{
    const allStatus = await (0,helper.__deprecated__getStorage)(RISK_WARNING_KEY);
...
var Wallet_constants = __webpack_require__(91469);
...
async function updateTokenPrices() {
    ...
    try {
        ...
        await Promise.allSettled(platforms.map(async (platform)=>{
            const prices = await web3_providers_src/* TokenPrice.getTokenPrices */.GI.getTokenPrices(platform, trackingContracts[platform], types/* CurrencyType.USD */.V2.USD);
...
async function updateNativeTokenPrices() {
    ...
    // update chain state
    try {
        const prices = await web3_providers_src/* TokenPrice.getNativeTokenPrice */.GI.getNativeTokenPrice(trackingNativeTokenIds, types/* CurrencyType.USD */.V2.USD);
        updateCurrentPrices(prices);
    } catch  {
    // do nothing
    } finally{
...
/* harmony import */ var _masknet_plugin_wallet__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(19841);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(66394);
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(94232);
/* harmony import */ var _database_Plugin_db__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(53123);
...
/* harmony export */ });
/* harmony import */ var lodash_unified__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(96596);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(65506);
/* harmony import */ var _dimensiondev_kit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(28807);
/* harmony import */ var _masknet_plugin_wallet__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19841);
/* harmony import */ var _database_Plugin_db__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(53123);
...
/* harmony import */ var _wallet__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(94858);
...
/* harmony import */ var lodash_unified__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(96596);
...
/* harmony import */ var _masknet_plugin_wallet__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19841);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(66394);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(65506);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(2239);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(6955);
/* harmony import */ var _database_Plugin_db__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(53123);
/* harmony import */ var _settings__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(94232);
...
async function getWallet(address = _settings__WEBPACK_IMPORTED_MODULE_5__/* .currentMaskWalletAccountSettings.value */ .T_.value) {
    ...
    const wallet = await _database_Plugin_db__WEBPACK_IMPORTED_MODULE_4__/* .PluginDB.get */ .O.get('wallet', (0,_masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_7__/* .formatEthereumAddress */ .j8)(address)) ?? null;
