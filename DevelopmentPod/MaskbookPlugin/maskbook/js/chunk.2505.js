(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[2505],{
...
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(36803);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(65506);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(157);
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(39638);
...
function resolveUserUrlOnCurrentProvider(chainId, address, provider, username) {
    switch(provider){
        ...
        case _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_6__/* .NonFungibleAssetProvider.OPENSEA */ .pI.OPENSEA:
            return urlcat__WEBPACK_IMPORTED_MODULE_3___default()(resolveLinkOnOpenSea(chainId), `/${username ?? ''}`);
        case _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_6__/* .NonFungibleAssetProvider.NFTSCAN */ .pI.NFTSCAN:
            return '';
        case _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_6__/* .NonFungibleAssetProvider.ZORA */ .pI.ZORA:
...
function resolveAvatarLinkOnCurrentProvider(chainId, asset, provider) {
    switch(provider){
        case _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_6__/* .NonFungibleAssetProvider.OPENSEA */ .pI.OPENSEA:
            return urlcat__WEBPACK_IMPORTED_MODULE_3___default()(resolveLinkOnOpenSea(chainId), `/collection/${asset.slug ?? ''}`);
        case _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_6__/* .NonFungibleAssetProvider.RARIBLE */ .pI.RARIBLE:
            return urlcat__WEBPACK_IMPORTED_MODULE_3___default()(resolveLinkOnRarible(chainId), `/collection/${asset.token_address ?? ''}`);
        case _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_6__/* .NonFungibleAssetProvider.NFTSCAN */ .pI.NFTSCAN:
            return '';
        case _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_6__/* .NonFungibleAssetProvider.ZORA */ .pI.ZORA:
            return '';
