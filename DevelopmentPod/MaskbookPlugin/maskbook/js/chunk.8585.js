"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[8585],{
...
function DepositDialog() {
    ...
    const { open , closeDialog  } = (0,dist/* useRemoteControlledDialog */.F$)(PoolTogether_messages/* PluginPoolTogetherMessages.DepositDialogUpdated */.d.DepositDialogUpdated, (ev)=>{
        if (!ev.open) return;
        setPool(ev.pool);
        setToken(ev.token);
    });
