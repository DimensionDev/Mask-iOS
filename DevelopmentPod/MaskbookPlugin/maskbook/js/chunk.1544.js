"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[1544],{
...
function toRaribleImage(url) {
    if (!url) return '';
    if (url.startsWith('ipfs://ipfs/')) return (0,pipes/* resolveIPFSLink */.r5)(url.replace(/^ipfs:\/\/ipfs\//, ''));
    return url;
}
