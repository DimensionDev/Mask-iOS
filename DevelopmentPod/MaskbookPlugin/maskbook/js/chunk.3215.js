"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[3215],{
...
/* harmony import */ var react_use__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(73570);
/* harmony import */ var react_use__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(30688);
/* harmony import */ var react_use__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(93618);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(10459);
/* harmony import */ var _masknet_theme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(30232);
/* harmony import */ var _hooks_useUnConfirmedRequest__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(39517);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(31174);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(96151);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(65506);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(38443);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(29782);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(80526);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(66394);
/* harmony import */ var _masknet_shared__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(2666);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(37253);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(93775);
...
/* harmony import */ var _mui_lab__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(61098);
/* harmony import */ var _dimensiondev_kit__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(28807);
/* harmony import */ var _plugins_Wallet_messages__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(84797);
/* harmony import */ var _service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(5027);
...
/* harmony import */ var _plugins_Wallet_hooks_useTokenPrice__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(41106);
/* harmony import */ var _components_LoadingPlaceholder__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(56885);
/* harmony import */ var web3_utils__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(11627);
...
/* harmony import */ var _masknet_plugin_infra_web3__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(67071);
/* harmony import */ var _masknet_web3_shared_base__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(89260);
/* harmony import */ var _components_CopyIconButton__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(60937);
...
const ContractInteraction = /*#__PURE__*/ (0,react__WEBPACK_IMPORTED_MODULE_1__.memo)(()=>{
    ...
    const { value: defaultPrices  } = (0,react_use__WEBPACK_IMPORTED_MODULE_23__/* ["default"] */ .Z)(async ()=>{
        if ((0,_masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_24__/* .isEIP1559Supported */ .U1)(chainId) && !maxFeePerGas && !maxPriorityFeePerGas) {
            ...
            // Gwei to wei
            return {
                maxPriorityFeePerGas: (0,web3_utils__WEBPACK_IMPORTED_MODULE_13__.toHex)((0,_masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_25__/* .formatGweiToWei */ .nU)(response?.medium?.suggestedMaxPriorityFeePerGas ?? 0).toFixed(0)),
                maxFeePerGas: (0,web3_utils__WEBPACK_IMPORTED_MODULE_13__.toHex)((0,_masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_25__/* .formatGweiToWei */ .nU)(response?.medium?.suggestedMaxFeePerGas ?? 0).toFixed(0))
            };
        } else if (!gasPrice) {
    ...
    // Wei
    const gasPriceEIP1559 = new (bignumber_js__WEBPACK_IMPORTED_MODULE_10___default())((maxFeePerGas ?? defaultPrices?.maxFeePerGas) ?? 0, 16);
    const gasPricePriorEIP1559 = new (bignumber_js__WEBPACK_IMPORTED_MODULE_10___default())((gasPrice ?? defaultPrices?.gasPrice) ?? 0);
    const gasFee = ((0,_masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_24__/* .isEIP1559Supported */ .U1)((0,_masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_24__/* .getChainIdFromNetworkType */ .EP)(networkType)) ? gasPriceEIP1559 : gasPricePriorEIP1559).multipliedBy(gas ?? 0).integerValue().toFixed();
    // token decimals
    ...
    const tokenPrice = (0,_plugins_Wallet_hooks_useTokenPrice__WEBPACK_IMPORTED_MODULE_11__/* .useTokenPrice */ .p)(chainId, !isNativeTokenInteraction ? token?.address : undefined);
    const nativeTokenPrice = (0,_plugins_Wallet_hooks_useTokenPrice__WEBPACK_IMPORTED_MODULE_11__/* .useNativeTokenPrice */ .l)(nativeToken?.chainId);
    const tokenValueUSD = (0,_masknet_web3_shared_base__WEBPACK_IMPORTED_MODULE_15__/* .leftShift */ .w5)(tokenAmount, tokenDecimals).times((!isNativeTokenInteraction ? tokenPrice : nativeTokenPrice) ?? 0).toString();
    ...
    console.log({
        ...
        defaultPrice: gasPrice ?? defaultPrices?.gasPrice,
        request,
        tokenPrice,
        tokenAmount,
        tokenDecimals,
    ...
    const { value: domain  } = (0,_masknet_plugin_infra_web3__WEBPACK_IMPORTED_MODULE_14__/* .useReverseAddress */ .$q)(to, _masknet_plugin_infra_web3__WEBPACK_IMPORTED_MODULE_14__/* .NetworkPluginID.PLUGIN_EVM */ .FF.PLUGIN_EVM);
    const { Utils  } = (0,_masknet_plugin_infra_web3__WEBPACK_IMPORTED_MODULE_14__/* .useWeb3State */ .dM)();
                ...
                children: [
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            ...
                            domain && Utils?.formatDomainName ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_28__/* ["default"] */ .Z, {
