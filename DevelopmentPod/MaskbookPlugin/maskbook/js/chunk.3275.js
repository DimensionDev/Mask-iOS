"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[3275],{
...
const DeleteWallet = /*#__PURE__*/ (0,react.memo)(()=>{
    ...
    const currentWallet = (0,entry_web3/* useWallet */.Os)();
    ...
    const onConfirm = (0,react.useCallback)(async ()=>{
        if (wallet?.address) {
            try {
                ...
                const wallets = await messages/* WalletRPC.getWallets */.V.getWallets();
    ...
    (0,useTitle/* useTitle */.Z)(t('popups_delete_wallet'));
