"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[4387],{
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.2.5_695e98f08a2d125282e19cae338368d2/node_modules/@mui/icons-material/QueryBuilder.js
var QueryBuilder = __webpack_require__(43039);
...
var messages = __webpack_require__(78823);
...
var base = __webpack_require__(88787);
...
function DonateDialog(props) {
    ...
    const shareLink = (ref = (_utils = social_network.activatedSocialNetworkUI.utils).getShareLinkURL) === null || ref === void 0 ? void 0 : ref.call(_utils, token ? [
        `I just donated ${title} with ${(0,formatter/* formatBalance */.az)(amount, token.decimals)} ${cashTag}${token.symbol}. ${(0,twitter_com_base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) || (0,facebook_com_base/* isFacebook */.DF)(social_network.activatedSocialNetworkUI) ? `Follow @${(0,twitter_com_base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) ? t('twitter_account') : t('facebook_account')} (mask.io) to donate Gitcoin grants.` : ''}`,
        '#mask_io',
        postLink, 
    ].join('\n') : '').toString();
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(86424);
...
const PluginGitcoinRPC = (0,_masknet_plugin_infra__WEBPACK_IMPORTED_MODULE_0__/* .createPluginRPC */ .V8)(_constants__WEBPACK_IMPORTED_MODULE_1__/* .PLUGIN_ID */ .Uu, ()=>__webpack_require__.e(/* import() */ 6680).then(__webpack_require__.bind(__webpack_require__, 6680))
