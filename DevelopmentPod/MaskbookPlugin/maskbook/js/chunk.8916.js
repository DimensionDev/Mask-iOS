"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[8916],{
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(85792);
/* harmony import */ var _masknet_theme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(31939);
/* harmony import */ var react_hook_form__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(72261);
/* harmony import */ var _components_StyledInput__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(11877);
/* harmony import */ var react_router_dom__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(18271);
...
const CreateWallet = /*#__PURE__*/ (0,react__WEBPACK_IMPORTED_MODULE_1__.memo)(()=>{
    ...
    const { control , handleSubmit , formState: { errors , isValid  } , schema ,  } = (0,_hooks_useSetWalletNameForm__WEBPACK_IMPORTED_MODULE_6__/* .useSetWalletNameForm */ .$)();
    const onCreate = (0,react__WEBPACK_IMPORTED_MODULE_1__.useCallback)(async ({ name  })=>{
        try {
            await _plugins_Wallet_messages__WEBPACK_IMPORTED_MODULE_4__/* .WalletRPC.deriveWallet */ .V.deriveWallet(name);
            navigate(-1);
        } catch (error) {
    ...
    (0,_hook_useTitle__WEBPACK_IMPORTED_MODULE_7__/* .useTitle */ .Z)(t('popups_create_wallet'));
