"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[5020],{
...
var base = __webpack_require__(24829);
// EXTERNAL MODULE: ../plugins/RSS3/src/constants.ts
var constants = __webpack_require__(35837);
...
var messages = __webpack_require__(20831);
...
function useDonations(address) {
    return (0,useAsync/* default */.Z)(async ()=>{
        ...
        return response.status ? response.assets : shared_base_src/* EMPTY_LIST */.rP;
    }, [
        address
    ]);
}
...
const useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>({
        card: {
            ...
            display: 'flex',
            flexDirection: 'row',
            backgroundColor: entry/* MaskColorVar.twitterBg */.ZN.twitterBg,
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.8.0_ar3vczqpton7uep5462l6mtgi4/node_modules/@mui/icons-material/EventRounded.js
var EventRounded = __webpack_require__(51594);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.8.0_ar3vczqpton7uep5462l6mtgi4/node_modules/@mui/icons-material/LocationOnRounded.js
var LocationOnRounded = __webpack_require__(26803);
...
const StatusBox_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>({
        statusBox: {
            display: 'flex',
            alignItems: 'center',
...
const DonationsPage_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>({
        statusBox: {
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
...
const FootprintPage_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>({
        address: {
            color: theme.palette.primary.main
        },
        link: {
...
function TabCard({ type , socialAddressList  }) {
    const t = useI18N();
    const addressName = socialAddressList?.find((x)=>x.type === src/* SocialAddressType.RSS3 */.bN.RSS3 && x.networkSupporterPluginID === src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM
    );
    const userAddress = addressName?.address || '';
    const { value: donations = shared_base_src/* EMPTY_LIST */.rP , loading: loadingDonations  } = useDonations(userAddress);
    const { value: footprints = shared_base_src/* EMPTY_LIST */.rP , loading: loadingFootprints  } = useFootprints(userAddress);
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.Z, {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(shared_src/* AddressViewer */.u0, {
                        identityAddress: addressName
                    })
                ]
            }),
...
function shouldDisplay(identity, addressNames) {
    return addressNames?.some((x)=>x.type === src/* SocialAddressType.RSS3 */.bN.RSS3 && x.networkSupporterPluginID === src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM
    ) ?? false;
}
const sns = {
    ...base/* base */.u,
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(35837);
...
const PluginProfileRPC = (0,_masknet_plugin_infra__WEBPACK_IMPORTED_MODULE_0__/* .createPluginRPC */ .V8)(_constants__WEBPACK_IMPORTED_MODULE_1__/* .PLUGIN_ID */ .Uu, ()=>__webpack_require__.e(/* import() */ 7510).then(__webpack_require__.bind(__webpack_require__, 77510))
