...
;// CONCATENATED MODULE: ../icons/general/Right.tsx


const RightIcon = (0,icons_utils/* createIcon */.I)('RightIcon', /*#__PURE__*/ (0,jsx_runtime.jsx)("g", {
    fill: "none",
...
const Transfer1559 = /*#__PURE__*/ (0,react.memo)(({ selectedAsset , openAssetMenu , otherWallets  })=>{
    ...
    const maxAmount = (0,react.useMemo)(()=>{
        const gasFee = (0,formatter/* formatGweiToWei */.nU)(new (bignumber_default())(maxFeePerGas !== null && maxFeePerGas !== void 0 ? maxFeePerGas : 0)).multipliedBy((0,token/* addGasMargin */.bu)(MIN_GAS_LIMIT));
        ...
        return (0,formatter/* formatBalance */.az)(amount_.toFixed(), selectedAsset === null || selectedAsset === void 0 ? void 0 : selectedAsset.token.decimals);
    }, [
        selectedAsset,
        maxFeePerGas,
        minGasLimit,
    ...
    const popoverContent = (0,react.useMemo)(()=>{
        ...
        if (registeredAddress && !resolveDomainError && (Utils === null || Utils === void 0 ? void 0 : Utils.resolveDomainLink)) return(/*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.Z, {
            ...
            children: [
                ...
                /*#__PURE__*/ (0,jsx_runtime.jsx)(RightIcon, {})
            ]
        }));
        return;
    }, [
