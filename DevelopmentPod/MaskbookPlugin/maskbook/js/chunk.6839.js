"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[6839],{
...
var shared = __webpack_require__(39055);
// EXTERNAL MODULE: ./src/social-network-adaptor/instagram.com/base.ts
var base = __webpack_require__(93505);
...
function getPostID(node) {
    return node.current?.querySelector('a[href^="/p/"]')?.href.match(/\/p\/(.+)\/.+/)?.[1] || null;
}
...
function NFTAvatarButtonInDialog() {
    ...
    (0,src_utils/* useLocationChange */.SL)(setStyleWithSelector);
...
function NFTAvatarInInstagram() {
    ...
    const location = (0,useLocation/* default */.Z)();
    const { value: _avatar  } = (0,hooks/* useNFTAvatar */.i)(identity.identifier.userId, constants/* RSS3_KEY_SNS.INSTAGRAM */.vu.INSTAGRAM);
...
const NFTAvatarSettingDialog_useStyles = (0,entry/* makeStyles */.ZL)()(()=>({
        root: {
            padding: '8px 0',
            margin: '0 16px'
        }
