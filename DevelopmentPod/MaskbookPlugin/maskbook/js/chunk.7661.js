"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[7661],{
...
var Trader_types = __webpack_require__(46347);
// EXTERNAL MODULE: ./src/utils/index.ts + 5 modules
var utils = __webpack_require__(76108);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.2.5_811d2bc6069f340521b4a59905442643/node_modules/@mui/material/Chip/chipClasses.js
var chipClasses = __webpack_require__(11690);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.2.5_811d2bc6069f340521b4a59905442643/node_modules/@mui/material/Collapse/Collapse.js + 1 modules
var Collapse = __webpack_require__(62537);
...
var settings = __webpack_require__(45627);
...
var helpers = __webpack_require__(98992);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.2.5_695e98f08a2d125282e19cae338368d2/node_modules/@mui/icons-material/Tune.js
var Tune = __webpack_require__(85725);
// EXTERNAL MODULE: ./src/plugins/Trader/constants/index.ts + 2 modules
var Trader_constants = __webpack_require__(22487);
...
var useGetTradeContext = __webpack_require__(36466);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.2.5_695e98f08a2d125282e19cae338368d2/node_modules/@mui/icons-material/esm/ArrowDownward.js
var ArrowDownward = __webpack_require__(21529);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.2.5_695e98f08a2d125282e19cae338368d2/node_modules/@mui/icons-material/esm/HelpOutline.js
var HelpOutline = __webpack_require__(30091);
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Collapse/* default */.Z, {
                                                ...
                                                children: trades.slice(1).map((trade)=>{
                                                    return(/*#__PURE__*/ (0,jsx_runtime.jsx)(TraderInfo, {
                                                        trade: trade,
                                                        onClick: ()=>{
                                                            if (!userSelected.current) userSelected.current = true;
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/react-use@17.3.2/node_modules/react-use/esm/useUnmount.js
var useUnmount = __webpack_require__(87340);
...
var useWrappedEtherContract = __webpack_require__(41077);
...
var _0x_constants = __webpack_require__(32482);
...
var useTradeParameters = __webpack_require__(6312);
...
var useTradeAmount = __webpack_require__(31331);
...
var useExchangeProxyContract = __webpack_require__(70687);
...
var external_link = __webpack_require__(61077);
...
var Info = __webpack_require__(12560);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.2.5_811d2bc6069f340521b4a59905442643/node_modules/@mui/material/Slider/Slider.js
var Slider = __webpack_require__(65678);
...
var useBalance = __webpack_require__(32053);
...
function Trader(props) {
    ...
    (0,react.useEffect)(()=>{
        ...
        if (!inputToken) {
            dispatchTradeStore({
                ...
                token: chainId === types/* ChainId.Mainnet */.a_.Mainnet && (coin === null || coin === void 0 ? void 0 : coin.is_mirrored) ? Trader_constants/* UST */.bi[types/* ChainId.Mainnet */.a_.Mainnet] : (0,utils_token/* createNativeToken */.$c)(chainId)
            });
        }
    }, [
        chainId,
    ...
    (0,react.useEffect)(()=>{
        ...
        if ((0,address/* isSameAddress */.Wr)(coin.contract_address, NATIVE_TOKEN_ADDRESS) && (inputToken === null || inputToken === void 0 ? void 0 : inputToken.type) === types/* EthereumTokenType.Native */.Dr.Native && coin.symbol === inputToken.symbol) {
            dispatchTradeStore({
                type: useAllProviderTradeContext/* AllProviderTradeActionType.UPDATE_INPUT_TOKEN */.AF.UPDATE_INPUT_TOKEN,
                token: undefined
            });
        ...
        if (!outputToken) {
            dispatchTradeStore({
                ...
                token: coin.contract_address ? (0,utils_token/* createERC20Token */.wY)(chainId, coin.contract_address, decimals, coin.name, coin.symbol) : undefined
            });
        }
    }, [
        coin,
    ...
    const { value: inputTokenBalance_ , loading: loadingInputTokenBalance  } = (0,useFungibleTokenBalance/* useFungibleTokenBalance */.V)((0,address/* isSameAddress */.Wr)(inputToken === null || inputToken === void 0 ? void 0 : inputToken.address, NATIVE_TOKEN_ADDRESS) ? types/* EthereumTokenType.Native */.Dr.Native : (ref2 = inputToken === null || inputToken === void 0 ? void 0 : inputToken.type) !== null && ref2 !== void 0 ? ref2 : types/* EthereumTokenType.Native */.Dr.Native, (ref3 = inputToken === null || inputToken === void 0 ? void 0 : inputToken.address) !== null && ref3 !== void 0 ? ref3 : '', chainId);
    var ref4, ref5;
    const { value: outputTokenBalance_ , loading: loadingOutputTokenBalance  } = (0,useFungibleTokenBalance/* useFungibleTokenBalance */.V)((0,address/* isSameAddress */.Wr)(outputToken === null || outputToken === void 0 ? void 0 : outputToken.address, NATIVE_TOKEN_ADDRESS) ? types/* EthereumTokenType.Native */.Dr.Native : (ref4 = outputToken === null || outputToken === void 0 ? void 0 : outputToken.type) !== null && ref4 !== void 0 ? ref4 : types/* EthereumTokenType.Native */.Dr.Native, (ref5 = outputToken === null || outputToken === void 0 ? void 0 : outputToken.address) !== null && ref5 !== void 0 ? ref5 : '', chainId);
    (0,react.useEffect)(()=>{
    ...
    const shareLink = (ref = (_utils = social_network.activatedSocialNetworkUI.utils).getShareLinkURL) === null || ref === void 0 ? void 0 : ref.call(_utils, (focusedTrade === null || focusedTrade === void 0 ? void 0 : focusedTrade.value) && inputToken && outputToken ? [
        `I just swapped ${(0,formatter/* formatBalance */.az)(focusedTrade.value.inputAmount, inputToken.decimals, 6)} ${cashTag}${inputToken.symbol} for ${(0,formatter/* formatBalance */.az)(focusedTrade.value.outputAmount, outputToken.decimals, 6)} ${cashTag}${outputToken.symbol}.${(0,base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) || (0,facebook_com_base/* isFacebook */.DF)(social_network.activatedSocialNetworkUI) ? `Follow @${(0,base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) ? t('twitter_account') : t('facebook_account')} (mask.io) to swap cryptocurrencies on ${(0,base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) ? 'Twitter' : 'Facebook'}.` : ''}`,
        '#mask_io', 
    ].join('\n') : '').toString();
    // #endregion
...
/* harmony export */ });
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(25071);
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(22487);
/* harmony import */ var _types__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(46347);
...
var useMulticallContract = __webpack_require__(59463);
// EXTERNAL MODULE: ../web3-shared/evm/hooks/useChainId.ts
var useChainId = __webpack_require__(13601);
// EXTERNAL MODULE: ../../node_modules/.pnpm/web3-utils@1.5.2/node_modules/web3-utils/lib/index.js
...
var useGetTradeContext = __webpack_require__(36466);
// EXTERNAL MODULE: ../public-api/src/index.ts
var src = __webpack_require__(85123);
...
// EXTERNAL MODULE: ../web3-shared/evm/hooks/useContract.ts
var hooks_useContract = __webpack_require__(47683);
...
;// CONCATENATED MODULE: ./src/plugins/Trader/trader/useTradeSettings.ts


function useTradeProviderSettings(tradeProvider) {
    const raw = (0,shared_src/* useValueRef */.E)((0,settings/* getCurrentTradeProviderGeneralSettings */.Aj)(tradeProvider));
    try {
...
var Wallet_settings = __webpack_require__(18274);
...
function _0x_useTrade_useTrade(strategy, inputAmount, outputAmount, inputToken, outputToken, temporarySlippage) {
    ...
    const slippage = temporarySlippage || slippageSetting;
    const { pools  } = useTradeProviderSettings(public_api_src/* TradeProvider.ZRX */.z4.ZRX);
...
/* harmony export */ });
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(36130);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(76342);
/* harmony import */ var _masknet_public_api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(85123);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(22487);
/* harmony import */ var _dimensiondev_kit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14381);
/* harmony import */ var _useTargetChainIdContext__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(17508);
...
/* harmony import */ var _web3_shared_evm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13601);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(76342);
...
function useTargetChainIdContext() {
    const chainId = (0,_web3_shared_evm__WEBPACK_IMPORTED_MODULE_1__/* .useChainId */ .xx)();
