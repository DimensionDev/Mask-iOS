"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[9034],{
...
/* harmony import */ var react_use__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(32588);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(5326);
/* harmony import */ var _service__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(78778);
/* harmony import */ var _components_LoadingPlaceholder__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(21978);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(21784);
/* harmony import */ var _masknet_shared__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(77818);
/* harmony import */ var _masknet_shared_base_ui__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(80226);
/* harmony import */ var _hook_useHasPassword__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(39652);
/* harmony import */ var react_hook_form__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(72261);
/* harmony import */ var _hooks_usePasswordForm__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(41986);
/* harmony import */ var _components_PasswordField__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(98027);
/* harmony import */ var _plugins_Wallet_messages__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(91788);
/* harmony import */ var _mui_lab__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(80875);
/* harmony import */ var _settings_settings__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(5903);
/* harmony import */ var _masknet_plugin_infra_web3__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(50719);
/* harmony import */ var _masknet_web3_shared_base__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(67938);
...
const WalletRecovery = /*#__PURE__*/ (0,react__WEBPACK_IMPORTED_MODULE_1__.memo)(()=>{
    ...
    const web3State = (0,_masknet_plugin_infra_web3__WEBPACK_IMPORTED_MODULE_14__/* .useWeb3State */ .dM)(_masknet_web3_shared_base__WEBPACK_IMPORTED_MODULE_15__/* .NetworkPluginID.PLUGIN_EVM */ .FF.PLUGIN_EVM);
    const currentPersona = (0,_masknet_shared_base_ui__WEBPACK_IMPORTED_MODULE_8__/* .useValueRef */ .E)(_settings_settings__WEBPACK_IMPORTED_MODULE_13__/* .currentPersonaIdentifier */ .cn);
    const backupId = new URLSearchParams(location.search).get('backupId');
    const { loading , value  } = (0,react_use__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .Z)(async ()=>{
        if (backupId) return _service__WEBPACK_IMPORTED_MODULE_5__/* ["default"].Backup.getUnconfirmedBackup */ .ZP.Backup.getUnconfirmedBackup(backupId);
        return undefined;
    }, [
        backupId
    ]);
    ...
    const [{ loading: setPasswordLoading  }, handleSetPassword] = (0,react_use__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(async (data)=>{
        try {
    ...
    const [{ loading: confirmLoading  }, onConfirm] = (0,react_use__WEBPACK_IMPORTED_MODULE_18__/* ["default"] */ .Z)(async ()=>{
        // If the payment password does not exist, set it first
        if (!hasPassword) {
            await onSubmit();
        }
        if (backupId) {
            const json = await _service__WEBPACK_IMPORTED_MODULE_5__/* ["default"].Backup.getUnconfirmedBackup */ .ZP.Backup.getUnconfirmedBackup(backupId);
            if (json) {
                await _service__WEBPACK_IMPORTED_MODULE_5__/* ["default"].Backup.restoreUnconfirmedBackup */ .ZP.Backup.restoreUnconfirmedBackup({
                    id: backupId,
                    action: 'confirm'
                });
                // Set default wallet
                if (json.wallets) await _plugins_Wallet_messages__WEBPACK_IMPORTED_MODULE_12__/* .WalletRPC.setDefaultMaskAccount */ .V.setDefaultMaskAccount();
    ...
    return loading || getHasPasswordLoading ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_LoadingPlaceholder__WEBPACK_IMPORTED_MODULE_6__/* .LoadingPlaceholder */ .u, {}) : /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .Z, {
                                            ...
                                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_masknet_shared__WEBPACK_IMPORTED_MODULE_7__/* .FormattedAddress */ .Kv, {
                                                ...
                                                size: 16,
                                                formatter: _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_20__/* .formatEthereumAddress */ .j8
                                            })
                                        })
                                    ]
                                }, wallet.address);
                                ...
                                children: [
                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(react_hook_form__WEBPACK_IMPORTED_MODULE_21__/* .Controller */ .Qr, {
                                                control: control,
                                                render: ({ field  })=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_PasswordField__WEBPACK_IMPORTED_MODULE_11__/* .PasswordField */ .Z, {
                                                        ...field,
                                                        classes: {
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
                ...
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_mui_lab__WEBPACK_IMPORTED_MODULE_22__/* ["default"] */ .Z, {
