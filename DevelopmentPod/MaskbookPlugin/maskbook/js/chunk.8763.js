"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[8763],{
...
;// CONCATENATED MODULE: ../icons/general/Wallet.tsx
...
var PasswordField = __webpack_require__(88183);
...
const DeleteWallet = /*#__PURE__*/ (0,react.memo)(()=>{
    ...
    const onConfirm = (0,react.useCallback)(async ()=>{
        if (wallet === null || wallet === void 0 ? void 0 : wallet.address) {
            try {
                var ref;
                await messages/* WalletRPC.removeWallet */.V.removeWallet(wallet.address, password);
                const wallets = await messages/* WalletRPC.getWallets */.V.getWallets(types/* ProviderType.MaskWallet */.lP.MaskWallet);
                const otherWalletAddress = (ref = (0,head/* default */.Z)(wallets)) === null || ref === void 0 ? void 0 : ref.address;
                if (otherWalletAddress) {
                    await messages/* WalletRPC.updateMaskAccount */.V.updateMaskAccount({
                        account: otherWalletAddress
                    });
                } else {
                    settings/* currentMaskWalletAccountSettings.value */.T_.value = '';
                }
                if (settings/* currentAccountSettings.value */.aK.value === wallet.address) {
                    var ref1;
                    var ref2;
                    await messages/* WalletRPC.updateAccount */.V.updateAccount({
                        account: (ref2 = (ref1 = (0,head/* default */.Z)(wallets)) === null || ref1 === void 0 ? void 0 : ref1.address) !== null && ref2 !== void 0 ? ref2 : '',
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(Warning/* WarningIcon */.a, {
                                style: {
                                    fontSize: 48
                                }
                            }),
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                                ...
                                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(WalletIcon, {})
                            }),
                            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                        className: classes.name,
                                        children: wallet === null || wallet === void 0 ? void 0 : wallet.name
                                    }),
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
