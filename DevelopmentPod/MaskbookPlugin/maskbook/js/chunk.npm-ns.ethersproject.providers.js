"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[7604],{
...
__webpack_require__.d(__webpack_exports__, {
  "r": () => (/* binding */ JsonRpcProvider)
});

// UNUSED EXPORTS: JsonRpcSigner
...
var web_lib_esm = __webpack_require__(90382);
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@ethersproject+providers@5.4.2/node_modules/@ethersproject/providers/lib.esm/_version.js
const version = "providers/5.4.2";
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@ethersproject+hash@5.4.0/node_modules/@ethersproject/hash/lib.esm/namehash.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@ethersproject+providers@5.4.2/node_modules/@ethersproject/providers/lib.esm/base-provider.js
...
const base_provider_logger = new logger_lib_esm/* Logger */.Yd(version);
...
function getEventTag(eventName) {
    ...
    else if (abstract_provider_lib_esm/* ForkEvent.isForkEvent */.Sg.isForkEvent(eventName)) {
...
let nextPollId = 1;
class BaseProvider extends abstract_provider_lib_esm/* Provider */.zt {
    /**
     *  ready
     *
     ...
     */
    constructor(network) {
        base_provider_logger.checkNew(new.target, abstract_provider_lib_esm/* Provider */.zt);
        super();
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@ethersproject+providers@5.4.2/node_modules/@ethersproject/providers/lib.esm/json-rpc-provider.js
...
const json_rpc_provider_logger = new logger_lib_esm/* Logger */.Yd(version);
...
class JsonRpcSigner extends lib_esm/* Signer */.E {
