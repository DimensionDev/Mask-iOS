"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[2683],{
...
var base = __webpack_require__(60736);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.5.0_a3cb2128d94074523de9af11c2410761/node_modules/@mui/icons-material/esm/Remove.js
var Remove = __webpack_require__(83469);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.5.0_a3cb2128d94074523de9af11c2410761/node_modules/@mui/icons-material/esm/Add.js
var Add = __webpack_require__(67399);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.5.0_a3cb2128d94074523de9af11c2410761/node_modules/@mui/icons-material/esm/Tune.js
var Tune = __webpack_require__(16346);
...
function GasSettingBar(props) {
    ...
    const { setDialog: setGasSettingDialog  } = (0,dist/* useRemoteControlledDialog */.F$)(messages/* WalletMessages.events.gasSettingDialogUpdated */.R.events.gasSettingDialogUpdated);
...
var apis = __webpack_require__(15361);
...
var MaskBox_messages = __webpack_require__(23615);
...
function useMaskBoxMetadata(boxId, creator) {
    return (0,useAsyncRetry/* default */.Z)(async ()=>{
        if (!boxId || !creator || !wallet_ts_dist.EthereumAddress.isValid(creator)) return;
...
function useContext(initialState) {
    ...
    const { value: boxInfo = null , error: errorBoxInfo , loading: loadingBoxInfo , retry: retryBoxInfo ,  } = (0,useAsyncRetry/* default */.Z)(async ()=>{
        var ref;
        if (!maskBoxInfo || !maskBoxStatus || (0,utils_address/* isZeroAddress */.uO)((ref = maskBoxInfo === null || maskBoxInfo === void 0 ? void 0 : maskBoxInfo.creator) !== null && ref !== void 0 ? ref : primitives/* ZERO_ADDRESS */.r)) return null;
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@mui+lab@5.0.0-alpha.72_154258abcf19999eeddd92026c0a2f6c/node_modules/@mui/lab/Skeleton/Skeleton.js
...
function PreviewCard(props) {
    ...
    const { setDialog: setTransactionDialog  } = (0,dist/* useRemoteControlledDialog */.F$)(messages/* WalletMessages.events.transactionDialogUpdated */.R.events.transactionDialogUpdated, (ev)=>{
        if (ev.open) return;
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/rss3-next@0.6.17_typescript@4.6.2/node_modules/rss3-next/dist/browser/RSS3.js
var RSS3 = __webpack_require__(35917);
...
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5196);
...
const MaskBoxRPC = (0,_masknet_plugin_infra__WEBPACK_IMPORTED_MODULE_0__/* .createPluginRPC */ .V8)(_constants__WEBPACK_IMPORTED_MODULE_1__/* .PLUGIN_ID */ .Uu, ()=>__webpack_require__.e(/* import() */ 2713).then(__webpack_require__.bind(__webpack_require__, 82713))
, MaskBoxMessages.rpc);
