...
/******/ 			return "js/chunk." + ({"1077":"npm-ns.dimensiondev.mask-wallet-core","8117":"npm.protobufjs"}[chunkId] || chunkId) + ".js";
/******/ 		};
/******/ 	})();
/******/ 	
...
;// CONCATENATED MODULE: ./web-workers/prepare.ts
...
setTimeout(()=>self.postMessage('Alive')
, 0);
