"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[4506],{
...
// EXTERNAL MODULE: ./src/plugins/Trader/base.ts + 7 modules
var base = __webpack_require__(96322);
// EXTERNAL MODULE: ./src/plugins/Trader/SNSAdaptor/trader/TraderDialog.tsx
var TraderDialog = __webpack_require__(40053);
...
function useAvailableDataProviders(type, keyword) {
    ...
    return (0,useAsync/* default */.Z)(async ()=>{
        return messages/* PluginTraderRPC.getAvailableDataProviders */.V.getAvailableDataProviders(chainId, type, keyword);
    }, [
        chainId,
        type,
        keyword
...
function useSearchedKeyword() {
    ...
    const onLocationChange = (0,react.useCallback)(()=>{
        if (social_network/* activatedSocialNetworkUI */.LM?.collecting?.getSearchedKeyword) {
            setKeyword(social_network/* activatedSocialNetworkUI */.LM?.collecting?.getSearchedKeyword());
        }
    }, []);
    (0,react.useEffect)(()=>{
        onLocationChange();
...
var types = __webpack_require__(35766);
...
function useTrendingByKeyword(tagType, keyword, dataProvider) {
    ...
    const { value: trending , loading , error ,  } = (0,useAsync/* default */.Z)(async ()=>{
        ...
        return messages/* PluginTraderRPC.getCoinTrendingByKeyword */.V.getCoinTrendingByKeyword(chainId, keyword, tagType, currency, dataProvider);
    }, [
        chainId,
        dataProvider,
        currency?.id,
    ...
    const { value: detailedToken  } = (0,entry_web3/* useFungibleToken */.cf)(src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM, trending?.coin.contract_address);
    const coin = {
        ...trending?.coin,
...
function useTrendingById(id, dataProvider) {
    ...
    const { value: trending , loading , error ,  } = (0,useAsync/* default */.Z)(async ()=>{
        if (!id) return null;
        if (!currency) return null;
        return messages/* PluginTraderRPC.getCoinTrendingById */.V.getCoinTrendingById(chainId, id, currency, dataProvider);
    }, [
        chainId,
        dataProvider,
        currency?.id,
            ...
            children: [
                ...
                ticker.price ? /*#__PURE__*/ (0,jsx_runtime.jsx)(TableCell/* default */.Z, {
                    ...
                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)(shared_src/* FormattedCurrency */.bO, {
                        value: ticker.price,
                        formatter: src/* formatCurrency */.xG
                    })
                }) : null,
                /*#__PURE__*/ (0,jsx_runtime.jsx)(TableCell/* default */.Z, {
                    className: classes.cell,
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.8.0_ar3vczqpton7uep5462l6mtgi4/node_modules/@mui/icons-material/ArrowDropUp.js
var ArrowDropUp = __webpack_require__(62268);
...
const PriceChanged_useStyles = (0,entry/* makeStyles */.ZL)()({
    root: {
        fontSize: 'inherit',
        position: 'relative'
    },
...
const PriceChangedTable_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>({
        container: {
            '&::-webkit-scrollbar': {
                display: 'none'
            }
...
function usePriceLineChart(svgRef, data, dimension, id, opts) {
    ...
    (0,useLineChart/* useLineChart */.t)(svgRef, data, dimension, id, {
        color,
        tickFormat: `${sign},.2s`,
        formatTooltip: (value)=>(0,src/* formatCurrency */.xG)(value, sign)
    });
}
...
const PriceChart_useStyles = (0,entry/* makeStyles */.ZL)()((theme, { stats , coin  })=>{
    return {
        root: {
            position: 'relative',
...
function PriceChart(props) {
    const { t  } = (0,utils/* useI18N */.M1)();
    const classes = (0,entry/* useStylesExtends */.Bc)(PriceChart_useStyles(props), props);
            ...
            props.stats.length ? /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
                children: [
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsx)("svg", {
                        ...
                        onClick: ()=>{
                            props.stats.length && (0,shared_base_ui_src/* openWindow */.xw)(props.coin?.platform_url);
                        }
                    })
                ]
...
function usePriceStats({ coinId , currency , days =PriceChartDaysControl/* Days.MAX */.h.MAX , dataProvider  }) {
    ...
    return (0,useAsyncRetry/* default */.Z)(async ()=>{
        ...
        return messages/* PluginTraderRPC.getPriceStats */.V.getPriceStats(chainId, coinId, currency, days, dataProvider);
    }, [
        coinId,
        dataProvider,
        currency?.id,
...
;// CONCATENATED MODULE: ./src/plugins/Trader/storage/index.ts

const storageDefaultValue = {
    dataProvider: public_api_src/* DataProvider.COIN_GECKO */.FW.COIN_GECKO
};
let storage = null;
...
function setStorage(dataProvider) {
...
function useCurrentDataProvider(availableDataProviders) {
    const currentDataProvider = (0,use_subscription.useSubscription)(getDataProvider().subscription);
    ...
    (0,react.useEffect)(()=>{
        ...
        availableDataProviders.sort((a, b)=>a - b
        ).join(),
        currentDataProvider
    ]);
    return dataProvider;
...
const TradeView_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>{
    return {
        root: {
            width: '100%',
            maxWidth: 450,
...
function TradeView(props) {
    ...
    const chainId = (0,entry_web3/* useChainId */.xx)(src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM);
    const classes = (0,entry/* useStylesExtends */.Bc)(TradeView_useStyles(), props);
...
const CoinMarketTable_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>({
        root: {
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.8.0_ar3vczqpton7uep5462l6mtgi4/node_modules/@mui/icons-material/FileCopy.js
var FileCopy = __webpack_require__(75932);
...
const CoinMetadataTags_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>({
        tag: {
...
function TagsDialog(props) {
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
        children: tags ? /*#__PURE__*/ (0,jsx_runtime.jsx)(shared_src/* InjectedDialog */.Fl, {
            open: open,
            title: "Tags",
            onClose: onClose,
            children: /*#__PURE__*/ (0,jsx_runtime.jsx)(DialogContent/* default */.Z, {
                children: tags?.map((x, i)=>/*#__PURE__*/ (0,jsx_runtime.jsx)(Linking, {
                        href: x,
                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Chip/* default */.Z, {
                            label: x.replace(/-/g, ' '),
...
const CoinMetadataTable_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>({
        root: {
            padding: theme.spacing(2)
        },
        container: {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Table/* default */.Z, {
            ...
            children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(TableBody/* default */.Z, {
                children: [
                    ...
                    trending.coin.tags?.length ? /*#__PURE__*/ (0,jsx_runtime.jsxs)(TableRow/* default */.Z, {
                        children: [
                            /*#__PURE__*/ (0,jsx_runtime.jsx)(TableCell/* default */.Z, {
                                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                    className: classes.label,
...
const CoinMarketPanel_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>({
        root: {
            padding: theme.spacing(2)
        }
    })
...
const TrendingCard_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>{
    return {
        root: {
            overflow: 'auto',
            '&::-webkit-scrollbar': {
...
function TrendingCard(props) {
    ...
    const classes = (0,entry/* useStylesExtends */.Bc)(TrendingCard_useStyles(), props);
...
const TrendingViewError_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>({
        content: {
            paddingTop: 0,
            paddingBottom: 0
        },
...
const TrendingViewSkeleton_useStyles = (0,entry/* makeStyles */.ZL)()({
    content: {
        paddingTop: 0,
        paddingBottom: 0
    },
...
function TrendingViewSkeleton(props) {
    ...
    const classes = (0,entry/* useStylesExtends */.Bc)(TrendingViewSkeleton_useStyles(), props);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.8.0_ar3vczqpton7uep5462l6mtgi4/node_modules/@mui/icons-material/MonetizationOnOutlined.js
var MonetizationOnOutlined = __webpack_require__(35141);
...
var Transak_messages = __webpack_require__(79462);
...
const DataProviderIcon_useStyles = (0,entry/* makeStyles */.ZL)()({
    cmc: {
        width: 16,
        height: 16,
        verticalAlign: 'bottom'
...
const TradeFooter_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>{
    return {
        footer: {
            justifyContent: 'space-between'
        },
...
const TradeFooter = (props)=>{
    ...
    const { t  } = (0,utils/* useI18N */.M1)();
    const classes = (0,entry/* useStylesExtends */.Bc)(TradeFooter_useStyles(), props);
...
var Trader_settings = __webpack_require__(80097);
...
const CoinMenu_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>({
        symbol: {
            color: theme.palette.text.secondary,
            fontSize: 12,
            marginLeft: theme.spacing(0.5)
...
function useApprovedTokens(token_address) {
    ...
    const tokens = (0,shared_base_ui_src/* useValueRef */.E)(Trader_settings/* approvedTokensFromUniswap */.dm);
    const onApprove = (0,react.useCallback)(()=>{
        ...
        Trader_settings/* approvedTokensFromUniswap.value */.dm.value = json_stable_stringify_default()(parsed);
    }, [
        tokens,
        token_address
    ]);
    (0,react.useEffect)(()=>{
        try {
            if (!tokens) Trader_settings/* approvedTokensFromUniswap.value */.dm.value = json_stable_stringify_default()([]);
...
const CoinSafetyAlert_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>{
    return {
        root: {
                ...
                /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.Z, {
                    ...
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)(Link/* default */.Z, {
                            ...
                            target: "_blank",
                            rel: "noopener noreferrer",
                            href: resolver/* explorerResolver.fungibleTokenLink */.Nb.fungibleTokenLink(evm_types/* ChainId.Mainnet */.a_.Mainnet, coin.contract_address),
...
const TrendingViewDeck_useStyles = (0,entry/* makeStyles */.ZL)()((theme)=>{
    return {
        root: {
            width: '100%',
            boxShadow: 'none',
...
function TrendingViewDeck(props) {
    ...
    const { t  } = (0,utils/* useI18N */.M1)();
    const classes = (0,entry/* useStylesExtends */.Bc)(TrendingViewDeck_useStyles(), props);
    // #region buy
    const transakPluginEnabled = (0,entry_content_script/* useActivatedPluginsSNSAdaptor */.Pz)('any').find((x)=>x.ID === src_entry/* PluginId.Transak */.je.Transak
    );
    ...
    const { setDialog: setBuyDialog  } = (0,shared_base_ui_src/* useRemoteControlledDialog */.F$)(Transak_messages/* PluginTransakMessages.buyTokenDialogUpdated */.l.buyTokenDialogUpdated);
    ...
    const currentPreferredCoinIdSettings = (0,shared_base_ui_src/* useValueRef */.E)((0,Trader_settings/* getCurrentPreferredCoinIdSettings */.Lc)(dataProvider));
                        ...
                        children: [
                            market ? /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
                                children: [
                                    ...
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(shared_src/* FormattedCurrency */.bO, {
                                            value: (dataProvider === public_api_src/* DataProvider.COIN_MARKET_CAP */.FW.COIN_MARKET_CAP ? (0,last/* default */.Z)(stats)?.[1] ?? market.current_price : market.current_price) ?? 0,
                                            formatter: src/* formatCurrency */.xG
                                        })
                                    })
                                ]
...
function useAvailableCoins(type, keyword, dataProvider) {
    ...
    return (0,useAsync/* default */.Z)(async ()=>{
        if (!keyword) return [];
        return messages/* PluginTraderRPC.getAvailableCoins */.V.getAvailableCoins(chainId, keyword, type, dataProvider);
    }, [
        dataProvider,
        type,
        keyword,
...
function usePreferredCoinId(keyword, dataProvider) {
    ...
    const settings = (0,shared_base_ui_src/* useValueRef */.E)((0,Trader_settings/* getCurrentPreferredCoinIdSettings */.Lc)(dataProvider));
...
var token = __webpack_require__(91761);
...
const TraderView_useStyles = (0,entry/* makeStyles */.ZL)()((theme, props)=>{
    return {
        root: props.isPopper ? {
            width: 450,
...
function TraderView(props) {
    ...
    const chainIdValid = (0,entry_web3/* useChainIdValid */.as)(src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM);
    ...
    // #region swap
    const { value: tokenDetailed  } = (0,entry_web3/* useFungibleToken */.cf)(src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM, coinSymbol === 'eth' ? '' : trending?.coin.contract_address ?? '');
    // #endregion
    // #region stats
    ...
    const DataProviderSwitcher = (0,react.useMemo)(()=>{
        ...
        return /*#__PURE__*/ (0,jsx_runtime.jsxs)(ActionButton/* default */.ZP, {
            sx: {
                marginTop: 1
            },
            color: "primary",
            ...
            children: [
                "Switch to ",
                (0,pipes/* resolveDataProviderName */.K7)(nextOption)
            ]
        });
    }, [
        dataProvider,
        pipes/* resolveDataProviderName */.K7
    ]);
    // // #endregion
    ...
    const isSwappable = (!!trending?.coin.contract_address || (0,token/* isNativeTokenSymbol */.VD)(coinSymbol)) && chainIdValid;
    // #endregion
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/react-use@17.4.0/node_modules/react-use/esm/useWindowScroll.js
var useWindowScroll = __webpack_require__(88822);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+base@5.0.0-alpha.81_ohobp6rpsmerwlq5ipwfh5yigy/node_modules/@mui/base/ClickAwayListener/ClickAwayListener.js
var ClickAwayListener = __webpack_require__(74388);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.8.0_4xriuibr7qayay6mzcpq5f43me/node_modules/@mui/material/Fade/Fade.js
var Fade = __webpack_require__(23970);
...
function TrendingPopper(props) {
    ...
    , []);
    (0,shared_base_ui_src/* useRemoteControlledDialog */.F$)(Wallet_messages/* WalletMessages.events.walletStatusDialogUpdated */.R.events.walletStatusDialogUpdated, onFreezed);
    (0,shared_base_ui_src/* useRemoteControlledDialog */.F$)(Wallet_messages/* WalletMessages.events.selectProviderDialogUpdated */.R.events.selectProviderDialogUpdated, onFreezed);
    (0,shared_base_ui_src/* useRemoteControlledDialog */.F$)(Transak_messages/* PluginTransakMessages.buyTokenDialogUpdated */.l.buyTokenDialogUpdated, onFreezed);
    (0,shared_base_ui_src/* useRemoteControlledDialog */.F$)(messages/* PluginTraderMessages.swapSettingsUpdated */.A.swapSettingsUpdated, onFreezed);
    // #endregion
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsx)(ClickAwayListener/* default */.Z, {
        ...
        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Popper/* default */.Z, {
            ...
            ,
            ...props.PopperProps,
            children: ({ TransitionProps  })=>/*#__PURE__*/ (0,jsx_runtime.jsx)(Fade/* default */.Z, {
                    in: Boolean(anchorEl),
                    ...TransitionProps,
                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                        children: props.children?.(name, type, availableDataProviders, ()=>setTimeout(()=>popperRef.current?.update()
                            , 100)
                        )
                    })
                })
...
const enhanceTag = {
    onHover (kind, content, event, chainId) {
        const element = event.currentTarget;
        const timer = setTimeout(async ()=>{
            const type = kind === 'cash' ? types/* TagType.CASH */.Qy.CASH : types/* TagType.HASH */.Qy.HASH;
            const dataProviders = await messages/* PluginTraderRPC.getAvailableDataProviders */.V.getAvailableDataProviders(chainId, type, content);
...
;// CONCATENATED MODULE: ../icons/general/SwapColorfulIcon.tsx


const SwapColorfulIcon = (0,icons_utils/* createIcon */.I)('SwapColorfulIcon', /*#__PURE__*/ (0,jsx_runtime.jsxs)("g", {
    children: [
        ...
        /*#__PURE__*/ (0,jsx_runtime.jsx)("path", {
            d: "M27.2495 13.001L22.2495 18.001H25.9995C25.9995 22.1385 22.637 25.501 18.4995 25.501C17.237 25.501 16.037 25.1885 14.9995 24.626L13.1745 26.451C14.712 27.426 16.537 28.001 18.4995 28.001C24.0245 28.001 28.4995 23.526 28.4995 18.001H32.2495L27.2495 13.001ZM10.9995 18.001C10.9995 13.8635 14.362 10.501 18.4995 10.501C19.762 10.501 20.962 10.8135 21.9995 11.376L23.8245 9.55098C22.287 8.57598 20.462 8.00098 18.4995 8.00098C12.9745 8.00098 8.49951 12.476 8.49951 18.001H4.74951L9.74951 23.001L14.7495 18.001H10.9995Z",
            fill: "white"
        })
    ]
}), '0 0 37 36');
...
const sns = {
    ...
    ApplicationEntries: [
        (()=>{
            const icon = /*#__PURE__*/ (0,jsx_runtime.jsx)(SwapColorfulIcon, {});
            ...
            return {
                ...
                RenderEntryComponent (EntryComponentProps) {
                    const { openDialog  } = (0,shared_base_ui_src/* useRemoteControlledDialog */.F$)(messages/* PluginTraderMessages.swapDialogUpdated */.A.swapDialogUpdated);
                    return /*#__PURE__*/ (0,jsx_runtime.jsx)(shared_src/* ApplicationEntry */.Tv, {
                        ...EntryComponentProps,
                        title: name,
                        icon: icon,
                        iconFilterColor: iconFilterColor,
                        onClick: EntryComponentProps.onClick ? ()=>EntryComponentProps.onClick?.(openDialog)
                         : openDialog
                    });
                },
    ...
    wrapperProps: {
        icon: /*#__PURE__*/ (0,jsx_runtime.jsx)(SwapColorfulIcon, {
            style: {
                width: 24,
                height: 24,
