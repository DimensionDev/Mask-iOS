"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[1911],{
...
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(74750);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(61212);
/* harmony import */ var _masknet_theme__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(14767);
...
var utils_chainDetailed = __webpack_require__(9094);
...
var base = __webpack_require__(91015);
// EXTERNAL MODULE: ./src/plugins/RedPacket/constants.ts
var constants = __webpack_require__(13329);
// EXTERNAL MODULE: ./src/plugins/RedPacket/SNSAdaptor/helpers.ts + 2 modules
var helpers = __webpack_require__(10605);
...
var messages = __webpack_require__(84273);
...
var TokenAmountPanel = __webpack_require__(99010);
...
function RedPacketERC20Form(props) {
    ...
    const [isRandom, setRandom] = (0,react.useState)((origin === null || origin === void 0 ? void 0 : origin.isRandom) ? 1 : 0);
    ...
    // amount
    const [rawAmount, setRawAmount] = (0,react.useState)((origin === null || origin === void 0 ? void 0 : origin.isRandom) ? (0,formatter/* formatBalance */.az)(origin === null || origin === void 0 ? void 0 : origin.total, (ref4 = (ref1 = origin.token) === null || ref1 === void 0 ? void 0 : ref1.decimals) !== null && ref4 !== void 0 ? ref4 : 0) : (0,formatter/* formatBalance */.az)(new (bignumber_default())((ref5 = origin === null || origin === void 0 ? void 0 : origin.total) !== null && ref5 !== void 0 ? ref5 : '0').div((ref6 = origin === null || origin === void 0 ? void 0 : origin.shares) !== null && ref6 !== void 0 ? ref6 : 1), (ref7 = origin === null || origin === void 0 ? void 0 : (ref2 = origin.token) === null || ref2 === void 0 ? void 0 : ref2.decimals) !== null && ref7 !== void 0 ? ref7 : 0));
    const amount = (0,base_src/* rightShift */.pu)(rawAmount !== null && rawAmount !== void 0 ? rawAmount : '0', token === null || token === void 0 ? void 0 : token.decimals);
    const totalAmount = (0,react.useMemo)(()=>(0,base_src/* multipliedBy */.$q)(amount, isRandom ? 1 : shares !== null && shares !== void 0 ? shares : '0')
    , [
        amount,
        shares
    ]);
    ...
    var ref8, ref9;
    // balance
    const { value: tokenBalance = '0' , loading: loadingTokenBalance  } = (0,useFungibleTokenBalance/* useFungibleTokenBalance */.V)((ref8 = token === null || token === void 0 ? void 0 : token.type) !== null && ref8 !== void 0 ? ref8 : types/* EthereumTokenType.Native */.Dr.Native, (ref9 = token === null || token === void 0 ? void 0 : token.address) !== null && ref9 !== void 0 ? ref9 : '');
    // #endregion
...
var call = __webpack_require__(54243);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.2.5_695e98f08a2d125282e19cae338368d2/node_modules/@mui/icons-material/ExpandMore.js
var ExpandMore = __webpack_require__(90384);
...
const ERC721ContractSelectPanel_useStyles = (0,src/* makeStyles */.ZL)()((theme, props)=>{
    return {
        root: {
            height: 52,
...
function ERC721ContractSelectPanel(props) {
    ...
    const { value: assets , loading: loadingBalanceFromNFTscan  } = (0,useNFTBalance/* useNFTBalance */.$)(account, !contract);
    const { t  } = (0,utils/* useI18N */.M1)();
    const balanceFromNFTscan = assets ? (ref = assets.find((asset)=>{
    ...
    const balance = balanceFromChain ? Number(balanceFromChain) : balanceFromNFTscan !== null && balanceFromNFTscan !== void 0 ? balanceFromNFTscan : 0;
    onBalanceChange(balance);
    const loading = (loadingFromChain || loadingBalanceFromNFTscan) && !balance;
    // #region select contract
    const [id] = (0,react.useState)((0,v4/* default */.Z)());
    const { setDialog: setNftContractDialog  } = (0,shared_src/* useRemoteControlledDialog */.F$)(Wallet_messages/* WalletMessages.events.selectNftContractDialogUpdated */.R.events.selectNftContractDialogUpdated, (0,react.useCallback)((ev)=>{
...
const EthereumERC721TokenApprovedBoundary_useStyles = (0,src/* makeStyles */.ZL)()(()=>({
        snackBarText: {
            fontSize: 14
        },
        snackBarLink: {
...
function EthereumERC721TokenApprovedBoundary(props) {
    ...
    const { t  } = (0,utils/* useI18N */.M1)();
    const classes = (0,src/* useStylesExtends */.Bc)(EthereumERC721TokenApprovedBoundary_useStyles(), props);
    const { value , loading , retry  } = useERC721ContractIsApproveForAll(contractDetailed === null || contractDetailed === void 0 ? void 0 : contractDetailed.address, owner, operator);
    const [approveState, approveCallback, resetCallback] = useERC721ContractSetApproveForAllCallback(contractDetailed === null || contractDetailed === void 0 ? void 0 : contractDetailed.address, operator, true);
                ...
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                        ...
                        children: t('plugin_wallet_approve_all_nft_successfully', {
                            symbol: contractDetailed === null || contractDetailed === void 0 ? void 0 : contractDetailed.symbol
                        })
                    }),
...
var useERC721TokenDetailedOwnerList = __webpack_require__(75342);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.2.5_695e98f08a2d125282e19cae338368d2/node_modules/@mui/icons-material/AddCircleOutline.js
var AddCircleOutline = __webpack_require__(81618);
...
const RedpacketMessagePanel_useStyles = (0,src/* makeStyles */.ZL)()((theme)=>{
    return {
        root: {
            height: 52,
            border: `1px solid ${theme.palette.mode === 'light' ? '#EBEEF0' : '#2F3336'}`,
...
var useERC721TokenDetailedCallback = __webpack_require__(21390);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.2.5_695e98f08a2d125282e19cae338368d2/node_modules/@mui/icons-material/QuestionMark.js
var QuestionMark = __webpack_require__(56389);
...
const SelectNftTokenDialog_useStyles = (0,src/* makeStyles */.ZL)()((theme, props)=>({
        dialogContent: {
            minHeight: 380
        },
...
function SelectNftTokenDialog(props) {
    ...
    const selectToken = (0,react.useCallback)((token, findToken, shiftKey, index)=>{
        if (!shiftKey || tokenIdFilterList.length > 0) {
            ...
            var _index, _index1;
            const tokenDetailedSelectedListSorted = tokenDetailedSelectedList.sort((a, b)=>((_index = b.index) !== null && _index !== void 0 ? _index : 0) - ((_index1 = a.index) !== null && _index1 !== void 0 ? _index1 : 0)
            );
            if (findToken) {
                ...
                while(nextToken){
                    ...
                    var ref;
                    const nextTokenIndex = ((ref = nextToken === null || nextToken === void 0 ? void 0 : nextToken.index) !== null && ref !== void 0 ? ref : 0) + 1;
                    var _index2;
                    nextToken = tokenDetailedSelectedListSorted.find((v)=>((_index2 = v.index) !== null && _index2 !== void 0 ? _index2 : 0) === nextTokenIndex
                    );
                }
                ...
                var ref1;
                const lastSelectedToken = tokenDetailedSelectedListSorted.filter((v)=>{
                    return ((ref1 = v === null || v === void 0 ? void 0 : v.index) !== null && ref1 !== void 0 ? ref1 : 0) < index;
                })[0];
                const lastSelectedTokenIndex = (0,findLastIndex/* default */.Z)(tokenDetailedOwnerList, (v, i)=>{
                    return v.tokenId === (lastSelectedToken === null || lastSelectedToken === void 0 ? void 0 : lastSelectedToken.tokenId) && i < index;
                });
    ...
    const onSearch = (0,react.useCallback)(async ()=>{
        ...
        setTokenDetailed((_tokenDetailed === null || _tokenDetailed === void 0 ? void 0 : _tokenDetailed.info.owner) ? {
            ..._tokenDetailed,
            index: 0
        } : undefined);
        setSearched(true);
    ...
    const isOwner = (0,address/* isSameAddress */.Wr)(account, tokenDetailed === null || tokenDetailed === void 0 ? void 0 : tokenDetailed.info.owner) || tokenDetailedSelectedList.length > 0;
    var ref2;
    const isAdded = existTokenDetailedList.map((t)=>t.tokenId
    ).includes((ref2 = tokenDetailed === null || tokenDetailed === void 0 ? void 0 : tokenDetailed.tokenId) !== null && ref2 !== void 0 ? ref2 : '');
    // #endregion
            ...
            children: [
                /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.Z, {
                    ...
                    children: [
                        ...
                        }) : (tokenDetailed === null || tokenDetailed === void 0 ? void 0 : tokenDetailed.info.name) ? /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.Z, {
                            className: classnames_default()(classes.wrapper, classes.nftWrapper),
                            children: [
                                /*#__PURE__*/ (0,jsx_runtime.jsx)("img", {
                                    className: classes.nftImg,
                                    src: tokenDetailed === null || tokenDetailed === void 0 ? void 0 : tokenDetailed.info.mediaUrl
                                }),
                                /*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
                                    ...
                                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                        className: classes.nftName,
                                        color: "textSecondary",
                                        children: tokenDetailed === null || tokenDetailed === void 0 ? void 0 : tokenDetailed.info.name
                                    })
                                })
                            ]
...
function NFTCard(props) {
    ...
    return(/*#__PURE__*/ (0,jsx_runtime.jsxs)(ListItem/* default */.ZP, {
        className: classnames_default()(classes.selectWrapper, tokenIdFilterList.length > 0 && !tokenIdFilterList.includes(token.tokenId) ? classes.hide : ''),
        children: [
            /*#__PURE__*/ (0,jsx_runtime.jsx)(shared_src/* NFTCardStyledAssetPlayer */.yC, {
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.2.5_695e98f08a2d125282e19cae338368d2/node_modules/@mui/icons-material/Launch.js
var Launch = __webpack_require__(82940);
...
const RedpacketNftConfirmDialog_useStyles = (0,src/* makeStyles */.ZL)()((theme)=>({
        root: {
            fontSize: 16
        },
        link: {
...
function RedpacketNftConfirmDialog(props) {
    ...
    const { attachMetadata  } = (0,plugin_infra_src/* useCompositionContext */.Cp)();
    const { t  } = (0,utils/* useI18N */.M1)();
    ...
    const currentIdentity = (0,useActivatedUI/* useCurrentIdentity */.Ud)();
    var _userId, ref1;
    const senderName = (ref1 = (_userId = currentIdentity === null || currentIdentity === void 0 ? void 0 : currentIdentity.identifier.userId) !== null && _userId !== void 0 ? _userId : currentIdentity === null || currentIdentity === void 0 ? void 0 : (ref2 = currentIdentity.linkedPersona) === null || ref2 === void 0 ? void 0 : ref2.nickname) !== null && ref1 !== void 0 ? ref1 : 'Unknown User';
    ...
    const onSendPost = (0,react.useCallback)((id)=>{
        ...
        attachMetadata(constants/* RedPacketNftMetaKey */.HA, {
            ...
            contractAddress: contract.address,
            contractTokenURI: (_iconURL = contract.iconURL) !== null && _iconURL !== void 0 ? _iconURL : '',
            contractVersion: 1,
            privateKey,
            chainId: contract.chainId
        });
    ...
    (0,react.useEffect)(()=>{
        ...
        if (createState.type === types/* TransactionStateType.CONFIRMED */.n$.CONFIRMED && createState.no === 0) {
            ...
            var _returnValues;
            const { id  } = (_returnValues = (ref = receipt.events) === null || ref === void 0 ? void 0 : ref.CreationSuccess.returnValues) !== null && _returnValues !== void 0 ? _returnValues : {};
            onSendPost(id);
            onClose();
        }
        resetCallback();
...
const RedPacketERC721Form_useStyles = (0,src/* makeStyles */.ZL)()((theme)=>{
    return {
        root: {
            display: 'flex',
            alignItems: 'stretch',
...
const RedPacketCreateNew_useStyles = (0,src/* makeStyles */.ZL)()((theme, { snsId  })=>({
        tab: {
            height: 36,
            minHeight: 36,
            fontWeight: 300
        ...
        tabs: {
            height: 36,
            minHeight: 36,
            margin: `0 ${snsId === minds_com_base/* MINDS_ID */.fN ? '12px' : 'auto'}`,
            borderRadius: 4,
...
var StyledLinearProgress = __webpack_require__(78504);
 ...
 */ function useAvailabilityComputed(account, payload) {
    const chainId = (0,useChainId/* useChainId */.xx)();
    var _network, ref;
    const parsedChainId = (ref = (0,utils_chainDetailed/* getChainIdFromName */.np)((_network = payload.network) !== null && _network !== void 0 ? _network : '')) !== null && ref !== void 0 ? ref : types/* ChainId.Mainnet */.a_.Mainnet;
    ...
    var _address;
    const isCreator = (0,address/* isSameAddress */.Wr)((_address = payload === null || payload === void 0 ? void 0 : payload.sender.address) !== null && _address !== void 0 ? _address : '', account);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/date-fns@2.28.0/node_modules/date-fns/esm/nextDay/index.js
var nextDay = __webpack_require__(74270);
...
const RedPacketInHistoryList_useStyles = (0,src/* makeStyles */.ZL)()((theme)=>{
...
function RedPacketInHistoryList(props) {
    ...
    const { value: tokenDetailed  } = (0,useFungibleTokenDetailed/* useFungibleTokenDetailed */.j)((0,address/* isSameAddress */.Wr)(NATIVE_TOKEN_ADDRESS, tokenAddress) ? types/* EthereumTokenType.Native */.Dr.Native : types/* EthereumTokenType.ERC20 */.Dr.ERC20, tokenAddress !== null && tokenAddress !== void 0 ? tokenAddress : '');
    var _token;
    ...
    (0,react.useEffect)(()=>{
        ...
        if (refundState.type === types/* TransactionStateType.HASH */.n$.HASH) {
            ...
            setTransactionDialog({
                open: true,
                state: refundState,
                summary: availability ? `Refunding lucky drop for ${(0,formatter/* formatBalance */.az)(new (bignumber_default())(availability.balance), (ref = historyToken === null || historyToken === void 0 ? void 0 : historyToken.decimals) !== null && ref !== void 0 ? ref : 0, (ref6 = historyToken === null || historyToken === void 0 ? void 0 : historyToken.decimals) !== null && ref6 !== void 0 ? ref6 : 0)} ${historyToken === null || historyToken === void 0 ? void 0 : historyToken.symbol}` : ''
            });
    ...
    const formatRefundDuration = `${refundDuration === null || refundDuration === void 0 ? void 0 : refundDuration.hours}h ${refundDuration === null || refundDuration === void 0 ? void 0 : refundDuration.minutes}m`;
    var ref3, ref4, ref5;
    // #endregion
        ...
        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.Z, {
            ...
            children: [
                /*#__PURE__*/ (0,jsx_runtime.jsx)(shared_src/* TokenIcon */.T1, {
                    ...
                    address: (ref3 = historyToken === null || historyToken === void 0 ? void 0 : historyToken.address) !== null && ref3 !== void 0 ? ref3 : '',
                    name: historyToken === null || historyToken === void 0 ? void 0 : historyToken.name,
                    logoURI: historyToken === null || historyToken === void 0 ? void 0 : historyToken.logoURI
                }),
                /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.Z, {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                            ...
                                            children: t('plugin_red_packet_history_total_amount', {
                                                amount: (0,formatter/* formatBalance */.az)(history.total, historyToken === null || historyToken === void 0 ? void 0 : historyToken.decimals, 6),
                                                symbol: historyToken === null || historyToken === void 0 ? void 0 : historyToken.symbol
                                            })
                                        }),
                                        /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                            variant: "body1",
                            ...
                            children: [
                                /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                    ...
                                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Trans/* Trans */.c, {
                                        ...
                                        values: {
                                            claimedShares: (ref4 = (ref1 = history.claimers) === null || ref1 === void 0 ? void 0 : ref1.length) !== null && ref4 !== void 0 ? ref4 : 0,
                                ...
                                /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                    ...
                                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Trans/* Trans */.c, {
                                        ...
                                        values: {
                                            amount: (0,formatter/* formatBalance */.az)(history.total, historyToken === null || historyToken === void 0 ? void 0 : historyToken.decimals, 6),
                                            claimedAmount: (0,formatter/* formatBalance */.az)(new (bignumber_default())(history.total).minus((ref5 = history === null || history === void 0 ? void 0 : history.total_remaining) !== null && ref5 !== void 0 ? ref5 : 0), historyToken === null || historyToken === void 0 ? void 0 : historyToken.decimals, 6),
                                            symbol: historyToken === null || historyToken === void 0 ? void 0 : historyToken.symbol
                                        }
                                    })
                                })
...
const RedPacketHistoryList_useStyles = (0,src/* makeStyles */.ZL)()((theme)=>{
    const smallQuery = `@media (max-width: ${theme.breakpoints.values.sm}px)`;
    return {
        root: {
            display: 'flex',
...
var fill = __webpack_require__(96462);
 ...
 */ function useNftAvailabilityComputed(account, payload) {
    const chainId = (0,useChainId/* useChainId */.xx)();
    const asyncResult = useAvailabilityNftRedPacket(payload === null || payload === void 0 ? void 0 : payload.rpid, account);
    const result = asyncResult;
    const availability = result.value;
...
const NftItem = ({ contract , tokenId , className , claimed , renderOrder , ...rest })=>{
    ...
    const [name, setName] = (0,react.useState)('#' + tokenId);
    if (!contract) {
        return(/*#__PURE__*/ (0,jsx_runtime.jsx)("div", {
            className: classnames_default()(className, classes.nft, classes.loading),
            ...rest,
...
const NftRedPacketHistoryItem_useStyles = (0,src/* makeStyles */.ZL)()((theme)=>{
    const smallQuery = `@media (max-width: ${theme.breakpoints.values.sm}px)`;
    return {
        root: {
            borderRadius: 10,
        ...
        children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.Z, {
            ...
            children: [
                /*#__PURE__*/ (0,jsx_runtime.jsx)(shared_src/* TokenIcon */.T1, {
                    ...
                    address: (ref = contractDetailed === null || contractDetailed === void 0 ? void 0 : contractDetailed.address) !== null && ref !== void 0 ? ref : '',
                    name: (ref1 = contractDetailed === null || contractDetailed === void 0 ? void 0 : contractDetailed.name) !== null && ref1 !== void 0 ? ref1 : '-',
                    logoURI: (ref2 = contractDetailed === null || contractDetailed === void 0 ? void 0 : contractDetailed.iconURL) !== null && ref2 !== void 0 ? ref2 : new URL(/* asset import */ __webpack_require__(33265), __webpack_require__.b).toString()
                }),
                /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.Z, {
                    className: classes.content,
                    children: [
...
const NftRedPacketHistoryList_useStyles = (0,src/* makeStyles */.ZL)()((theme, _, refs)=>{
    const smallQuery = `@media (max-width: ${theme.breakpoints.values.sm}px)`;
    return {
        root: {
            display: 'flex',
...
function NftRedPacketHistoryList({ onSend  }) {
    ...
    if (!(histories === null || histories === void 0 ? void 0 : histories.length)) {
        return(/*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
            className: classes.placeholder,
            color: "textSecondary",
...
const RedPacketPast_useStyles = (0,src/* makeStyles */.ZL)()((theme)=>({
        tab: {
            height: 36,
            minHeight: 36,
            fontWeight: 300
...
function RedPacketPast({ onSelect , onClose  }) {
    ...
    const currentIdentity = (0,useActivatedUI/* useCurrentIdentity */.Ud)();
    var _userId, ref1;
    const senderName = (ref1 = (_userId = currentIdentity === null || currentIdentity === void 0 ? void 0 : currentIdentity.identifier.userId) !== null && _userId !== void 0 ? _userId : currentIdentity === null || currentIdentity === void 0 ? void 0 : (ref = currentIdentity.linkedPersona) === null || ref === void 0 ? void 0 : ref.nickname) !== null && ref1 !== void 0 ? ref1 : 'Unknown User';
    const { attachMetadata  } = (0,plugin_infra_src/* useCompositionContext */.Cp)();
    const handleSendNftRedpacket = (0,react.useCallback)((history, contractDetailed)=>{
        ...
        attachMetadata(constants/* RedPacketNftMetaKey */.HA, {
            ...
            contractTokenURI: (_iconURL = contractDetailed.iconURL) !== null && _iconURL !== void 0 ? _iconURL : '',
...
function useCreateParams(redPacketSettings, version, publicKey) {
    ...
    return (0,useAsync/* default */.Z)(async ()=>{
        ...
        let gasError = null;
        const value = (0,base_src/* toFixed */.FH)(((ref = paramsObj.token) === null || ref === void 0 ? void 0 : ref.type) === types/* EthereumTokenType.Native */.Dr.Native ? total : 0);
...
const RedPacketConfirmDialog_useStyles = (0,src/* makeStyles */.ZL)()((theme)=>({
        link: {
            display: 'flex',
            marginLeft: theme.spacing(0.5)
        },
...
function RedPacketConfirmDialog(props) {
    var ref10, ref1, ref2, ref3, ref4, ref5, ref6;
    const { t  } = (0,utils/* useI18N */.M1)();
    ...
    (0,react.useEffect)(()=>{
        var ref;
        if ((settings === null || settings === void 0 ? void 0 : (ref = settings.token) === null || ref === void 0 ? void 0 : ref.chainId) !== chainId) onClose();
    }, [
        chainId,
        onClose
    ]);
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Grid/* default */.ZP, {
                ...
                children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(Typography/* default */.Z, {
                    ...
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsx)("span", {
                            children: settings === null || settings === void 0 ? void 0 : (ref10 = settings.token) === null || ref10 === void 0 ? void 0 : ref10.symbol
                        }),
                        (0,address/* isNativeTokenAddress */.qw)(settings === null || settings === void 0 ? void 0 : settings.token) ? null : /*#__PURE__*/ (0,jsx_runtime.jsx)(Link/* default */.Z, {
                            color: "textPrimary",
                            className: classes.link,
                            href: (0,pipes/* resolveTokenLinkOnExplorer */.yW)(settings === null || settings === void 0 ? void 0 : settings.token),
                            target: "_blank",
                            rel: "noopener noreferrer",
                            onClick: stop,
                            children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Launch/* default */.Z, {
                    ...
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Grid/* default */.ZP, {
                        ...
                        children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                            ...
                            children: /*#__PURE__*/ (0,jsx_runtime.jsx)(shared_src/* FormattedBalance */.BV, {
                                value: new (bignumber_default())((ref7 = settings === null || settings === void 0 ? void 0 : settings.total) !== null && ref7 !== void 0 ? ref7 : 0).div((ref8 = settings === null || settings === void 0 ? void 0 : settings.shares) !== null && ref8 !== void 0 ? ref8 : 1),
                                decimals: settings === null || settings === void 0 ? void 0 : (ref1 = settings.token) === null || ref1 === void 0 ? void 0 : ref1.decimals,
                                symbol: settings === null || settings === void 0 ? void 0 : (ref2 = settings.token) === null || ref2 === void 0 ? void 0 : ref2.symbol,
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Grid/* default */.ZP, {
                ...
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                    ...
                    children: /*#__PURE__*/ (0,jsx_runtime.jsx)(shared_src/* FormattedBalance */.BV, {
                        ...
                        decimals: settings === null || settings === void 0 ? void 0 : (ref3 = settings.token) === null || ref3 === void 0 ? void 0 : ref3.decimals,
                        symbol: settings === null || settings === void 0 ? void 0 : (ref4 = settings.token) === null || ref4 === void 0 ? void 0 : ref4.symbol,
                        formatter: formatter/* formatBalance */.az
                    })
                })
            }),
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Grid/* default */.ZP, {
                ...
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(ActionButton/* default */.ZP, {
                    ...
                    onClick: onCreate,
                    children: t('plugin_red_packet_send_symbol', {
                        amount: (0,formatter/* formatBalance */.az)(settings === null || settings === void 0 ? void 0 : settings.total, (ref9 = settings === null || settings === void 0 ? void 0 : (ref5 = settings.token) === null || ref5 === void 0 ? void 0 : ref5.decimals) !== null && ref9 !== void 0 ? ref9 : 0),
                        symbol: settings === null || settings === void 0 ? void 0 : (ref6 = settings.token) === null || ref6 === void 0 ? void 0 : ref6.symbol
                    })
                })
            })
        ]
...
const RedPacketDialog_useStyles = (0,src/* makeStyles */.ZL)()((theme)=>({
        content: {
            position: 'relative',
            paddingTop: 50
        },
...
function RedPacketDialog(props) {
    ...
    const onCreateOrSelect = (0,react.useCallback)(async (payload)=>{
        if (payload.password === '') {
            if (payload.contract_version === 1) {
                ...
                var ref;
                payload.password = (ref = prompt('Please enter the password of the lucky drop:', '')) !== null && ref !== void 0 ? ref : '';
            } else if (payload.contract_version > 1 && payload.contract_version < 4) {
                var ref1;
                // just sign out the password if it is lost.
                payload.password = await service/* default.Ethereum.personalSign */.ZP.Ethereum.personalSign((ref1 = lib_default().sha3(payload.sender.message)) !== null && ref1 !== void 0 ? ref1 : '', account);
    ...
    (0,react.useEffect)(()=>{
        var ref;
        if (!(createSettings === null || createSettings === void 0 ? void 0 : createSettings.token) || createState.type === types/* TransactionStateType.UNKNOWN */.n$.UNKNOWN) return;
        ...
        setTransactionDialog({
            ...
            summary: t('plugin_red_packet_create_with_token', {
                amount: (0,formatter/* formatBalance */.az)(createSettings === null || createSettings === void 0 ? void 0 : createSettings.total, createSettings === null || createSettings === void 0 ? void 0 : (ref = createSettings.token) === null || ref === void 0 ? void 0 : ref.decimals),
                symbol: createSettings === null || createSettings === void 0 ? void 0 : createSettings.token.symbol
            })
        });
    }, [
        ...
        tabs: [
            {
                ...
                children: (0,src/* usePortalShadowRoot */.ad)((container)=>/*#__PURE__*/ (0,jsx_runtime.jsx)(RedPacketCreateNew, {
                        origin: settings,
                        onNext: onNext,
                        state: tokenState,
                        onClose: onClose,
...
const useStyles_useStyles = (0,src/* makeStyles */.ZL)()((theme)=>{
    const spinningAnimationKeyFrames = src/* keyframes */.F4`
to {
...
function OperationFooter({ canClaim , canRefund , claimState , refundState , shareLink , onClaimOrRefund  }) {
...
function RedPacket(props) {
    ...
    const shareLink = (ref2 = (_utils = social_network.activatedSocialNetworkUI.utils).getShareLinkURL) === null || ref2 === void 0 ? void 0 : ref2.call(_utils, t((0,twitter_com_base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) || (0,facebook_com_base/* isFacebook */.DF)(social_network.activatedSocialNetworkUI) ? 'plugin_red_packet_share_message_official_account' : 'plugin_red_packet_share_message_not_twitter', {
        sender: payload.sender.name,
        payload: postLink,
        network: (0,pipes/* resolveNetworkName */.nW)(networkType),
        account: (0,twitter_com_base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) ? t('twitter_account') : t('facebook_account')
    }).trim()).toString();
    ...
    const onClaimOrRefundOnNative = (0,react.useCallback)(async ()=>{
        if (!availability) return;
        await (native_rpc/* nativeAPI */.Nz === null || native_rpc/* nativeAPI */.Nz === void 0 ? void 0 : native_rpc/* nativeAPI.api.claimOrRefundRedpacket */.Nz.api.claimOrRefundRedpacket({
    ...
    (0,react.useEffect)(()=>{
        ...
        if (native_rpc/* hasNativeAPI */._) {
            native_rpc/* nativeAPI */.Nz === null || native_rpc/* nativeAPI */.Nz === void 0 ? void 0 : native_rpc/* nativeAPI.api.notifyRedpacket */.Nz.api.notifyRedpacket({
                redpacketPayload: payload,
                availability: {
                    token_address: availability.token_address,
                    balance: availability.balance,
    ...
    if (!availability || !token) return(/*#__PURE__*/ (0,jsx_runtime.jsx)(EthereumChainBoundary/* EthereumChainBoundary */.T, {
        chainId: (ref7 = (0,utils_chainDetailed/* getChainIdFromName */.np)((_network = payload.network) !== null && _network !== void 0 ? _network : '')) !== null && ref7 !== void 0 ? ref7 : types/* ChainId.Mainnet */.a_.Mainnet,
    ...
    var _network1, ref8, _name;
    return(/*#__PURE__*/ (0,jsx_runtime.jsxs)(EthereumChainBoundary/* EthereumChainBoundary */.T, {
        chainId: (ref8 = (0,utils_chainDetailed/* getChainIdFromName */.np)((_network1 = payload.network) !== null && _network1 !== void 0 ? _network1 : '')) !== null && ref8 !== void 0 ? ref8 : types/* ChainId.Mainnet */.a_.Mainnet,
        children: [
...
function RedPacketInPost(props) {
    ...
    const postIdentifier = usePostInfo/* usePostInfoDetails.identifier */.H9.identifier();
...
const RedPacketNft_useStyles = (0,src/* makeStyles */.ZL)()((theme)=>({
        root: {
            position: 'relative'
        },
        actions: {
...
function RedPacketNft({ payload  }) {
    ...
    const [claimState, claimCallback, resetCallback] = useClaimNftRedpacketCallback(payload.id, availability === null || availability === void 0 ? void 0 : availability.totalAmount, web3.eth.accounts.sign(account, payload.privateKey).signature);
    ...
    const openAddressLinkOnExplorer = (0,react.useCallback)(()=>{
        window.open((0,pipes/* resolveAddressLinkOnExplorer */.V3)(payload.chainId, payload.contractAddress), '_blank', 'noopener noreferrer');
    }, [
        payload
    ]);
    ...
    const postLink = (0,usePostInfo/* usePostLink */.Vc)();
    const networkType = (0,useNetworkType/* useNetworkType */.b)();
    const shareLink = (ref = (_utils = social_network.activatedSocialNetworkUI.utils).getShareLinkURL) === null || ref === void 0 ? void 0 : ref.call(_utils, (availability === null || availability === void 0 ? void 0 : availability.isClaimed) ? t((0,twitter_com_base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) || (0,facebook_com_base/* isFacebook */.DF)(social_network.activatedSocialNetworkUI) ? 'plugin_red_packet_nft_share_claimed_message' : 'plugin_red_packet_nft_share_claimed_message_not_twitter', {
        sender: payload.senderName,
        payload: postLink,
        network: (0,pipes/* resolveNetworkName */.nW)(networkType),
        account: (0,twitter_com_base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) ? t('twitter_account') : t('facebook_account')
    }).trim() : t((0,twitter_com_base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) || (0,facebook_com_base/* isFacebook */.DF)(social_network.activatedSocialNetworkUI) ? 'plugin_red_packet_nft_share_foreshow_message' : 'plugin_red_packet_nft_share_foreshow_message_not_twitter', {
        sender: payload.senderName,
        payload: postLink,
        network: (0,pipes/* resolveNetworkName */.nW)(networkType),
        account: (0,twitter_com_base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) ? t('twitter_account') : t('facebook_account')
...
var general_RedPacket = __webpack_require__(73696);
...
const sns = {
    ...
    DecryptedInspector (props) {
        if ((0,helpers/* RedPacketMetadataReader */.Qc)(props.message.meta).ok) return(/*#__PURE__*/ (0,jsx_runtime.jsx)(MaskPluginWrapper/* default */.Z, {
            pluginName: "Lucky Drop",
        ...
        if ((0,helpers/* RedPacketNftMetadataReader */.st)(props.message.meta).ok) return(/*#__PURE__*/ (0,jsx_runtime.jsx)(MaskPluginWrapper/* default */.Z, {
            pluginName: "NFT Lucky Drop",
            publisher: base/* base.publisher */.u.publisher,
...
function ERC20RedpacketBadge(props) {
    ...
    const { payload  } = props;
    var ref2;
    const { value: fetchedToken  } = (0,useERC20TokenDetailed/* useERC20TokenDetailed */.k)((ref2 = (ref = payload.token) === null || ref === void 0 ? void 0 : ref.address) !== null && ref2 !== void 0 ? ref2 : payload.token_address);
    var _network, ref3;
    const chainId = (ref3 = (0,utils_chainDetailed/* getChainIdFromName */.np)((_network = payload.network) !== null && _network !== void 0 ? _network : '')) !== null && ref3 !== void 0 ? ref3 : types/* ChainId.Mainnet */.a_.Mainnet;
    const chainDetailed = (0,utils_chainDetailed/* getChainDetailed */.$G)(chainId);
    var _token;
    const tokenDetailed = ((ref1 = payload.token) === null || ref1 === void 0 ? void 0 : ref1.type) === types/* EthereumTokenType.Native */.Dr.Native ? chainDetailed === null || chainDetailed === void 0 ? void 0 : chainDetailed.nativeCurrency : (_token = payload.token) !== null && _token !== void 0 ? _token : fetchedToken;
    var ref4, ref5, ref6;
    return(/*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
        children: [
            "🧧 A Lucky Drop with ",
...
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13329);
/* harmony import */ var _masknet_plugin_infra__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(94531);
...
var Error = __webpack_require__(29325);
...
/* harmony import */ var _useERC721TokenDetailed__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(70718);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(36130);
/* harmony import */ var _contracts_useERC721TokenContract__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(68699);
...
/* harmony import */ var wallet_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(99674);
/* harmony import */ var wallet_ts__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(wallet_ts__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _contracts_useERC721TokenContract__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(68699);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(36130);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(54243);
/* harmony import */ var _useERC721TokenDetailed__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(70718);
...
/* harmony import */ var _useERC20TokenBalance__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(11091);
/* harmony import */ var _useNativeTokenBalance__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2871);
