"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[9384],{
...
const Logout = /*#__PURE__*/ (0,react.memo)(()=>{
    const { selectedPersona  } = usePersonaContext/* PersonaContext.useContainer */.m.useContainer();
    ...
    const [{ loading  }, onLogout] = (0,useAsyncFn/* default */.Z)(async ()=>{
        ...
        await service/* default.Identity.logoutPersona */.ZP.Identity.logoutPersona(selectedPersona.identifier);
        ...
        if (!currentPersona) {
            ...
            if (lastCreatedPersona) await service/* default.Settings.setCurrentPersonaIdentifier */.ZP.Settings.setCurrentPersonaIdentifier(lastCreatedPersona);
        }
        navigate(src/* PopupRoutes.Personas */.mZ.Personas, {
            replace: true
        });
    }, [
        selectedPersona,
...
const LogoutUI = /*#__PURE__*/ (0,react.memo)(({ backupPassword , loading , onLogout , onCancel , selectedPersona  })=>{
    const { t  } = (0,src_utils/* useI18N */.M1)();
    const { classes  } = useStyles();
    const [password, setPassword] = (0,react.useState)('');
    const [error, setError] = (0,react.useState)(false);
    (0,useTitle/* useTitle */.Z)(t('popups_log_out'));
                            ...
                            /*#__PURE__*/ (0,jsx_runtime.jsxs)("div", {
                                children: [
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                        ...
                                        children: selectedPersona?.nickname
                                    }),
                                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                        className: classes.identifier,
                                        children: (0,src/* formatPersonaFingerprint */.Nb)(selectedPersona?.identifier.rawPublicKey ?? '', 10)
                                    })
                                ]
                            })
                        ]
