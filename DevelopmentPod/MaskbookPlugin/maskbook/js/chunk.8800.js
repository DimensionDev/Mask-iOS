"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[8800],{
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.6.1_15f9e73798f83ff073fea11061a4a4f7/node_modules/@mui/icons-material/Print.js
var Print = __webpack_require__(27206);
...
const PersonaRecovery = ()=>{
    ...
    (0,useAsync/* default */.Z)(async ()=>{
        ...
        (!state?.mnemonic || await (!API/* Services.Identity.validateMnemonic */.K9.Identity.validateMnemonic(state?.mnemonic.join(' ')))) && !state?.privateKey) {
    ...
    const onNext = (0,react.useCallback)(async (personaName)=>{
        setError('');
        try {
            const identifier = state?.mnemonic ? await createPersona(state?.mnemonic.join(' '), personaName) : await createPersonaByPrivateKey(state?.privateKey, personaName);
            await changeCurrentPersona(identifier);
