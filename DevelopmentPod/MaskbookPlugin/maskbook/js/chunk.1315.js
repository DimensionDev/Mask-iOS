"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[1315],{
...
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(74750);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(76342);
/* harmony import */ var react_use__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(18228);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(40299);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(52311);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(78796);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(43463);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(95097);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(60822);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(40675);
/* harmony import */ var _masknet_theme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(14767);
/* harmony import */ var _components_NetworkSelector__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(97035);
/* harmony import */ var _mui_lab__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(30212);
/* harmony import */ var _mui_lab__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(67828);
/* harmony import */ var _masknet_icons__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(49561);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(28620);
/* harmony import */ var _plugins_Wallet_messages__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(98697);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(76108);
/* harmony import */ var _components_PasswordField__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(88183);
/* harmony import */ var _service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(8267);
...
const StyledTabs = (0,_mui_material__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .ZP)(_mui_material__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z)`
    &.${_mui_material__WEBPACK_IMPORTED_MODULE_10__/* ["default"].root */ .Z.root} {
        min-height: unset;
        background-color: #f7f9fa;
        padding-top: 6px;
    }
    & .${_mui_material__WEBPACK_IMPORTED_MODULE_10__/* ["default"].indicator */ .Z.indicator} {
        display: none;
    }
    & .${_mui_material__WEBPACK_IMPORTED_MODULE_10__/* ["default"].flexContainer */ .Z.flexContainer} {
        justify-content: center;
    }
`;
const StyledTab = (0,_mui_material__WEBPACK_IMPORTED_MODULE_8__/* ["default"] */ .ZP)(_mui_material__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .Z)`
    &.${_mui_material__WEBPACK_IMPORTED_MODULE_12__/* ["default"].root */ .Z.root} {
        font-size: 12px;
        line-height: 16px;
        min-height: unset;
        min-width: 165px;
    ...
    &.${_mui_material__WEBPACK_IMPORTED_MODULE_12__/* ["default"].selected */ .Z.selected} {
...
var BackupTabs;
(function(BackupTabs) {
    BackupTabs["JsonFile"] = 'Json File';
    BackupTabs["PrivateKey"] = 'Private Key';
...
const BackupWallet = /*#__PURE__*/ (0,react__WEBPACK_IMPORTED_MODULE_1__.memo)(()=>{
    ...
    const wallet = (0,_masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_13__/* .useWallet */ .O)();
    ...
    const [{ value: exportValue  }, onConfirm] = (0,react_use__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .Z)(async ()=>{
        if (!(wallet === null || wallet === void 0 ? void 0 : wallet.hasStoredKeyInfo)) return;
        try {
            return {
                jsonFile: await _plugins_Wallet_messages__WEBPACK_IMPORTED_MODULE_4__/* .WalletRPC.exportKeyStoreJSON */ .V.exportKeyStoreJSON(wallet.address, password),
                privateKey: await _plugins_Wallet_messages__WEBPACK_IMPORTED_MODULE_4__/* .WalletRPC.exportPrivateKey */ .V.exportPrivateKey(wallet.address, password)
            };
        } catch (error) {
    ...
    const { jsonFile , privateKey  } = exportValue !== null && exportValue !== void 0 ? exportValue : {
        jsonFile: '',
        privateKey: ''
    };
    const [{ value: downloadValue  }, onExport] = (0,react_use__WEBPACK_IMPORTED_MODULE_14__/* ["default"] */ .Z)(async ()=>{
        try {
            await _service__WEBPACK_IMPORTED_MODULE_7__/* ["default"].Welcome.downloadBackup */ .ZP.Welcome.downloadBackup(jsonFile, 'json');
            return true;
        } catch (error) {
            if (error instanceof Error) {
                setErrorMessage(error.message);
    ...
    return(/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
        children: [
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
                ...
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mui_lab__WEBPACK_IMPORTED_MODULE_16__/* ["default"] */ .ZP, {
                    value: currentTab,
                    children: [
                        ...
                        jsonFile ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mui_lab__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .Z, {
                            value: BackupTabs.JsonFile,
                            ...
                            children: [
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
                                    ...
                                    children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_masknet_icons__WEBPACK_IMPORTED_MODULE_18__/* .File */ .$, {
                                        style: {
                                            fontSize: 32,
                                            width: 32,
                                            height: 32
                        ...
                        privateKey ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(_mui_lab__WEBPACK_IMPORTED_MODULE_17__/* ["default"] */ .Z, {
                            value: BackupTabs.PrivateKey,
                            className: classes.tabPanel,
                            style: {
                            ...
                            children: [
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Z, {
                                    ...
                                    children: privateKey !== null && privateKey !== void 0 ? privateKey : ''
                                }),
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Z, {
                                    className: classes.tip,
                        ...
                        !jsonFile && !privateKey ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            className: classes.tabPanel,
                            style: {
                                flex: 1
                            },
                            children: [
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_15__/* ["default"] */ .Z, {
                                    ...
                                    children: t('wallet_confirm_with_password')
                                }),
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_components_PasswordField__WEBPACK_IMPORTED_MODULE_6__/* .PasswordField */ .Z, {
                                    value: password,
            ...
            !(privateKey && currentTab === BackupTabs.PrivateKey) ? /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
                style: {
                    padding: 16
                },
                children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(_mui_material__WEBPACK_IMPORTED_MODULE_19__/* ["default"] */ .Z, {
                    ...
                    children: jsonFile ? t('export') : t('popups_wallet_next')
                })
            }) : null
        ]
    }));
