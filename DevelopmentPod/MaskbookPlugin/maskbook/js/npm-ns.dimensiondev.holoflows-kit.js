...
(function (global, factory) {
    ...
    class LiveSelector {
        ...
        constructor(initialElements = []) {
            Object.defineProperty(this, "initialElements", {
                enumerable: true,
                configurable: true,
                writable: true,
             ...
             */
            Object.defineProperty(this, "appendSelectorChain", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: (type) => (param) => {
             ...
             */
            Object.defineProperty(this, "selectorChain", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: []
            ...
            for (const op of this.selectorChain) {
                ...
                switch (op.type) {
                    ...
                    case 'sort':
                        ...
                        break;
                    case 'at': {
                        arr = [at$1(arr, op.param)].filter(nonNull);
                        break;
                    }
                    case 'flat':
                        arr = [].concat(...arr);
    ...
    var object = {
      ...
      pickBy, result: result$1, set, setWith, toPairs,
    ...
    var util = {
      attempt, bindAll, cond, conforms, constant: constant$1,
    ...
    function createEventTarget() {
        const emitter = new dist.Emitter();
        ...
        return {
            has(key) {
                var _a;
                return (((_a = emitter.$[key]) === null || _a === void 0 ? void 0 : _a.size) || 0) > 0;
            },
            add(event, callback, options) {
                var _a;
                const off = (options === null || options === void 0 ? void 0 : options.once) ? dist.once(emitter, event, callback) : emitter.on(event, callback);
                getOff(event).set(callback, off);
                (_a = options === null || options === void 0 ? void 0 : options.signal) === null || _a === void 0 ? void 0 : _a.addEventListener('abort', off, { once: true });
                return off;
            },
            remove(event, callback) {
                var _a;
                (_a = getOff(event).get(callback)) === null || _a === void 0 ? void 0 : _a();
            },
            emitter,
            emit(type, ...args) {
    ...
    class Watcher {
        constructor(liveSelector) {
            ...
            Object.defineProperty(this, "events", {
                ...
                configurable: true,
                writable: true,
                value: createEventTarget()
            });
            /**
             * The liveSelector that this object holds.
             */
            Object.defineProperty(this, "liveSelector", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: void 0
            ...
            //#region useForeach
            /** Saved useForeach */
            Object.defineProperty(this, "useForeachFn", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: void 0
            ...
            Object.defineProperty(this, "lastKeyList", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: []
            ...
            Object.defineProperty(this, "lastNodeList", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: []
            ...
            Object.defineProperty(this, "lastCallbackMap", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: new Map()
            ...
            Object.defineProperty(this, "lastDOMProxyMap", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: new Map()
            ...
            Object.defineProperty(this, "findNodeFromListByKey", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: (list, keys) => (key) => {
            ...
            Object.defineProperty(this, "singleModeLastValue", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: void 0
            ...
            Object.defineProperty(this, "singleModeHasLastValue", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: false
            ...
            Object.defineProperty(this, "singleModeCallback", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: void 0
            ...
            Object.defineProperty(this, "watcherChecker", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: (deadline) => {
             ...
             */
            Object.defineProperty(this, "domProxyOption", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: {}
            ...
            /** The first DOMProxy */
            Object.defineProperty(this, "_firstDOMProxy", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: DOMProxy(this.domProxyOption)
            });
            //#endregion
             ...
             */
            Object.defineProperty(this, "mapNodeToKey", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: defaultMapNodeToKey
            });
            /**
             * Compare between `key` and `key`, in case of you don't want the default behavior
             */
            Object.defineProperty(this, "keyComparer", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: defaultEqualityComparer
            });
            /**
             * Compare between `value` and `value`, in case of you don't want the default behavior
             */
            Object.defineProperty(this, "valueComparer", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: defaultEqualityComparer
            ...
            Object.defineProperty(this, "isWatcherCheckerRunning", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: false
            });
            Object.defineProperty(this, "needCheckerRunAgainAfterCurrentSchedule", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: false
             ...
             */
            Object.defineProperty(this, "scheduleWatcherCheck", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: () => {
            ...
            Object.defineProperty(this, "requestIdleCallback", {
                enumerable: true,
                configurable: true,
                writable: true,
            ...
            Object.defineProperty(this, "stack", {
                ...
                configurable: true,
                writable: true,
                value: (_a = new Error().stack) !== null && _a !== void 0 ? _a : ''
            });
            //#endregion
            //#region Warnings
            /**
             ...
             */
            Object.defineProperty(this, "_warning_forget_watch_", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: warning({
            ...
            Object.defineProperty(this, "_warning_repeated_keys", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: warning({ once: true })
            });
            Object.defineProperty(this, "_warning_single_mode", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: warning({
...
Or to ignore this message, call \`.dismissSingleModeWarning()\` on the watcher.\n`, stack);
            ...
            Object.defineProperty(this, "_warning_mutation_", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: warning({
    ...
    class MutationObserverWatcher extends Watcher {
        ...
        stopWatchOnDisconnected = false) {
            ...
            Object.defineProperty(this, "consistentWatchRoot", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: consistentWatchRoot
            });
            Object.defineProperty(this, "stopWatchOnDisconnected", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: stopWatchOnDisconnected
            });
            ...
            Object.defineProperty(this, "observer", {
                ...
                configurable: true,
                writable: true,
                value: new MutationObserver((mutations, observer) => {
    ...
    })(exports.Environment = exports.Environment || (exports.Environment = {}));
    let result;
    /**
    ...
    })(exports.MessageTarget = exports.MessageTarget || (exports.MessageTarget = {}));
    const throwSetter = () => {
        throw new TypeError();
    };
    ...
    const domainRegistry = new dist.Emitter();
    ...
    class WebExtensionMessage {
        ...
        constructor(options) {
            ...
            Object.defineProperty(this, "serialization", {
                ...
                configurable: true,
                writable: true,
                value: { deserialization: (x) => x, serialization: (x) => x }
            });
            Object.defineProperty(this, "logFormatter", {
                enumerable: true,
                configurable: true,
                writable: true,
                value: (instance, key, data) => {
                    return [
            ...
            _WebExtensionMessage_eventRegistry.set(this, createEventTarget());
        ...
        get eventRegistry() {
            return __classPrivateFieldGet(this, _WebExtensionMessage_eventRegistry, "f").emitter;
        }
    }
    ...
    Object.defineProperty(WebExtensionMessage, "acceptExternalConnectFns", {
        enumerable: true,
        configurable: true,
        writable: true,
        value: new Set()
