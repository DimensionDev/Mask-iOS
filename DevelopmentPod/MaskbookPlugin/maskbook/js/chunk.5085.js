(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[5085],{
...
/* harmony import */ var _mui_material_Tabs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(49103);
/* harmony import */ var _TabContext__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(38884);
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(24515);
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(80672);
...
/* harmony import */ var _mui_material__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9744);
/* harmony import */ var _mui_material_styles__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8571);
...
var useRecentTransactions = __webpack_require__(71668);
...
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(98086);
/* harmony import */ var _masknet_web3_shared_evm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(63541);
/* harmony import */ var _API__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(85971);
...
var PageFrame = __webpack_require__(96449);
// EXTERNAL MODULE: ../dashboard/src/locales/index.ts
var locales = __webpack_require__(21692);
// EXTERNAL MODULE: ../dashboard/src/components/ContentContainer/index.tsx
var ContentContainer = __webpack_require__(96621);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+lab@5.0.0-alpha.71_6860626c1dd203d2615586c177a8991f/node_modules/@mui/lab/TabList/TabList.js
var TabList = __webpack_require__(39362);
...
var Empty = __webpack_require__(63413);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/Tooltip/Tooltip.js + 1 modules
var Tooltip = __webpack_require__(8309);
...
const ChangeNetworkTip = /*#__PURE__*/ (0,react.memo)(({ chainId  })=>{
    ...
    var _SelectNetworkMenu;
    const { NetworkIconClickBait  } = (_SelectNetworkMenu = (0,src/* useWeb3UI */.$d)().SelectNetworkMenu) !== null && _SelectNetworkMenu !== void 0 ? _SelectNetworkMenu : {};
    const networkDescriptors = (0,src/* useNetworkDescriptors */.px)();
...
const FungibleTokenTableRow = /*#__PURE__*/ (0,react.memo)(({ asset , onSend , onSwap  })=>{
    ...
    const currentChainId = (0,src/* useChainId */.xx)();
    const { Utils  } = (0,src/* useWeb3State */.dM)();
    const networkDescriptors = (0,src/* useNetworkDescriptors */.px)();
    const currentPluginId = (0,src/* usePluginIDContext */.Zn)();
    ...
    return(/*#__PURE__*/ (0,jsx_runtime.jsxs)(TableRow/* default */.Z, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(TableCell/* default */.Z, {
                ...
                variant: "body",
                children: /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                    children: ((ref2 = asset.price) === null || ref2 === void 0 ? void 0 : ref2[src/* CurrencyType.USD */.V2.USD]) ? new (bignumber_default())((_USD = asset.price[src/* CurrencyType.USD */.V2.USD]) !== null && _USD !== void 0 ? _USD : '').gt((0,base_src/* pow10 */.wA)(-6)) ? Utils === null || Utils === void 0 ? void 0 : (ref3 = Utils.formatCurrency) === null || ref3 === void 0 ? void 0 : ref3.call(Utils, Number.parseFloat((_USD1 = asset.price[src/* CurrencyType.USD */.V2.USD]) !== null && _USD1 !== void 0 ? _USD1 : ''), '$') : '<0.000001' : '-'
                })
            }),
            /*#__PURE__*/ (0,jsx_runtime.jsx)(TableCell/* default */.Z, {
                className: classes.cell,
            ...
            currentPluginId === src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM && /*#__PURE__*/ (0,jsx_runtime.jsxs)(TableCell/* default */.Z, {
                sx: {
                    minWidth: '200px'
                },
                className: classes.cell,
...
const FungibleTokenTable = /*#__PURE__*/ (0,react.memo)(({ selectedChainId  })=>{
    ...
    const { Asset  } = (0,src/* useWeb3State */.dM)();
                ...
                /*#__PURE__*/ (0,jsx_runtime.jsx)(TableHead/* default */.Z, {
                    children: /*#__PURE__*/ (0,jsx_runtime.jsxs)(TableRow/* default */.Z, {
                        children: [
                            ...
                            currentPluginId === src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM && /*#__PURE__*/ (0,jsx_runtime.jsx)(TableCell/* default */.Z, {
                                align: "center",
                                variant: "head",
                                className: classes.header,
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/Stack/Stack.js
var Stack = __webpack_require__(80672);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/TablePagination/TablePagination.js + 3 modules
var TablePagination = __webpack_require__(31438);
// EXTERNAL MODULE: ../web3-shared/evm/utils/misc.ts
var misc = __webpack_require__(7454);
...
const CollectiblePlaceholder = /*#__PURE__*/ (0,react.memo)(({ chainId  })=>{
    ...
    const t = (0,locales/* useDashboardI18N */.x)();
    const networkDescriptor = (0,src/* useNetworkDescriptor */.Vw)(chainId);
...
const CollectibleCard = /*#__PURE__*/ (0,react.memo)(({ chainId , token , onSend , renderOrder  })=>{
    ...
    const networkDescriptor = (0,src/* useNetworkDescriptor */.Vw)((ref8 = token.contract) === null || ref8 === void 0 ? void 0 : ref8.chainId);
    ...
    const sendable = currentPluginId === src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM;
...
var hooks_useChainId = __webpack_require__(63541);
...
var hooks_useNativeTokenDetailed = __webpack_require__(80955);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.4.4_d06e3de907ce734e888a65f5db1d962e/node_modules/@mui/icons-material/Tune.js
var Tune = __webpack_require__(45121);
...
const TransferERC20 = /*#__PURE__*/ (0,react.memo)(({ token  })=>{
    ...
    var ref2;
    // balance
    const { value: tokenBalance = '0' , retry: tokenBalanceRetry  } = (0,useFungibleTokenBalance/* useFungibleTokenBalance */.V)(tokenType, (ref2 = selectedToken === null || selectedToken === void 0 ? void 0 : selectedToken.address) !== null && ref2 !== void 0 ? ref2 : '');
    const nativeToken = (0,hooks_useNativeTokenDetailed/* useNativeTokenDetailed */.J)();
    const nativeTokenPrice = useNativeTokenPrice();
    // #region resolve ENS domain
    const { value: registeredAddress = '' , error: resolveDomainError , loading: resolveDomainLoading ,  } = (0,src/* useLookupAddress */.hn)(address, src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM);
    // #endregion
    // transfer amount
    ...
    const ensContent = (0,react.useMemo)(()=>{
        ...
        if (address.includes('.eth')) {
            ...
            if ((Utils === null || Utils === void 0 ? void 0 : (ref6 = Utils.isValidDomain) === null || ref6 === void 0 ? void 0 : ref6.call(Utils, address)) && resolveDomainError) {
                return(/*#__PURE__*/ (0,jsx_runtime.jsx)(Box/* default */.Z, {
                    style: {
                        padding: '25px 10px'
                    },
                            ...
                            children: [
                                /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                                    ...
                                    children: t.transfer_cost({
                                        ...
                                        symbol: (ref3 = (ref1 = nativeToken.value) === null || ref1 === void 0 ? void 0 : ref1.symbol) !== null && ref3 !== void 0 ? ref3 : '',
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/ImageListItem/ImageListItem.js + 1 modules
var ImageListItem = __webpack_require__(70380);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/ImageList/ImageList.js + 1 modules
var ImageList = __webpack_require__(34931);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/ImageListItemBar/ImageListItemBar.js + 1 modules
var ImageListItemBar = __webpack_require__(63153);
...
var general_Checkbox = __webpack_require__(27402);
...
var zod_lib = __webpack_require__(56382);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+icons-material@5.4.4_d06e3de907ce734e888a65f5db1d962e/node_modules/@mui/icons-material/KeyboardArrowDown.js
var KeyboardArrowDown = __webpack_require__(20005);
...
const TransferERC721 = /*#__PURE__*/ (0,react.memo)(()=>{
    ...
    // #region resolve ENS domain
    const { value: registeredAddress = '' , error: resolveDomainError , loading: resolveDomainLoading ,  } = (0,src/* useLookupAddress */.hn)(allFormFields.recipient, src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM);
    // #endregion
...
var esm_useAsyncRetry = __webpack_require__(22572);
...
const CollectibleList = /*#__PURE__*/ (0,react.memo)(({ selectedNetwork  })=>{
    ...
    const { value ={
        ...
        hasNextPage: false
    } , error: collectiblesError , loading: isQuerying , retry ,  } = (0,esm_useAsyncRetry/* default */.Z)(async ()=>{
        var ref;
    ...
    const onSend = (0,react.useCallback)((detail)=>{
        // Sending NFT is only available on EVM currently.
        if (currentPluginId !== src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM) return;
...
const Assets = /*#__PURE__*/ (0,react.memo)(({ network  })=>{
    ...
    const showCollectibles = [
        src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM,
                    ...
                    children: [
                        /*#__PURE__*/ (0,jsx_runtime.jsxs)(Box/* default */.Z, {
                            ...
                            children: [
                                ...
                                pluginId === src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM && /*#__PURE__*/ (0,jsx_runtime.jsxs)(Button/* default */.Z, {
                                    size: "small",
                                    color: "secondary",
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.4.4_04cbc9cecf451fb80119a7777a08edb2/node_modules/@mui/material/Button/buttonClasses.js
var buttonClasses = __webpack_require__(89691);
...
var RedPacket = __webpack_require__(61445);
// EXTERNAL MODULE: ../icons/general/ITO.tsx
var ITO = __webpack_require__(474);
...
const HistoryTableRow = /*#__PURE__*/ (0,react.memo)(({ transaction , selectedChainId  })=>{
    const { value: domain  } = (0,src/* useReverseAddress */.$q)(transaction.toAddress);
...
const ReceiveDialog = /*#__PURE__*/ (0,react.memo)(({ open , chainName , walletAddress , onClose  })=>{
    ...
    const { value: domain  } = (0,src/* useReverseAddress */.$q)(walletAddress);
    const { Utils  } = (0,src/* useWeb3State */.dM)();
...
var WalletStateBar = __webpack_require__(61682);
// EXTERNAL MODULE: ../icons/general/CloudLink.tsx
var CloudLink = __webpack_require__(95923);
...
function Wallets() {
    const wallet = (0,src/* useWallet */.Os)();
    const wallets = (0,src/* useWallets */.rB)();
    const navigate = (0,react_router/* useNavigate */.s0)();
    const t = (0,locales/* useDashboardI18N */.x)();
    const currentChainId = (0,src/* useChainId */.xx)();
    const { Asset  } = (0,src/* useWeb3State */.dM)();
    ...
    const networks = (0,src/* getRegisteredWeb3Networks */.Rm)();
            ...
            !wallet ? /*#__PURE__*/ (0,jsx_runtime.jsx)(StartUp, {}) : /*#__PURE__*/ (0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
                children: [
                    /*#__PURE__*/ (0,jsx_runtime.jsx)(Balance, {
                        ...
                        showOperations: pluginId === src/* NetworkPluginID.PLUGIN_EVM */.FF.PLUGIN_EVM
                    }),
