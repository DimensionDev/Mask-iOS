(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[1403],{
...
const CreateMnemonic = /*#__PURE__*/ (0,react.memo)(()=>{
    ...
    const [walletState, onSubmit] = (0,useAsyncFn/* default */.Z)(async ()=>{
        ...
        if (!account) {
            ...
            await API/* PluginServices.Wallet.resolveMaskAccount */.NG.Wallet.resolveMaskAccount([
                address_
            ]);
        }
        return address_;
