"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[4844],{
...
var CryptoartAI_constants = __webpack_require__(53548);
...
function MakeOfferDialog(props) {
    ...
    const shareLink = (ref2 = (_utils = social_network.activatedSocialNetworkUI.utils).getShareLinkURL) === null || ref2 === void 0 ? void 0 : ref2.call(_utils, token ? t((0,base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) || (0,facebook_com_base/* isFacebook */.DF)(social_network.activatedSocialNetworkUI) ? 'plugin_cryptoartai_offer_share' : 'plugin_cryptoartai_offer_share_no_official_account', {
        amount: amount,
...
function CheckoutDialog(props) {
    ...
    const shareLink = (ref15 = (_utils = social_network.activatedSocialNetworkUI.utils).getShareLinkURL) === null || ref15 === void 0 ? void 0 : ref15.call(_utils, token ? t((0,base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) || (0,facebook_com_base/* isFacebook */.DF)(social_network.activatedSocialNetworkUI) ? 'plugin_cryptoartai_share' : 'plugin_cryptoartai_share_no_official_account', {
...
var CryptoartAI_base = __webpack_require__(13610);
...
function renderPostInspector(payload) {
    return(/*#__PURE__*/ (0,jsx_runtime.jsx)(MaskPluginWrapper/* default */.Z, {
        pluginName: CryptoartAI_constants/* PLUGIN_NAME */.EW,
