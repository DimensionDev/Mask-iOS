(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[9997],{
...
var helpers = __webpack_require__(93046);
...
async function getAssetFUSD(chainId, account) {
    ...
    const price = await src/* CoinGecko.getTokenPrice */.oD.getTokenPrice('usd-coin', entry_web3/* CurrencyType.USD */.V2.USD);
...
async function getAssetFLOW(chainId, account) {
    ...
    const price = await src/* CoinGecko.getTokenPrice */.oD.getTokenPrice('flow', entry_web3/* CurrencyType.USD */.V2.USD);
    const balance = await getTokenBalance(chainId, account, 8, {
        fungibleTokenAddress: FUNGIBLE_TOKEN_ADDRESS,
...
async function getAssetTether(chainId, account) {
    ...
    const price = await src/* CoinGecko.getTokenPrice */.oD.getTokenPrice('tether', entry_web3/* CurrencyType.USD */.V2.USD);
    const balance = await getTokenBalance(chainId, account, 8, {
        fungibleTokenAddress: FUNGIBLE_TOKEN_ADDRESS,
...
function createFungibleAsset(token, balance, logoURI, price) {
    return {
        ...
        logoURI,
        value: {
            [entry_web3/* CurrencyType.USD */.V2.USD]: (0,src/* multipliedBy */.$q)(price?.usd ?? 0, (0,src/* leftShift */.w5)(balance, 8)).toFixed()
        },
        price
    };
}
...
var types = __webpack_require__(73946);
