"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[2087],{
...
function BackupDialog({ local =true , params , open , merged , onClose  }) {
    ...
    const { value: previewInfo , loading: searching  } = (0,useAsync/* default */.Z)(()=>API/* Services.Backup.generateBackupPreviewInfo */.K9.Backup.generateBackupPreviewInfo()
    );
    const [{ loading  }, handleBackup] = (0,useAsyncFn/* default */.Z)(async ()=>{
        ...
        try {
            ...
            const { file , personaNickNames  } = await API/* Services.Backup.createBackupFile */.K9.Backup.createBackupFile({
            ...
            if (local) {
                ...
                const encrypted = await (0,src/* encryptBackup */.Hb)((0,encode/* encode */.c)(backupPassword), (0,encode/* encode */.c)(file));
                const now = (0,format/* default */.Z)(Date.now(), 'yyyy-MM-dd');
                await API/* Services.Helper.saveFileFromBuffer */.K9.Helper.saveFileFromBuffer({
                    fileContent: encrypted,
                    fileName: `mask-network-keystore-backup-${now}.bin`,
                    mimeType: shared_base_src/* MimeTypes.Binary */.VS.Binary
                });
            } else if (params) {
                ...
                const encrypted = await (0,src/* encryptBackup */.Hb)((0,encode/* encode */.c)(params.account + backupPassword), (0,encode/* encode */.c)(file));
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.8.0_4xriuibr7qayay6mzcpq5f43me/node_modules/@mui/material/FormControlLabel/formControlLabelClasses.js
var formControlLabelClasses = __webpack_require__(47913);
...
function CloudBackupMergeDialog({ account , info , open , onClose , onMerged  }) {
    ...
    const [{ loading  }, handleMerge] = (0,useAsyncFn/* default */.Z)(async ()=>{
        try {
            ...
            const data = (await API/* Services.Backup.addUnconfirmedBackup */.K9.Backup.addUnconfirmedBackup(backupText)).unwrap();
...
var type = __webpack_require__(99922);
...
var ConfirmDialog = __webpack_require__(25993);
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.8.0_4xriuibr7qayay6mzcpq5f43me/node_modules/@mui/material/Select/selectClasses.js
var selectClasses = __webpack_require__(6465);
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.8.0_4xriuibr7qayay6mzcpq5f43me/node_modules/@mui/material/OutlinedInput/outlinedInputClasses.js
var outlinedInputClasses = __webpack_require__(17611);
...
var Personas_api = __webpack_require__(62205);
