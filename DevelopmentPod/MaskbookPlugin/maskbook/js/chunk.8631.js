"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[8631],{
...
var dHEDGE_types = __webpack_require__(63937);
...
var dHEDGE_messages = __webpack_require__(50179);
...
function InvestDialog() {
    ...
    const { open , closeDialog  } = (0,shared_src/* useRemoteControlledDialog */.F$)(dHEDGE_messages/* PluginDHedgeMessages.InvestDialogUpdated */.V.InvestDialogUpdated, (ev)=>{
        if (!ev.open) return;
        setPool(ev.pool);
    ...
    // #endregion
    // #region select token
    const { setDialog: setSelectTokenDialogOpen  } = (0,shared_src/* useRemoteControlledDialog */.F$)(Wallet_messages/* WalletMessages.events.selectTokenDialogUpdated */.R.events.selectTokenDialogUpdated, (0,react.useCallback)((ev)=>{
    ...
    // #endregion
    // #region Swap
    const { setDialog: openSwapDialog  } = (0,shared_src/* useRemoteControlledDialog */.F$)(messages/* PluginTraderMessages.swapDialogUpdated */.A.swapDialogUpdated, (0,react.useCallback)((ev)=>{
        if (!ev.open) {
    ...
    const shareLink = (ref = (_utils = social_network.activatedSocialNetworkUI.utils).getShareLinkURL) === null || ref === void 0 ? void 0 : ref.call(_utils, token ? [
        `I just invested ${(0,formatter/* formatBalance */.az)(amount, token.decimals)} ${cashTag}${token.symbol} in ${pool === null || pool === void 0 ? void 0 : pool.name}. ${(0,base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) || (0,facebook_com_base/* isFacebook */.DF)(social_network.activatedSocialNetworkUI) ? `Follow @${(0,base/* isTwitter */.L3)(social_network.activatedSocialNetworkUI) ? t('twitter_account') : t('facebook_account')} (mask.io) to invest dHEDGE pools.` : ''}`,
        '#mask_io', 
    ].join('\n') : '').toString();
    // on close transaction dialog
    const { setDialog: setTransactionDialogOpen  } = (0,shared_src/* useRemoteControlledDialog */.F$)(Wallet_messages/* WalletMessages.events.transactionDialogUpdated */.R.events.transactionDialogUpdated, (0,react.useCallback)((ev)=>{
        if (!ev.open) {
            retryLoadTokenBalance();
...
/* harmony export */ });
/* harmony import */ var _masknet_plugin_infra__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(94531);
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(33611);
...
const PluginDHedgeRPC = (0,_masknet_plugin_infra__WEBPACK_IMPORTED_MODULE_0__/* .createPluginRPC */ .V8)(_constants__WEBPACK_IMPORTED_MODULE_1__/* .DHEDGE_PLUGIN_ID */ .Bc, ()=>__webpack_require__.e(/* import() */ 7113).then(__webpack_require__.bind(__webpack_require__, 7113))
