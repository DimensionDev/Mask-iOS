"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[7659],{
    ...
    const onConfirm = (0,react.useCallback)(async ()=>{
        if (wallet?.address) {
            try {
                ...
                const otherWalletAddress = (0,head/* default */.Z)(wallets)?.address;
                ...
                if (settings/* currentAccountSettings.value */.aK.value === wallet.address) {
                    await messages/* WalletRPC.updateAccount */.V.updateAccount({
                        account: (0,head/* default */.Z)(wallets)?.address ?? '',
