"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[7810],{
...
var SetupGuide = __webpack_require__(24957);
...
async function connectSocialNetwork(identifier, network) {
    var _utils, ref;
    const ui = await (0,social_network.loadSocialNetworkUI)(network);
...
async function openShareLink(SNSIdentifier, post) {
    var _utils, ref;
    const url = (ref = (_utils = (await (0,social_network.getNetworkWorker)(SNSIdentifier)).utils).getShareLinkURL) === null || ref === void 0 ? void 0 : ref.call(_utils, post);
    if (!url) return;
    browser.tabs.create({
        active: true,
        url: url.toString()
