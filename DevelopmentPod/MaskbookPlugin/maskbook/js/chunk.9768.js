"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[9768],{
...
function getSearchedKeywordAtFacebook() {
    var ref;
    const hashKeyword = (ref = location.pathname.match(/^\/hashtag\/([A-za-z0\u20139_]+)$/u)) === null || ref === void 0 ? void 0 : ref[1];
    if (hashKeyword) return '#' + hashKeyword;
    if (/\/search\/top\/?$/.test(location.pathname)) {
        const params = new URLSearchParams(location.search);
        var ref1;
        return decodeURIComponent((ref1 = params.get('q')) !== null && ref1 !== void 0 ? ref1 : '');
    }
    return '';
};
    ...
    if (isMobile/* isMobileFacebook */.q) {
        ...
        if (location.href.match(/plugins.+(perma.+story_fbid%3D|posts%2F)?/)) {
            ...
            try {
                ...
                var ref4;
                const postIdMode1 = postTimeNode1 ? (ref4 = (ref1 = (ref = postTimeNode1.getAttribute('href')) === null || ref === void 0 ? void 0 : ref.match(/story_fbid=(\d+)/g)) === null || ref1 === void 0 ? void 0 : ref1[0].split('=')[1]) !== null && ref4 !== void 0 ? ref4 : null : null;
                if (postIdMode1) return postIdMode1;
                const postTimeNode2 = root.querySelector('[href*="posts"]');
                var ref5;
                const postIdMode2 = postTimeNode2 ? (ref5 = (ref3 = (ref2 = postTimeNode2.getAttribute('href')) === null || ref2 === void 0 ? void 0 : ref2.match(/posts\/(\d+)/g)) === null || ref3 === void 0 ? void 0 : ref3[0].split('/')[1]) !== null && ref5 !== void 0 ? ref5 : null : null;
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.5.0_daa021359a87c07543264c0518ec626c/node_modules/@mui/material/utils/debounce.js
var debounce = __webpack_require__(2772);
