"use strict";
(globalThis["webpackChunk_masknet_extension"] = globalThis["webpackChunk_masknet_extension"] || []).push([[2363],{
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@mui+material@5.6.1_1376d0c029fe63cac75d7e36fe4212f4/node_modules/@mui/material/TablePagination/tablePaginationClasses.js
var tablePaginationClasses = __webpack_require__(67506);
    ...
    return /*#__PURE__*/ (0,jsx_runtime.jsxs)(Table/* default */.Z, {
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(TableBody/* default */.Z, {
                children: dataSource?.length && !loading ? dataSource.map((item, index)=>/*#__PURE__*/ (0,jsx_runtime.jsx)(DeriveWalletTableRow, {
...
const AddDeriveWallet_useStyles = (0,entry/* makeStyles */.ZL)()({
    container: {
        padding: '16px 10px',
...
const AddDeriveWallet = /*#__PURE__*/ (0,react.memo)(()=>{
    ...
    const [{ loading: confirmLoading  }, onConfirm] = (0,useAsyncFn/* default */.Z)(async ()=>{
        ...
        if (unDeriveWallets.length) {
            ...
            const firstWallet = await messages/* WalletRPC.recoverWalletFromMnemonic */.V.recoverWalletFromMnemonic(`${walletName}${firstPath}`, mnemonic, `${src/* HD_PATH_WITHOUT_INDEX_ETHEREUM */.UB}/${firstPath}`);
            const wallets = await Promise.all(unDeriveWallets.slice(1).map(async (pathIndex)=>messages/* WalletRPC.recoverWalletFromMnemonic */.V.recoverWalletFromMnemonic(`${walletName}${pathIndex}`, mnemonic, `${src/* HD_PATH_WITHOUT_INDEX_ETHEREUM */.UB}/${pathIndex}`)
            ));
        ...
        children: [
            ...
            /*#__PURE__*/ (0,jsx_runtime.jsx)(Typography/* default */.Z, {
                ...
                children: t('popups_wallet_derivation_path', {
                    path: src/* HD_PATH_WITHOUT_INDEX_ETHEREUM */.UB
                })
            }),
